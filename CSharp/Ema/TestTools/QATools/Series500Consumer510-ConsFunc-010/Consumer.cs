...
public class Consumer
{
    static void Main()
    {
        ...
        try
        {
            ...
            long handle1 = consumer.RegisterClient(new RequestMsg().ServiceListName("SVG1").Name("LSEG.L"), appClient, 1);
            long handle2 = consumer.RegisterClient(new RequestMsg().ServiceListName("SVG1").Name("TRI.N"), appClient, 2);
