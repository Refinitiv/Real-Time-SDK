...
public class IProvider
{
    ...
    static Map CreateProgrammaticConfig()
    {
        ...
        innerElementList.AddUInt("EnumTypeFragmentSize", 128_000);
        innerElementList.AddUInt("FieldDictionaryFragmentSize", 8192);
        innerElementList.AddInt("PipePort", 9009);
        innerElementList.AddUInt("RequestTimeout", 15_000);
        innerElementList.AddAscii("Name", "Series400Provider421-PConfig-002");
        ...
        innerElementList.AddEnum("CompressionType", EmaConfig.CompressionTypeEnum.NONE);
        //APIQA
        ...
        innerElementList.AddUInt("ConnectionMinPingTimeout", 20_000);
        ...
        innerElementList.AddUInt("SysRecvBufSize", 10);
        innerElementList.AddUInt("SysSendBufSize", 10);
    ...
    public static void Main(string[] args)
    {
        ...
        try
        {
            ...
            provider = new OmmProvider(new OmmIProviderConfig().Config(CreateProgrammaticConfig())
                .OperationModel(OmmIProviderConfig.OperationModelMode.USER_DISPATCH).ProviderName("Provider_2"),
                appClient);
