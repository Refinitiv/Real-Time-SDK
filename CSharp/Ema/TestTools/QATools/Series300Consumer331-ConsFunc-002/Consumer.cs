...
public class Consumer 
{
    ...
    public static void Main(string[] args)
	{
        ...
        else if (args[0].Equals("-directoryFilter"))
        {
            dfilter = int.Parse(args[1]);
            System.Console.WriteLine("FILTER SPECIFIED IS " + dfilter);
        }
        //END APIQA
		...
		//APIQA
			consumer.RegisterClient(reqMsg.DomainType(EmaRdm.MMT_DIRECTORY).ServiceName("DIRECT_FEED").Filter(dfilter), appClient);
		//END APIQA	
