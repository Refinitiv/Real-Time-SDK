...
public class Consumer
{
	public static void Main()
	{
		...
		try
		{
			...
			//APIQA
			consumer.RegisterClient(reqMsg.DomainType(EmaRdm.MMT_DICTIONARY).Name("RWFFld_TEST").
					 Filter(EmaRdm.DICTIONARY_NORMAL).ServiceName("DIRECT_FEED"), appClient);

			consumer.RegisterClient(reqMsg.Clear().DomainType(EmaRdm.MMT_DICTIONARY).Name("RWFEnum_TEST").
                    Filter(EmaRdm.DICTIONARY_NORMAL).ServiceName("DIRECT_FEED"), appClient);
			//END APIQA
