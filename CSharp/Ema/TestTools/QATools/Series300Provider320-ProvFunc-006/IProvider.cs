...
class AppClient : IOmmProviderClient
{
    ...
    private int m_FragmentationSize = 9600;
    ...
    void ProcessDictionaryRequest(RequestMsg reqMsg, IOmmProviderEvent providerEvent)
    {
        ...
        try
        {
            if (reqMsg.Name().Equals("RWFFld"))
            {
                ...
                // APIQA
                m_FragmentationSize = 9600;
                while (!m_Result)
                {
                    m_FragmentationSize = m_FragmentationSize + 10000;
...
public class IProvider
{
    public static void Main(string[] args)
    {
        ...
        try
        {
            ...
            provider = new OmmProvider(new OmmIProviderConfig().AdminControlDictionary(OmmIProviderConfig.AdminControlMode.USER_CONTROL), appClient);
