...
class AppClient : IOmmConsumerClient
{
	...
	{
		Console.WriteLine("Item Stream Id: " + refreshMsg.StreamId());
		Console.WriteLine("Private Stream: " + refreshMsg.PrivateStream().ToString());
	...
	{
		Console.WriteLine("Item Stream Id: " + updateMsg.StreamId());
	...
	{
		Console.WriteLine("Item Stream Id: " + statusMsg.StreamId());
...
public class Consumer 
{
	public static void Main()
	{
		...
		{			
			...
			consumer.RegisterClient(new RequestMsg().DomainType(EmaRdm.MMT_MARKET_BY_PRICE)
															.ServiceName("DIRECT_FEED").Name("BBH.ITC")
															.PrivateStream(false), new AppClient());
