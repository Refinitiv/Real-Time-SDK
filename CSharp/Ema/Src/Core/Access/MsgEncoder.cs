...
#pragma warning restore CS8618
        ...
        internal bool m_copyByteBuffer = false;
        ...
        {
            int dataType = ConvertDataTypeToEta(payload.DataType);
        ...
        internal void Attrib(ComplexType attrib)
        {
            ...
            m_rsslMsg.MsgKey.AttribContainerType = ConvertDataTypeToEta(attrib.DataType);
