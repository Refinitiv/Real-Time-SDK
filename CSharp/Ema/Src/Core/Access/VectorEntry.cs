...
namespace LSEG.Ema.Access
{
    ...
    public sealed class VectorEntry : Entry
    {
        ...
        /// <exception cref="OmmInvalidUsageException"> if <see cref="HasPermissionData"/> returns false</exception>
        ...
        /// </summary>
        /// <returns>string representing current <see cref="VectorEntry"/> instance.</returns>
