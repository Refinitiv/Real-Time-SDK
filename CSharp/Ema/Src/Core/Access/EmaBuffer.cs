...
/// char or byte.<br/>
/// EmaBuffer class contains a copy of the passed in buffer.<br/>
...
public sealed class EmaBuffer : IEquatable<EmaBuffer>
{
    ...
    /// </summary>
    /// <returns>Reference to current <see cref="EmaBuffer"/> object.</returns>
    ...
    /// </summary>
    /// <value>Span pointing to data within internal buffer.</value>
    ...
    /// </summary>
    /// <remarks>
    /// Unlike <see cref="AsHexString()"/> lines of hex numbers are not appended with string 
    /// representation of processed bytes.
    /// </remarks>
    ...
    /// </summary>
    /// <returns>this EmaBuffer contents as a new byte array with the <see cref="Length"/> size </returns>
    /// <seealso cref="Contents"/>
    /// <seealso cref="Buffer"/>
    /// <exception cref="OutOfMemoryException">Thrown if application runs out of memory</exception>
    ...
    /// </summary>
    /// <remarks>
    /// The data block within underlying buffer starts from <see cref="Offset"/> and is <see cref="Length"/> bytes long.
    /// </remarks>
    /// <seealso cref="AsByteArray()"/>
    /// <seealso cref="Buffer"/>
    /// <seealso cref="Offset"/>
