...
///	This class is used for extraction of OmmQos only.<br/>
...
public sealed class OmmQos : Data
{
    ...
    /// </summary>
    /// <returns>string representing current <see cref="OmmQos"/> object.</returns>
    ...
    internal OmmQos()
    {
        ...
        DecodePrimitiveType = DecodeOmmQos;
        m_dataType = Access.DataType.DataTypes.QOS;
    }

    internal CodecReturnCode DecodeOmmQos(DecodeIterator dIter)
    {
