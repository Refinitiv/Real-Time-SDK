...
namespace LSEG.Ema.Access
{
    ...
    public sealed class Series : ComplexType, IEnumerable<SeriesEntry>
    {
        ...
        /// <summary>
        /// <see cref="Access.DataType.DataTypes"/> value representing the type of this <see cref="ComplexType"/> instance.
        /// </summary>
        public override int DataType => Access.DataType.DataTypes.SERIES;
        ...
        /// <returns>reference to current <see cref="Series"/> instance</returns>
        ...
        public IEnumerator<SeriesEntry> GetEnumerator()
        {
            ...
            {
                var errorEnumerator = m_objectManager != null ? m_objectManager!.GetSeriesErrorEnumerator() : new SeriesErrorEnumerator();
                errorEnumerator.SetError(m_errorCode);
                return errorEnumerator;
            }

            var enumerator = m_objectManager != null ? m_objectManager!.GetSeriesEnumerator() : new SeriesEnumerator();
        ...
        internal override Eta.Codec.CodecReturnCode Decode(Eta.Codec.DecodeIterator dIter)
        {
        ...
        /// <summary>
        /// Adds entry to current Series object.
        ...
        /// </summary>
        /// <returns>string representing current <see cref="Series"/> instance.</returns>
