...
namespace LSEG.Ema.Access
{
    ...
    /// <remarks>
    /// <para>
    /// <br>OmmConsumer provides interfaces to open, modify and close items.</br>
    ...
    /// </para>
    /// <para>
    /// <br>OmmConsumer provides a default behaviour / functionality.</br>
    /// This may be tuned / modified by application when using <see cref="OmmConsumerConfig"/>.
    /// </para>
    /// <para>
    /// <br>Application interacts with server through the OmmConsumer interface methods.</br>
    ...
    /// </para>
    /// <br>The following consumer example shows basic usage of OmmConsumer class in a simple consumer type app.</br>
    ...
    public sealed class OmmConsumer
    {
        ...
        /// if the credential update fails or if this method is called outside of an onCredentialRenewal callback.
        /// </exception>
