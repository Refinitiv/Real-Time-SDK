...
namespace LSEG.Ema.Access
{
    ...
    public sealed class FieldEntry : Entry
    {
        ...
        /// <summary>
        /// Returns a ripple field name if the entry has a ripple field. A subsequent call 
        /// using the former non-zero return value as a formal parameter, 
        /// returns the next ripple field in a ripple sequence.
        /// </summary>
        /// <param name="fieldId">field id value</param>
        /// <returns>ripple field name; empty string if no ripple field or the final ripple field of a ripple sequence.</returns>
        ...
        /// Calling this method must be preceded by a call to <see cref="HasEnumDisplay"/>.
        /// Throws OmmInvalidUsageException if <see cref="HasEnumDisplay"/> returns false.
        /// Throws OmmInvalidUsageException if contained object is not <see cref="OmmEnum"/>.
        /// Throws OmmInvalidUsageException if <see cref="Data.Code"/> returns <see cref="Data.DataCode.BLANK"/>
        /// </summary>
        ...
        {
            if (DataType.DataTypes.UINT != Load!.DataType)
            {
        ...
        {
            if (Load!.DataType != DataType.DataTypes.ARRAY)
            {
        ...
        /// </summary>
        /// <returns>string representing current <see cref="FieldEntry"/> instance.</returns>
        public override string ToString()
        {
            ...
            m_toString.Append("FieldEntry ")
                    ...
                    .Append(" dataType=\"").Append(DataType.AsString(Load.DataType));

            if (Load.DataType >= DataType.DataTypes.FIELD_LIST || Load.DataType == DataType.DataTypes.ARRAY)
            {
