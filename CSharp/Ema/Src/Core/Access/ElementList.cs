...
namespace LSEG.Ema.Access
{
    ...
    public sealed class ElementList : ComplexType, IEnumerable<ElementEntry>
    {
        ...
        /// </summary>
        public override int DataType => Access.DataType.DataTypes.ELEMENT_LIST;

        /// <summary>
        /// Returns InfoElementListNum value
        /// </summary>
        ...
        /// <summary>
        /// Clears the ElementList. Note: allows re-use of ElementList instance during encoding.
        /// </summary>
        ...
        /// </summary>
        /// <param name="elementListNum">ElementList template number</param>
        ...
        /// </summary>
        /// <returns><see cref="IEnumerator{ElementEntry}"/> instance</returns>
        public IEnumerator<ElementEntry> GetEnumerator()
        {
            if (m_errorCode != OmmError.ErrorCodes.NO_ERROR || !m_hasDecodedDataSet)
            {
                var errorEnumerator = m_objectManager != null ? m_objectManager.GetElementListErrorEnumerator() : new ElementListErrorEnumerator();
                errorEnumerator.SetError(m_errorCode);
                return errorEnumerator;
            }

            var decoder = m_objectManager != null ? m_objectManager.GetElementListEnumerator() : new ElementListEnumerator();
        ...
        /// <returns>reference to the current <see cref="ElementList"/> instance</returns>
        ...
        /// <exception cref="OmmInvalidUsageException"> if an error is detected (exception will specify the cause of the error)</exception>
        ...
        /// </summary>
        /// <param name="name">string object containing ElementEntry name</param>
        /// <param name="value">added EmaBuffer as <see cref="DataTypes.ASCII_STRING"/></param>
        /// <returns>reference to current <see cref="ElementList"/> object</returns>
        /// <exception cref="OmmInvalidUsageException"> if an error is detected (exception will specify the cause of the error)</exception>
        ...
        /// </summary>
        /// <param name="name">string object containing ElementEntry name</param>
        /// <param name="value">added string as <see cref="DataTypes.UTF8_STRING"/></param>
        /// <returns>reference to current <see cref="ElementList"/> object</returns>
        /// <exception cref="OmmInvalidUsageException"> if an error is detected (exception will specify the cause of the error)</exception>
