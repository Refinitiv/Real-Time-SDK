...
public sealed class EmaBufferU16 : IEquatable<EmaBufferU16>, IComparable<EmaBufferU16>
{
    ...
    ///
    /// <remarks>
    /// The data block within underlying buffer starts from 0 and is
    /// <see cref="Length"/> characters long.
    /// </remarks>
    ///
    /// <seealso cref="Buffer"/>
    ...
    /// </summary>
    /// <returns>string representing current <see cref="EmaBufferU16"/> instance.</returns>
