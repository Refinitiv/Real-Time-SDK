...
/// A variant class representing a primitive data entry in another container.
///
/// Public interface provides only read-only access to the contained data.
///
...
public abstract class Entry
{
    ...
    public int LoadType { get => Load != null ? Load!.DataType : DataType.DataTypes.NO_DATA; }
    /// <summary>
    ...
    {
        if (Load!.DataType != DataType.DataTypes.REQ_MSG)
        {
    ...
    {
        if (Load!.DataType != DataType.DataTypes.REFRESH_MSG)
        {
    ...
    {
        if (Load!.DataType != DataType.DataTypes.UPDATE_MSG)
        {
    ...
    {
        if (Load!.DataType != DataType.DataTypes.STATUS_MSG)
        {
    ...
    {
        if (Load!.DataType != DataType.DataTypes.POST_MSG)
        {
    ...
    {
        if (Load!.DataType != DataType.DataTypes.ACK_MSG)
        {
    ...
    {
        if (Load!.DataType != DataType.DataTypes.GENERIC_MSG)
        {
    ...
    {
        if (Load!.DataType != DataType.DataTypes.FIELD_LIST)
        {
    ...
    {
        if (Load!.DataType != DataType.DataTypes.ELEMENT_LIST)
        {
    ...
    public Map Map()
    {
        if (Load!.DataType != DataType.DataTypes.MAP)
        {
    ...
    {
        if (Load!.DataType != DataType.DataTypes.VECTOR)
        {
    ...
    {
        if (Load!.DataType != DataType.DataTypes.SERIES)
        {
    ...
    {
        if (Load!.DataType != DataType.DataTypes.FILTER_LIST)
        {
    ...
    {
        if (Load!.DataType != DataType.DataTypes.OPAQUE)
        {
    ...
    public OmmXml Xml()
    {
        if (Load!.DataType != DataType.DataTypes.XML)
        {
    ...
    {
        if (Load!.DataType != DataType.DataTypes.ANSI_PAGE)
        {
