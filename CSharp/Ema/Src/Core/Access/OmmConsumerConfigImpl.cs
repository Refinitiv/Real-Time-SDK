...
namespace LSEG.Ema.Access
{
    ...
    internal class OmmConsumerConfigImpl
    {
        ...
        internal void VerifyConfiguration()
        {
            ...
            {
                if(0 == consumer.ChannelSet.Count)
                {
                    throw new OmmInvalidConfigurationException("Consumer " + consumer.Name + " does not have any configured channels. Use Channel or ChannelSet to configure the channels.");
                }
