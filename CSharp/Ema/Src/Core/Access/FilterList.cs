...
namespace LSEG.Ema.Access
{
    ...
    public sealed class FilterList : ComplexType, IEnumerable<FilterEntry>
    {
        ...
        /// </summary>
        public override int DataType => Access.DataType.DataTypes.FILTER_LIST;
        
        /// <summary>
        /// Returns TotalCountHint
        /// </summary>
        /// <returns><see cref="int"/> value representing TotalCountHint</returns>
        /// <exception cref="OmmInvalidUsageException">if HasTotalCountHint returns false</exception>
        ...
        public IEnumerator<FilterEntry> GetEnumerator()
        {
            ...
            {
                var errorEnumerator = m_objectManager != null ? m_objectManager!.GetFilterListErrorEnumerator() : new FilterListErrorEnumerator();
                errorEnumerator.SetError(m_errorCode);
                return errorEnumerator;
            }

            var enumerator = m_objectManager != null ? m_objectManager.GetFilterListEnumerator() : new FilterListEnumerator();
        ...
        /// </summary>
        /// <returns>string representing current <see cref="FilterList"/> instance.</returns>
