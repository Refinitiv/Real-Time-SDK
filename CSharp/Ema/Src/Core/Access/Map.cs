...
namespace LSEG.Ema.Access
{
    ...
    public sealed class Map : ComplexType, IEnumerable<MapEntry>
    {
        ...
        /// </summary>
        public override int DataType => Access.DataType.DataTypes.MAP;
        ...
        /// <returns>reference to the current <see cref="Map"/> instance</returns>        
        ...
        public IEnumerator<MapEntry> GetEnumerator()
        {
            ...
            {
                var errorEnumerator = m_objectManager != null ? m_objectManager!.GetMapErrorEnumerator() : new MapErrorEnumerator();
				errorEnumerator.SetError(m_errorCode);
				return errorEnumerator;
            }

            var enumerator = m_objectManager != null ? m_objectManager!.GetMapEnumerator() : new MapEnumerator();
        ...
        internal override CodecReturnCode Decode(int majorVersion, int minorVersion, Buffer body, DataDictionary? dictionary, object? localSetDb)
        {
        ...
        /// <returns>reference to current <see cref="Map"/> instance</returns>
        /// <exception cref="OmmInvalidUsageException">if an error is detected</exception>
        ...
        /// </summary>
        /// <returns>string representing current <see cref="Map"/> instance.</returns>
