...
namespace LSEG.Ema.Access
{
    ...
    public sealed class VectorAction
    {
        ...
        /// <br>Increases any higher-ordered position by one.</br>
        /// <br>May leave gaps if previous lower-ordered position is not populated.</br>
        /// </summary>
        public const int INSERT = 4;
        /// <summary>
        /// Indicates to remove the entry.
        /// <br>Decreases any higher-ordered position by one.</br>
        /// <br>Contains no data.</br>
        /// </summary>
