...
public sealed class OmmState : Data
{
    ...
    /// </summary>
    public override int DataType { get => Access.DataType.DataTypes.STATE; }
    ...
    /// StatusText.
    /// </summary>
    /// <returns>string containing status text information</returns>
    ...
    /// </summary>
    /// <returns>string representing current <see cref="OmmState"/> instance.</returns>
    ...
    private const string NONSTREAMING_STRING = "NonStreaming";
    private const string CLOSED_STRING = "CLOSED";
    private const string CLOSEDRECOVER_STRING = "CLOSEDRecover";
    private const string CLOSEDREDIRECTED_STRING = "CLOSEDRedirected";

    private const string NOCHANGE_STRING = "NoChange";
    private const string OK_STRING = "Ok";
    private const string SUSPECT_STRING = "Suspect";

    private const string NONE_STRING = "None";
    private const string NOTFOUND_STRING = "NotFound";
    private const string TIMEOUT_STRING = "Timeout";
    private const string NOTAUTHORIZED_STRING = "NotAuthorized";
    private const string INVALIDARGUMENT_STRING = "InvalidArgument";
    private const string USAGEERROR_STRING = "UsageError";
    private const string PREEMPTED_STRING = "Preempted";
    private const string JUSTINTIMECONFLATIONSTARTED_STRING = "JustInTimeConflationStarted";
    private const string TICKBYTICKRESUMED_STRING = "TickByTickResumed";
    private const string FAILOVERSTARTED_STRING = "FailoverStarted";
    private const string FAILOVERCOMPLETED_STRING = "FailoverCompleted";
    private const string GAPDETECTED_STRING = "GapDetected";
    private const string NORESOURCES_STRING = "NoResources";
    private const string TOOMANYITEMS_STRING = "TooManyItems";
    private const string ALREADYOPEN_STRING = "AlreadyOpen";
    private const string SOURCEUNKNOWN_STRING = "SourceUnknown";
    private const string NOTOPEN_STRING = "NotOpen";
    private const string NONUPDATINGITEM_STRING = "NonUpdatingItem";
    private const string UNSUPPORTEDVIEWTYPE_STRING = "UnsupportedViewType";
    private const string INVALIDVIEW_STRING = "InvalidView";
    private const string FULLVIEWPROVIDED_STRING = "FullViewProvided";
    private const string UNABLETOREQUESTASBATCH_STRING = "UnableToRequestAsBatch";
    private const string NOBATCHVIEWSUPPORTINREQ_STRING = "NoBatchViewSupportInReq";
    private const string EXCEEDEDMAXMOUNTSPERUSER_STRING = "ExceededMaxMountsPerUser";
    private const string ERROR_STRING = "Error";
    private const string DACSDOWN_STRING = "DacsDown";
    private const string USERUNKNOWNTOPERMSYS_STRING = "UserUnknownToPermSys";
    private const string DACSMAXLOGINSREACHED_STRING = "DacsMaxLoginsReached";
    private const string DACSUSERACCESSTOAPPDENIED_STRING = "DacsUserAccessToAppDenied";
    private const string GAPFILL_STRING = "GapFill";
    private const string APPAUTHORIZATIONFAILED_STRING = "AppAuthorizationFailed";
