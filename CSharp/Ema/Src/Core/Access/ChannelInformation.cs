...
namespace LSEG.Ema.Access
{
    ...
    public sealed class ChannelInformation
    {
        ...
        /// </summary>
        /// <param name="componentInfo">string representation of component information</param>
        ...
        /// <param name="maxFragmentSize">maximum fragment size</param>
        /// <param name="maxOutputBuffers">maximum number of output buffers</param>
        /// <param name="guaranteedOutputBuffers">number of guaranteed output buffers</param>
        /// <param name="numInputBuffers">number of unput buffers</param>
        /// <param name="sysSendBufSize">the size of send buffer</param>
        /// <param name="sysRecvBufSize">the size of receive buffer</param>
        /// <param name="compressionType">compression type</param>
        /// <param name="compressionThreshold">compression threshold</param>
        /// <param name="encryptedConnectionType">the encryppted connection type</param>
        internal ChannelInformation(string componentInfo, string hostname, string ipAddress, ChannelState state,
            ConnectionType connectionType, ProtocolType protocolType, int majorVersion, int minorVersion, int pingTimeout,
            int maxFragmentSize, int maxOutputBuffers, int guaranteedOutputBuffers, int numInputBuffers,
            int sysSendBufSize, int sysRecvBufSize, CompressionType compressionType, int compressionThreshold, int encryptedConnectionType = 0)
        {
        ...
        /// </summary>
        public int EncryptedConnectionType { get; set; }
        ...
        public void Clear()
        {
            ...
            EncryptedConnectionType = -1;
        }

        /// <summary>
        /// Sets values of the current <see cref="ChannelInformation"/> instnace properties 
        /// from the provided <see cref="ReactorChannel"/> instnace.
        /// </summary>
        /// <param name="reactorChannel">source <see cref="ReactorChannel"/> to set info from</param>
        ...
        public override string ToString()
        {
            ...
            if (ProtocolType == Access.ProtocolType.RWF)
                m_stringBuilder.Append("Refinitiv wire format");
