...
/// <remarks>
/// <para>
/// OmmReal encapsulates magnitude type and mantissa information.</para>
///
/// <para>
/// The following code snippet shows setting of Real in FieldList;</para>
///
/// <example>
...
///
/// <para>
/// The following code snippet shows extraction of OmmReal from FieldList.</para>
///
/// <example>
...
public sealed class OmmReal : Data
{
    ...
    /// </summary>
    public override int DataType { get => Access.DataType.DataTypes.REAL; }
    ...
    /// </summary>
    /// <returns>string representing current <see cref="OmmReal"/> instance.</returns>
