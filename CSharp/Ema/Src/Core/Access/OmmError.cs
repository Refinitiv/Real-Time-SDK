...
/// received data. These objects are used for debugging purposes only.<br/>
/// OmmError is a read only class.<br/>
/// The usage of this class is limited to downcast operation only.<br/>
/// All methods in this class are \ref single threaded.<br/>
/// <example>
/// The following code snippet shows example Error usage:<br/>
/// <code>
...
public sealed class OmmError : Data
{
    ...
    /// </summary>
    /// <returns>string representing current <see cref="OmmError"/> object.</returns>
    ...
    internal OmmError()
    {
        ...
        DecodePrimitiveType = DecodeOmmError;
        m_dataType = Access.DataType.DataTypes.ERROR;
    }

    internal CodecReturnCode DecodeOmmError(DecodeIterator dIter)
    {
