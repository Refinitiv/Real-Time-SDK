...
namespace LSEG.Ema.Access
{
    internal class OmmConsumerImpl : OmmBaseImpl<IOmmConsumerClient>
    {
        ...
        public override long RegisterClient(RequestMsg requestMsg, IOmmConsumerClient client, object? closure)
        {
            return base.RegisterClient(requestMsg, client, closure);
        }
        ...
        public override int Dispatch(int dispatchTimeout)
        {
            return base.Dispatch(dispatchTimeout);
        }
