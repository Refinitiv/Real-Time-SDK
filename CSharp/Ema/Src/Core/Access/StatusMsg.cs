...
namespace LSEG.Ema.Access
{
    ...
    /// 
    /// Calling an accessor method on an optional member of StatusMsg must be
    /// preceded by a call to respective Has*** property.
    ...
    public sealed class StatusMsg : Msg, ICloneable
    {
        ...
        /// </summary>
        public override int DataType => Access.DataType.DataTypes.STATUS_MSG;
        ...
        /// <returns>reference to current <see cref="StatusMsg"/> instance</returns>
        ...
        /// </summary>
        /// <returns>string representing current <see cref="StatusMsg"/> instance.</returns>
