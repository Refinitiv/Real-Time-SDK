...
public class OAuth2CredentialRenewal
{
    ...
    /// </summary>
    /// <returns>Reference to the current <see cref="OAuth2CredentialRenewal"/> object.</returns>
    ...
    /// </summary>
    /// <returns>String containg the client ID</returns>
    ...
    /// </summary>
    /// <returns>String containg the client secret.</returns>
    ...
    /// </summary>
    /// <returns>String containg the JWK</returns>
    ...
    /// </summary>
    /// <returns>String containinng the token scope</returns>
    ...
    /// </summary>
    /// <returns>String containg the audience</returns>
