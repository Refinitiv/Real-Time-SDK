...
///
/// <para>
/// This message is used to respond to a Login Request message after the user's Login is
/// accepted.</para>
///
/// <para>
/// An OMM provider can use the Login request information to authentication
/// users with DACS.</para>
///
/// <para>
/// After authentication, a refresh message is sent to convey that the
/// login was accepted.</para>
///
/// <para>
/// If the login is rejected, a Login Status message should be sent.</para>
/// </remarks>
public sealed class LoginRefresh : Login
{
    ...
    /// </summary>
    ///
    /// <param name="val"> true if supports AllowSuspectData, false if no support
    ///   for AllowSuspectData.</param>
    ///
    /// <returns> reference to this object.</returns>
    ...
    /// </summary>
    ///
    /// <param name="value"> true if requesting for permission expressions, false if not
    ///   requesting permission expressions</param>
    ///
    /// <returns> reference to this object.</returns>
    ...
    /// </summary>
    ///
    /// <param name="value"> true if requesting for permission profile, false if not
    ///   requesting permission profile.</param>
    ///
    /// <returns> reference to this object.</returns>
    ...
    /// </summary>
    ///
    /// <param name="value"> true if supports SingleOpen, false if no support for
    ///   SingleOpen.</param>
    ///
    /// <returns> reference to this object.</returns>
    ...
    /// </summary>
    ///
    /// See <see cref="EmaRdm"/> for flag values of batch message support
    ///      <see cref="EmaRdm.SUPPORT_BATCH_REQUEST"/> = 0x001
    ///      <see cref="EmaRdm.SUPPORT_BATCH_REISSUE"/> = 0x002
    ///      <see cref="EmaRdm.SUPPORT_BATCH_CLOSE"/> = 0x004
    ///
    ...
    /// </summary>
    ///
    /// See <see cref="EmaRdm"/> for enhanced symbol list support
    ...
    /// </summary>
    ///
    /// <param name="value"> true if supports OMM Posting, false if no support for OMM
    ///   Posting.</param>
    ///
    /// <returns> reference to this object.</returns>
    ...
    /// </summary>
    ///
    /// <param name="value"> true if supports OptimizedPauseResume, false if no support
    ///   for OptimizedPauseResume.</param>
    ///
    /// <returns> reference to this object.</returns>
    ...
    /// </summary>
    ///
    /// <param name="value"> true if supports ProviderDictionaryDownload, false if no
    ///   support for ProviderDictionaryDownload.</param>
    ///
    /// <returns> reference to this object.</returns>
    ...
    /// </summary>
    ///
    /// <param name="value"> true if supports ViewRequests, false if no support for
    ///   ViewRequests.</param>
    ///
    /// <returns> reference to this object.</returns>
    ...
    /// </summary>
    ///
    /// <param name="value"> true if supports Warm Standby, false if no support for Warm
    ///   Standby.</param>
    ///
    /// <returns> reference to this object.</returns>
    ...
    /// <summary>Gets AllowSuspectData</summary>
    /// <exception cref="OmmInvalidUsageException">
    /// if <see cref="HasAllowSuspectData"/> returns false.
    /// </exception>
    ///
    ...
    /// <summary>Gets ApplicationId</summary>
    /// <exception cref="OmmInvalidUsageException">
    ...
    /// <summary>Gets ApplicationName</summary>
    /// <exception cref="OmmInvalidUsageException">
    ...
    /// <summary>Gets AuthenticationExtended</summary>
    /// <exception cref="OmmInvalidUsageException">
    ...
    /// <summary>Gets AuthenticationTTReissue</summary>
    /// <exception cref="OmmInvalidUsageException">
    /// if <see cref="HasAuthenticationTTReissue"/> returns false.
    /// </exception>
    ///
    ...
    /// <summary>Gets AuthenticationErrorCode</summary>
    /// <exception cref="OmmInvalidUsageException">
    ...
    /// <summary>Gets AuthenticationErrorText</summary>
    /// <exception cref="OmmInvalidUsageException">
    ...
    /// <summary>Gets ProvidePermissionExpressions</summary>
    /// <exception cref="OmmInvalidUsageException">
    /// if <see cref="HasProvidePermissionExpressions"/> returns false.
    /// </exception>
    ///
    ...
    /// <summary>Gets ProvidePermissionProfile</summary>
    /// <exception cref="OmmInvalidUsageException">
    /// if <see cref="HasProvidePermissionProfile"/> returns false.
    /// </exception>
    ///
    ...
    /// <summary>Gets SingleOpen</summary>
    /// <exception cref="OmmInvalidUsageException">
    /// if <see cref="HasSingleOpen"/> returns false.
    /// </exception>
    ///
    ...
    /// <summary>Gets Solicited</summary>
    /// <exception cref="OmmInvalidUsageException">
    /// if <see cref="HasSolicited"/> returns false.
    /// </exception>
    ///
    ...
    /// <summary>Gets SupportBatchRequests</summary>
    /// <exception cref="OmmInvalidUsageException">
    /// if <see cref="HasSupportBatchRequests"/> returns false.
    /// </exception>
    ///
    ...
    /// <summary>Gets SupportEnhancedSymbolList</summary>
    /// <exception cref="OmmInvalidUsageException">
    /// if <see cref="HasSupportEnhancedSymbolList"/> returns false.
    /// </exception>
    ///
    ...
    /// <summary>Gets SupportOMMPost</summary>
    /// <exception cref="OmmInvalidUsageException">
    /// if <see cref="HasSupportOMMPost"/> returns false
    /// </exception>
    ///
    ...
    /// <summary>Gets SupportProviderDictionaryDownload</summary>
    /// <exception cref="OmmInvalidUsageException">
    /// if <see cref="HasSupportProviderDictionaryDownload"/> returns false.
    /// </exception>
    ///
    ...
    /// <summary>Gets SupportViewRequests</summary>
    /// <exception cref="OmmInvalidUsageException">
    /// if <see cref="HasSupportViewRequests"/> returns false.
    /// </exception>
    ///
    ...
    /// <summary>Gets SupportStandby</summary>
    /// <exception cref="OmmInvalidUsageException">
    /// if <see cref="HasSupportStandby"/> returns false.
    /// </exception>
    ///
    ...
    /// <summary>Gets SeqNum</summary>
    /// <exception cref="OmmInvalidUsageException">
    /// if <see cref="HasSeqNum"/> returns false
    /// </exception>
    ///
