...
/// message to convey state information associated with the login stream.<br/>
/// Such state information can indicate that a login stream cannot be established or to
/// inform a consumer of a state change associated with an open login stream.<br/>
/// </remarks>
public sealed class LoginStatus : Login
{
    ...
    /// </remarks>
    /// <returns>Reference to current <see cref="LoginStatus"/> object.</returns>
    ...
    /// <summary>
    /// Returns AuthenticationErrorText
    /// </summary>
