...
///
/// <para>
/// The dictionary also saves general information about the dictionary itself</para>
///
/// <para>
/// This is found in the "!tag" comments of the file or in the summary data of
/// dictionaries encoded via the official domain model.</para>
///
/// <para>
...
public sealed class DataDictionary
{
    ...
    /// </summary>
    ///
    /// <returns>the list of DictionaryEntry</returns>
    ///
    public List<DictionaryEntry> Entries()
    {
        ...
        try
        {
            if (m_DictionaryEntryList is null)
            {
    ...
    public List<EnumTypeTable> EnumTables()
    {
        ...
        try
        {
            if (m_EnumTypeTableList is null)
            {
    ...
    public string FieldVersion
    {
        get
        {
            ...
            try
            {
                return m_rsslDataDictionary.InfoFieldVersion.Data() is not null
    ...
    /// if fails to load from the specified file name from <code>filename</code>.
    /// </exception>
            ...
            if (m_OwnRsslDataDictionary)
            {
                if (m_rsslDataDictionary.LoadFieldDictionary(filename, out m_RsslError) < 0)
                {
                    string errText = ErrorString().Append("Unable to load field dictionary from file named ")
                            ...
                            .Append(Environment.GetEnvironmentVariable("user.dir"))
    ...
    /// <summary>
    /// Adds information from an enumerated types dictionary file to the data dictionary
    /// object.
    /// </summary>
    ///
    ...
    ///
    /// <exception cref="OmmInvalidUsageException">
    /// if fails to encode field dictionary information.
    /// </exception>
    ///
    /// <seealso cref="EmaRdm"/>
    ///
    ...
    /// information from dictionaries that have been encoded in multiple parts.</para>
    ///
    ...
    ///
    /// <exception cref="OmmInvalidUsageException">
    /// if fails to decode field dictionary information.
    /// </exception>
    /// </remarks>
    ///
    /// <seealso cref="EmaRdm"/>
    ...
    ///
    /// <para>
    /// Note: This method will use the type Ascii for the DISPLAY array.</para>
    ///
    /// </remarks>
    ///
    ...
    ///
    /// <exception cref="OmmInvalidUsageException">
    /// if fails to encode enumerated types dictionary.
    /// </exception>
    ///
    ...
    ///
    /// <param name="series">Series to be used for decoding enumerated types information from.
    /// </param>
    /// <param name="verbosity">The desired verbosity to decode.</param>
    ///
    /// <exception cref="OmmInvalidUsageException">
    /// if fails to decode enumerated types dictionary.
    /// </exception>
    ///
    /// <seealso cref="Access.Series"/>
    /// <seealso cref="EmaRdm"/>
    ...
    ///
    /// <exception cref="OmmInvalidUsageException">
    /// If dictionary type is not available.
    /// </exception>
    ///
    /// <seealso cref="Series"/>
    ...
    public int ExtractDictionaryType(Access.Series series)
    {
        ...
        try
        {
            ...
            Eta.Codec.Buffer encodedBuffer = series.Encoder!.m_encodeIterator!.Buffer(); // todo: need to bring order to different buffers series.m_bodyBuffer;
    ...
    public bool HasEntry(string fieldName)
    {
        ...
        try
        {
            ...
            return (nameToIdMap is not null
    ...
    /// with <see cref="OmmInvalidUsageException.ErrorCodes.INVALID_USAGE"/> error code</para>
    ///
    /// </remarks>
    ///
    /// <param name="fieldName">the field name to get the dictionary Entry for</param>
    ...
    ///
    /// <exception cref="OmmInvalidUsageException">
    /// if the Entry does not exist or entryDst is null or is owned by API.
    /// </exception>
    ///
    ...
    public bool HasEntry(int fieldId)
    {
        ...
        try
        {
            ...
            return m_rsslDataDictionary.Entry(fieldId) is not null;
        }
        finally
        {
            m_DictionaryLock.Exit();
    ...
    /// </exception>
    ///
    /// Same like <see cref="DataDictionary.Entry(int)"/> note, entryDst should be created
    /// first and managed by the user.
    ///
    /// Otherwise Dictionary is owned by API and method will throw <see cref="OmmInvalidUsageException"/>
...
#pragma warning restore CS8618
    ...
    private Locker m_DictionaryLock = new ReadLocker(new System.Threading.ReaderWriterLockSlim(System.Threading.LockRecursionPolicy.SupportsRecursion));
    ...
    private DictionaryEntry GetDictionaryEntry(DataDictionary dataDictionary, IDictionaryEntry dictionaryEntry)
    {
        ...
        if (dictionaryEntryImpl is null)
        {
    ...
    {
        if (m_RsslDecodeIterator is null)
        {
