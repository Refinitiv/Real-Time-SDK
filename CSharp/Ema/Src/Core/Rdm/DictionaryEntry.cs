...
public sealed class DictionaryEntry
{
    ...
    {
        get => m_rsslDictionaryEntry.GetAcronym().Data() is not null
    ...
    {
        get => m_rsslDictionaryEntry.GetDdeAcronym().Data() is not null
    ...
    /// This type is defined in <see cref="Eta.Codec.MfFieldTypes"/>
    /// </summary>
    ///
    ...
    /// <summary>
    /// RWF type.
    /// This type is defined in <see cref="Access.DataType.DataTypes"/>
    /// and less than 256.
    /// </summary>
    ///
    ...
    ///
    /// <exception cref="Access.OmmInvalidUsageException">
    ...
    {
        get => m_rsslDictionaryEntry.GetEnumTypeTable() is not null ? true : false;
    }
...
#pragma warning restore CS8618
    ...
    {
        if (m_EnumTypeTableImpl is null)
        {
