...
namespace LSEG.Ema.Access.Tests
{
    public class EmaComplexTypeSimpleTests
    {
        ...
        public void EncodeVectorUsingPreEncodedEntries_PassTest()
        {
            ...
            Assert.Equal(CodecReturnCode.SUCCESS, decodedVector.Decode(Codec.MajorVersion(), Codec.MinorVersion(), buffer, dataDictionary, null));
        ...
        public void EncodeSeriesUsingPostEncodedEntries_PassTest()
        {
            ...
            Assert.Equal(CodecReturnCode.SUCCESS, decodedSeries.Decode(Codec.MajorVersion(), Codec.MinorVersion(), buffer, dataDictionary, null));
        ...
        public void EncodeMapUsingMixedEncodedEntries_PassTest()
        {
            ...
            Assert.Equal(CodecReturnCode.SUCCESS, decodedMap.Decode(Codec.MajorVersion(), Codec.MinorVersion(), buffer, dataDictionary, null));
