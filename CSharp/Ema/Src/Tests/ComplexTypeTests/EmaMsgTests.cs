...
namespace LSEG.Ema.Access.Tests
{
    public class EmaMsgTests
    {
        ...
        public void EncodeAndDecodeUsingPreviouslyDecodedContainer()
        {
            ...
            Assert.Equal(CodecReturnCode.SUCCESS, decodedElementList.Decode(Codec.MajorVersion(), Codec.MinorVersion(), elementListBuffer, dictionary, null));
            ...
            reqMsg.ReturnToPool();
            decodedReqMsg.ReturnToPool();
            decodedElementList.ReturnToPool();
        ...
        public void CopyFromEncodedMessageTest()
        {
            ...
            foreach (bool completeEnc in values)
            {
                ...
                decodedElementList.ReturnToPool();
                array.ReturnToPool();
                sourceMsg.ReturnToPool();
                destinationMsg.ReturnToPool();
        ...
        public void EncodeAndDecodeMsgWithCopyFlagSetTest()
        {
            ...
            elementList.ReturnToPool();
            attribElementList.ReturnToPool();
            array.ReturnToPool();
            msg.ReturnToPool();
            decodedMsg.ReturnToPool();
        ...
        public void EncodeAndDecodeElementListWithMessagePayloadTest()
        {
            ...
            ElementList decodedElementList = m_objectManager.GetOmmElementList();
            Assert.Equal(CodecReturnCode.SUCCESS, decodedElementList.Decode(Codec.MajorVersion(), Codec.MinorVersion(), body, dictionary, null));
        ...
        public void EncodeAndDecodeVectorWithMessagePayloadTest()
        {
            ...
            foreach (var msgType in msgDataTypes)
            {
                ...
                Assert.Equal(CodecReturnCode.SUCCESS, decodedVector.Decode(Codec.MajorVersion(), Codec.MinorVersion(), body, dictionary, null));
        ...
        public void EncodeAndDecodeSeriesWithMessagePayloadTest()
        {
            ...
            foreach (var msgType in msgDataTypes)
            {
                ...
                Assert.Equal(CodecReturnCode.SUCCESS, decodedSeries.Decode(Codec.MajorVersion(), Codec.MinorVersion(), body, dictionary, null));
        ...
        public void EncodeAndDecodeMapWithMessagePayloadTest()
        {
            ...
            foreach (var msgType in msgDataTypes)
            {
                ...
                Assert.Equal(CodecReturnCode.SUCCESS, decodedMap.Decode(Codec.MajorVersion(), Codec.MinorVersion(), body, dictionary, null));
        ...
        public void EncodeAndDecodeFilterListWithMessagePayloadTest()
        {
            ...
            Assert.Equal(CodecReturnCode.SUCCESS, decodedFilterList.Decode(Codec.MajorVersion(), Codec.MinorVersion(), body, dictionary, null));
            ...
            decodedFilterList.ReturnToPool();
