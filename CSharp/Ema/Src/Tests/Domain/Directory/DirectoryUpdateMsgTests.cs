...
{
    public class DirectoryUpdateMsgTests
    {
        private DirectoryUpdateMsg CreateSampleDomainMessage() =>
        ...
        private void AssertDomainMsgEqual(DirectoryUpdateMsg expected, DirectoryUpdateMsg actual)
        {
            ...
            AssertEqualBy(expected, actual, x => x.DoNotConflate());
        ...
        public void Message_should_decode_previously_encoded()
        {
            ...
            var decodedEmaMsg = new UpdateMsg(emaMsg).MarkForClear();

            // Act
            var decodedDomainMsg = new DirectoryUpdateMsg().Message(decodedEmaMsg);
        ...
        {
            // Arrange
            var domainMsg = new DirectoryUpdateMsg();
            var emaMsg = new UpdateMsg().MarkForClear();
        ...
        public void CopyFrom_should_copy_properly()
        {
            ...
            // Act
            var copiedDomainMsg = new DirectoryUpdateMsg().CopyFrom(domainMsg);
        ...
        public void Clear_should_reset_properties()
        {
            ...
            Assert.False(domainMsg.DoNotConflate());
