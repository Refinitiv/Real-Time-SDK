...
internal class OmmConsumerDictionaryClientTest : IOmmConsumerClient
{
    ...
    public OmmConsumerDictionaryClientTest()
    {
    }

    public OmmConsumerDictionaryClientTest(OmmConsumer ommConsumer)
    {
