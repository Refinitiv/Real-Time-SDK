...
public class LoginHelperTest
{
    ...
    public void EncodeLoginRequest_Test()
    {
        ...
        decReqMsg.Decode(loginReq.Message().m_rsslMsg, Codec.MajorVersion(), Codec.MinorVersion(), dictionary);
        ...
        decodedEl.Decode(Codec.MajorVersion(), Codec.MinorVersion(),
            decReqMsg.Attrib().ElementList().m_bodyBuffer!,
            dictionary, null);
    ...
    public void DecodeLoginRequest_Test()
    {
        ...
        decReqMsg.Decode(encReqMsg.m_requestMsgEncoder.GetEncodedBuffer(),
    ...
    public void DecodeLoginReqInvalidType_Test()
    {
        ...
        {
            Assert.Contains("Decoding error for AllowSuspectData element. Attempt to uintValue() while actual entry data type is Ascii",
                ex.Message);
        }
    }
    ...
    public void EncodeLoginRefresh_Test()
    {
        ...
        decRefreshMsg.Decode(encRefreshMsg.m_refreshMsgEncoder.GetEncodedBuffer(),
            Codec.MajorVersion(), Codec.MinorVersion(), dictionary, null);

        Ema.Access.ElementList decodedEl = new ElementList();

        decodedEl.Decode(Codec.MajorVersion(), Codec.MinorVersion(), decRefreshMsg.Attrib().ElementList().m_bodyBuffer!,
            dictionary, null);
    ...
    public void EncodeLoginStatus_Test()
    {
        ...
        decStatusMsg.Decode(loginStatus.Message().m_rsslMsg, Codec.MajorVersion(), Codec.MinorVersion(), dictionary);
    ...
    public void DecodeLoginStatus_Test()
    {
        ...
        decStatusMsg.Decode(encStatusMsg.m_statusMsgEncoder.GetEncodedBuffer(),
            Codec.MajorVersion(), Codec.MinorVersion(), dictionary, null);
