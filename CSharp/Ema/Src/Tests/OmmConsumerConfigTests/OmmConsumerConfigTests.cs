...
public class ConsumerConfigTests
{
    ...
    {
        OmmConsumerConfigImpl configImpl = LoadEmaBlankConfig().OmmConsConfigImpl;
    ...
    public void XmlConfigTest()
    {
        ...
        // TODO: extract rest of the code to separate test methods, test classes
    ...
    // TODO: move to separate test class (ProgrammaticConfigTests) & split into several tests
    [Fact]
