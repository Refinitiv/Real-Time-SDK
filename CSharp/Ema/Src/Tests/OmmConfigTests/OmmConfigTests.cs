...
public class ConfigTests
{
    ...
    private static readonly ConsumerConfig defaultConsConfig = new ConsumerConfig();
    private static readonly NiProviderConfig defaultNiProviderConfig = new NiProviderConfig();
    private static readonly IProviderConfig defaultIProviderConfig = new IProviderConfig();
    private static readonly ServerConfig defaultServerConfig = new ServerConfig();
    private static readonly ClientChannelConfig defaultChannelConfig = new ClientChannelConfig();
    private static readonly LoggerConfig defaultLoggerConfig = new LoggerConfig();
    private static readonly DictionaryConfig defaultDictConfig = new DictionaryConfig();
    ...
    public void ConsumerXmlConfigTest()
    {
        ...
        // Check the first configured TestConsumer
        ...
        // Check the first configured TestChannel_1
        ...
        // TestChannel_2 contains the default
        ...
        // Check the configured TestLogger_1
        ...
        // Check the configured TestDictionary_1
        ...
        Assert.Equal("proxyPort1", testChannelConfig.ConnectInfo.ConnectOptions.ProxyOptions.ProxyPort);
        Assert.True(testChannelConfig.ConnectInfo.ConnectOptions.TcpOpts.TcpNoDelay);
        Assert.Equal(EncryptionProtocolFlags.ENC_TLSV1_2, testChannelConfig.ConnectInfo.ConnectOptions.EncryptionOpts.EncryptionProtocolFlags & EncryptionProtocolFlags.ENC_TLSV1_2);
