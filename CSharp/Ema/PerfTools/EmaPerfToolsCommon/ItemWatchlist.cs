...
namespace LSEG.Ema.PerfTools.Common
{
    public class ItemWatchlist
    {
        ...
        /// <summary>
        /// Removes all items from current <see cref="ItemWatchlist"/> that satisfy <paramref name="predicate"/>.
        /// </summary>
        /// <param name="predicate"></param>
        public void RemoveIf(Func<ItemInfo, bool> predicate) => m_EntryList.RemoveAll(new Predicate<ItemInfo>(predicate));
