...
510_RequestRouting_FileCfg is an example of an OMM Consumer application
...
510_RequestRouting_FileCfg showcases an usage of the request routing
...
510_RequestRouting_FileCfg implements the following high-level steps:
