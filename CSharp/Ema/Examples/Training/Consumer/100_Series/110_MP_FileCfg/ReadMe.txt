...
110_MP_FileConfig is an OMM Consumer application example
...
110_MP_FileConfig illustrates an implicit dependence of the 
...
110_MP_FileConfig implements the following high-level steps:
