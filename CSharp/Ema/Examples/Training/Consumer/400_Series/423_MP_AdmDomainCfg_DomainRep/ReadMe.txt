...
The 423_MP_AdmDomainCfg_DomainRep application is provided as
...
423_MP_AdmDomainCfg_DomainRep showcases customization of the default EMA
...
This application is the Domain Representation version of 420_MP_AdminDomainConfig. It demonstrates the
ease-of-use Domain Representation functionality.

Detailed Description
====================

423_MP_AdmDomainCfg_DomainRep implements the following high level steps:
