...
The 250_Custom_Opaque application is provided as an example of OMM Consumer
application written to the EMA library.

This application demonstrates basic usage of the EMA library for accessing
and parsing of OMM Custom Domain data from Refinitiv Data Feed Direct (RDF-D),
directly from an OMM Provider application, or from an Advanced
Distribution Server.

250_Custom_Opaque showcases opening and processing of a custom domain
...
250_Custom_Opaque implements the following high level steps:
