...
340_Login_Streaming is an example of an OMM NiProvider application written
to the EMA library.
...
340_Login_Streaming illustrates how to create and publish one OMM streaming item
...
340_Login_Streaming implements the following high-level steps:
...
+ Creates streaming item (refresh and updates) and publishes it
  - MarketPrice TRI.N item on the NI_PUB service
