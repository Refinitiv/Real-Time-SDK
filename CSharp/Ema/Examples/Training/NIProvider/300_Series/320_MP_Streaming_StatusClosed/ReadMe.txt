...
320_MP_Streaming_StatusClosed is an example of an OMM NiProvider application 
...
320_MP_Streaming_StatusClosed illustrates how to create and publish a single OMM
...
320_MP_Streaming_StatusClosed implements the following high-level steps:
