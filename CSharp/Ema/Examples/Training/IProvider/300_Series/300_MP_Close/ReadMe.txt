...
300_MP_Close is an example of an OMM Interactive Provider application written to
the EMA library.
...
300_MP_Close illustrates how to create and publish a single OMM streaming
item. This application uses source directory configured in the EmaConfig.xml
file.
