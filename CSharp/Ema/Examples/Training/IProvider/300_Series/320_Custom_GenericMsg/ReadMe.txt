...
320_Custom_GenericMsg is an example of an OMM Interactive Provider application
written to the EMA library.

This application demonstrates the basic usage of the EMA library in providing of
custom domain data to the Advanced Distribution Hub.

320_Custom_GenericMsg illustrates how to create and publish a single streaming
item of custom domain. This application uses source directory configured in the
EmaConfig.xml file.
...
320_Custom_GenericMsg implements the following high-level steps:
