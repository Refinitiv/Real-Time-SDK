...
421_MP_ProgrammaticCfg is an example of an OMM Interactive Provider application
written to the EMA library.

This application demonstrates the basic usage of the EMA library in providing of
OMM MarketPrice data to a Consumer application.

421_MP_ProgrammaticCfg illustrates how to create and publish a single OMM
streaming item. The example showcases creation and usage of the programmatic
configuration feature of EMA. In addition to file configuration, EMA allows
users to programmatically configure Omm Provider instances.
...
+ Instantiates and modifies an OmmIProviderConfig object:
  - sets Omm Provider configuration with data from the programmatic
    configuration
