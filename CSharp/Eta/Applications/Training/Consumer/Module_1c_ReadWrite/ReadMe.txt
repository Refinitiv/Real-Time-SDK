...
(IChannel.State) is ChannelState.ACTIVE, and applications can send
and receive data.
...
file and build the ConsMod1c project.
...
Module_1c_ReadWrite.cs - The main file for the Transport API Consumer Training application.
