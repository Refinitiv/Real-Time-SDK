...
namespace Refinitiv.Eta.Example.VACommon
{
    ...
    public class ConnectionArg
    {
        ...
        /// <summary>
        /// Encrypted protocol for this connection.
        /// </summary>
        ...
        public ConnectionArg(ConnectionType connectionType, string service, string hostname, string port, List<ItemArg> itemList)
        {
