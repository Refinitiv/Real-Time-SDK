...
The distribution contains several DLL files (libraries), intended to allow for ease of integration into both production and development environments.
    ...
    ------------                  ----------------  -----------
    LSEG.Eta.Core.dll             eta3.5.1.1        The ETA - CSharp Edition library.  Includes
                                                    the ETA transport package and the RWF codec.

    LSEG.Eta.ValueAdd.dll         eta3.5.1.1        The Value Add library for ETA CSharp Edition.
                                                    Includes the ETA Value Add Reactor and
                                                    Administration Domain Model Representations.

    LSEG.Eta.Ansi.dll             eta3.5.1.1        The ANSI decoders and encoders.
...
# Reference Information
    ...
    Load Number: 2
    Load ID: etacsharp3.5.1.L2.all
        Supersedes: etacsharp3.5.1.L1.all
    Release Status: RRG
    Release Type: RRG
    US ECCN: EAR99
    EU ECCN: None
