...
namespace LSEG.Eta.Codec
{
    ...
    /// <remarks>
    ///
    /// <para>This information can be applied to an Enterprise Platform cache
    /// or routed further upstream to the source of data. Once received, the upstream
    /// components can republish data to downstream consumers.</para>
    ///
    /// <para>Post messages can be routed along a specific item stream, referred to as
    /// on-stream posting, or along a user's Login stream, referred to as off-stream
    /// posting.</para>
    ///
    /// <para>A <see cref="IPostMsg"/> can contain any ETA container type,
    /// including other messages.  User identification information can be associated
    /// with a post message and can be provided along with the content that was
    /// posted.</para>
    /// </remarks>
    /// <seealso cref="IMsg"/>
