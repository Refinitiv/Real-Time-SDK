...
namespace LSEG.Eta.Codec
{
	...
	/// semantics associated with it, thus the name generic.
	/// </summary>
	/// <remarks>
	///
	/// <para>
	/// Once a stream is established via a request-refresh/status interaction, this
	/// message can be sent from consumer to provider as well as from provider to
	/// consumer, and can also be leveraged by non-interactive provider applications.</para>
	///
	/// <para>
	/// Generic messages are transient and are typically not cached by any Enterprise
	/// Platform components.</para>
	///
	/// <para>
	/// The msgKey of a <see cref="IGenericMsg"/> does not need to match the
	/// <see cref="IMsgKey"/> information associated with the stream the generic
	/// message is flowing on. This allows for the key information to be used
	/// independently of the stream.</para>
	///
	/// <para>
	/// Any specific message usage, msgKey usage, expected interactions, and handling
	/// instructions are typically defined by a domain message model specification.</para>
    ///
	/// </remarks>
	/// <seealso cref="IMsg"/>
