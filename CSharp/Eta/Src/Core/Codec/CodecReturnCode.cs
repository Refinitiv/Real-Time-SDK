...
namespace LSEG.Eta.Codec
{
	...
	public enum CodecReturnCode
	{
		...
		/// content than is supported by a single <see cref="EncodeIterator"/>. There is a
		/// limit of 16 levels.
		/// </summary>
		ITERATOR_OVERRUN = -33,
		...
		/// <summary>
		/// Indicates that <see cref="FieldList"/> or <see cref="ElementList"/> encoding requires
		/// a set definition database which was not provided
		/// </summary>
		SET_DEF_NOT_PROVIDED = -27,

		/// <summary>
		/// Indicates that the <see cref="Buffer"/> contained on the <see cref="DecodeIterator"/>
		...
		/// <summary>
		/// Indicates that the <see cref="Buffer"/> contained on the <see cref="EncodeIterator"/>
		...
		/// calling <see cref="IMsg.EncodeInit(EncodeIterator, int)"/> if the application
		/// indicates that the message should include msgKey attributes without
		/// populating pre-encoded data into the <see cref="IMsgKey.EncodedAttrib()"/>.
		/// </summary>
		...
		/// <see cref="IMsg.EncodeInit(EncodeIterator, int)"/> without populating
		/// pre-encoded data into the <see cref="IMsg.ExtendedHeader()"/>.
		/// </summary>
		...
		/// <summary>
		/// Indicates that <see cref="FieldList"/> or <see cref="ElementList"/> encoding is
		...
		/// <summary>
		/// Indicates that <see cref="FieldList"/> or <see cref="ElementList"/> decoding skipped
    ...
    public static class CodecReturnCodeExtensions
    {
        ...
        /// </summary>
        /// <param name="retCode"> <see cref="CodecReturnCode"/> enumeration to convert to string
        /// </param>
        ...
        /// </summary>
        /// <param name="retCode"> <see cref="CodecReturnCode"/> enumeration to return info for
        /// </param>
