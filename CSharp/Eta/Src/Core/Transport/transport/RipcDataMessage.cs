...
namespace LSEG.Eta.Transports
{
    internal struct RipcDataMessage
    {
        ...
        internal static void PopulateRipcHeader(TransportBuffer bigBuffer, TransportBuffer buffer, bool firstFragment, byte flags, 
        ...
        */
        internal static int PopulateFirstFragment(TransportBuffer bigBuffer, TransportBuffer buffer, byte flags, byte optFlags, int totalLength, 
        ...
        * Returns TransportReturnCodes.FAILURE before any data is copied, if the input data will not fit in the fragment.
        */
        internal static int PopulateNextFragment(TransportBuffer bigBuffer, TransportBuffer buffer, byte flags, byte optFlags, byte[] inData, 
