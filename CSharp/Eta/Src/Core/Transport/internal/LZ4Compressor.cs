...
namespace LSEG.Eta.Internal
{
    internal class Lz4Compressor : Compressor
    {
        ...
        public override int Compress(TransportBuffer bufferToCompress, int dataStartPos, int lenToCompress)
        {
            ...
            {
                m_CompressedBytes = new byte[LZ4Codec.MaximumOutputSize(MaxCompressionLength)];
            }
        ...
        {
            int bytesWrittern = LZ4Codec.Decode(bufferToDecompress.Data.Contents, bufferToDecompress.GetDataStartPosition(), lenToDecompress,
