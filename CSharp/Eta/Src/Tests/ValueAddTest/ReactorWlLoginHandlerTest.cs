...
public class ReactorWlLoginHandlerTest
{
    ...
    private void LoginPauseResume(bool isWebsocket, string protocolList)
    {
        ...
        int pausedCount = ((WlItemHandler)consumerReactor.ComponentList[0].ReactorChannel.Watchlist.ItemHandler).StreamList.First.Value.NumPausedRequestsCount;
        int itemCount = ((WlItemHandler)consumerReactor.ComponentList[0].ReactorChannel.Watchlist.ItemHandler).StreamList.First.Value.UserRequestList.Count;
        ...
        pausedCount = ((WlItemHandler)consumerReactor.ComponentList[0].ReactorChannel.Watchlist.ItemHandler).StreamList.First.Value.NumPausedRequestsCount;
        itemCount = ((WlItemHandler)consumerReactor.ComponentList[0].ReactorChannel.Watchlist.ItemHandler).StreamList.First.Value.UserRequestList.Count;
    ...
    private void LoginPauseResumeToken(bool isWebsocket, string protocolList)
    {
        ...
        opts.SetupDefaultLoginStream = true;
        opts.SetupDefaultDirectoryStream = true;
        // opts.DirectoryHandler = new MockDirectoryHandler();
        // opts.ItemHandler = new MockItemHandler();
