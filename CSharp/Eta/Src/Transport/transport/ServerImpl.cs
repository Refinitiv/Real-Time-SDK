...
namespace Refinitiv.Eta.Transports
{
    internal class ServerImpl : IServer
    {
        ...
        private ProtocolBase m_ProtocolBase;
        ...
        internal int NumOfChannels { get; set; }

        private Pool m_SharedPool;
        ...
        public IChannel Accept(AcceptOptions opts, out Error error)
        {
            ...
            try
            {
                ...
                socketChannel.SendTimeout = 500;
                socketChannel.ReceiveTimeout = 500;
