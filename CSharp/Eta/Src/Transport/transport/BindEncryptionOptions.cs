...
namespace Refinitiv.Eta.Transports
{
    ...
    public class BindEncryptionOptions
    {
        ...
        {
            return $"EncryptionProtocolFlags: {EncryptionProtocolFlags}, ServerCertificate: {ServerCertificate}, ServerPrivateKey: {ServerPrivateKey}, TlsCipherSuites: {TlsCipherSuites}";
        }
    }
}
