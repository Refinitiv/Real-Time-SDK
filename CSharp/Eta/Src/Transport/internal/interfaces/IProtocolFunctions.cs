...
namespace Refinitiv.Eta.Internal.Interfaces
{
    internal interface IProtocolFunctions
    {
        ...
        int RemaingBytesAfterPausing(BigTransportBuffer bigBuffer);

        /* Populates fragmented messages without compression */
        int PopulateFragment(BigTransportBuffer bigBuffer, bool firstFragment, TransportBuffer buffer, byte flags, WriteArgs writeArgs);

        /* Populates fragmented messages with compression */
        int WriteFragmentCompressed(BigTransportBuffer bigBuffer, TransportBuffer buffer, WriteArgs writeArgs, bool firstFragment, out Error error);
