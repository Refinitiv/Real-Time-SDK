...
{
    internal class WlRequestList
    {
        private WlRequest? _head, _tail;
        private WlRequest? _iter;
        private int _count;

        public WlRequestList()
        {
            Clear();
        }
        ...
        public void PushBack(WlRequest elem)
        {
            if (_tail != null)
            {
                elem.m_prev = _tail;
        ...
        /// </summary>
        /// <param name="elem">the element to add</param>
        public void Push(WlRequest elem)
        {
            if (_head != null)
            {
                elem.m_next = _head;
        ...
        /// </summary>
        /// <returns>The first element</returns>
        public WlRequest? Pop()
        {
            WlRequest? head = _head;
            if (head != null)
                Remove(head);
            return head;
        }
        ...
        public void Remove(WlRequest elem)
        {
