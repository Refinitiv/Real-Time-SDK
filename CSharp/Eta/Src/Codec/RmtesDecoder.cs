...
namespace Refinitiv.Eta.Codec
{
    ...
    public class RmtesDecoder
    {
        ...
        /// <returns>The smallest byte that is contained in the given character set</returns>
        ...
        /// <returns>True if the input character is a GL character, false otherwise</returns>
        ...
        /// <param name="c">input character</param>
        /// <param name="set">current working set</param>
        /// <returns>True if the input character is a GR character, false otherwise</returns>
        ...
        /// <returns>The transformed character</returns>
        ...
        /// <returns>RMTES decoding state represented by <see cref="RmtesInfo"/></returns>
        ...
        ///Typical use:
        ///1. Allocate memory for the cache buffer.
        ///2. After decoding the payload buffer, call RMTESApplyToCache to copy the
        ///data to the RmtesCacheBuffer.
        ///3. Allocate memory for the unicode string.
        ///4. Call RMTESToUCS2 to convert the RMTES data for display or parsing.
        /// </summary>
        ...
        ///data to the RmtesCacheBuffer.
        ///3. Allocate memory for the unicode string.
        ///4. Call RMTESToUTF8 to convert the RMTES data for display or parsing.
        /// </summary>
        /// <param name="rmtesBuffer">Buffer used to store decoded RMTES data</param>
        /// <param name="cacheBuffer">Buffer containing encoded RMTES data</param>
        /// <returns><see cref="CodecReturnCode"/></returns>
        ...
        /// <returns>true if the input buffer contains partial update, false otherwise</returns>
        public Boolean HasPartialRMTESUpdate(Buffer buffer)
        {
            int numCount = 0;
            RMTESParseState state = RMTESParseState.NORMAL;

            for (int i = buffer.Position; i < buffer.Length + buffer.Position; ++i)
            {
                switch (state)
                {
        ...
        /// finding any partial RMTES updates</param>
        /// <returns><see cref="CodecReturnCode"/></returns>
