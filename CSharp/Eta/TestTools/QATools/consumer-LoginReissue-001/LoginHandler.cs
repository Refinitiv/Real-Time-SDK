...
namespace LSEG.Eta.Example.Common
{
    ...
    public class LoginHandler
    {
        ...
        public TransportReturnCode SendPauseResumeRequest(ChannelSession chnl, out Error error, Boolean pauseAll, Boolean resumeAll)
        {
            ...
            if (AuthenticationToken != null && !String.IsNullOrEmpty(AuthenticationToken))
            {
                ...
                if (AuthenticationExtended != null && !String.IsNullOrEmpty(AuthenticationExtended))
                {
                    LoginRequest.HasAuthenticationExtended = true;
                    LoginRequest.AuthenticationExtended.Data(AuthenticationExtended);
                }
            ...
            if (ApplicationName != null && !String.IsNullOrWhiteSpace(ApplicationName))
            {
                LoginRequest.HasAttrib = true;
                LoginRequest.LoginAttrib.HasApplicationName = true;
                LoginRequest.LoginAttrib.ApplicationName.Data(ApplicationName);
            ...
            if (ret != CodecReturnCode.SUCCESS)
            {
                error.Text = "Encoding of login request failed: <" + CodecReturnCodeExtensions.GetAsString(ret) + ">\n";
