...
namespace LSEG.Eta.Example.Consumer
{
    public class Consumer : ResponseCallback
    {
        ...
        private void ProcessMarketPriceResponse(Msg responseMsg, DecodeIterator dIter)
        {
            ...
            {
                Console.WriteLine("---------------------------------------------------------------------------");
                Console.WriteLine("Test#1 Real.Value(\"\") as String.------------------------------------");
                Real real = new Real();
                CodecReturnCode ret = 0;

                real.Clear();
                ret = real.Value("9223372036854775807");
                Console.WriteLine("Input :9223372036854775807 |Return code: " + ret 
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);

                real.Clear();
                ret = real.Value("9223372036854775807.0");
                Console.WriteLine("Input :9223372036854775807.0 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value("9223372036854775807.00");
                Console.WriteLine("Input :9223372036854775807.00 |Return code: " + ret
                   + " |real.ToString(): " + real.ToString()
                   + " |real.ToDouble(): " + real.ToDouble()
                   + " |real.ToLong(): " + real.ToLong()
                   + " |real.Hint: " + real.Hint);
                ...
                Console.WriteLine("Input :9223372036854775.807 |Return code: " + ret
                   + " |real.ToString(): " + real.ToString()
                   + " |real.ToDouble(): " + real.ToDouble()
                   + " |real.ToLong(): " + real.ToLong()
                   + " |real.Hint: " + real.Hint);
                ...
                Console.WriteLine("Input :9223372036854775.8070 |Return code: " + ret
                   + " |real.ToString(): " + real.ToString()
                   + " |real.ToDouble(): " + real.ToDouble()
                   + " |real.ToLong(): " + real.ToLong()
                   + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value("9223372036854774.807");
                Console.WriteLine("Input :9223372036854774.807 |Return code: " + ret
                   + " |real.ToString(): " + real.ToString()
                   + " |real.ToDouble(): " + real.ToDouble()
                   + " |real.ToLong(): " + real.ToLong()
                   + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value("9223372036854774.8070");
                Console.WriteLine("Input :9223372036854775.8070 |Return code: " + ret
                   + " |real.ToString(): " + real.ToString()
                   + " |real.ToDouble(): " + real.ToDouble()
                   + " |real.ToLong(): " + real.ToLong()
                ...
                real.Clear();           
                ret = real.Value("9223372036854775.5");
                Console.WriteLine("Input :9223372036854775.5 |Return code: " + ret
                   + " |real.ToString(): " + real.ToString()
                   + " |real.ToDouble(): " + real.ToDouble()
                   + " |real.ToLong(): " + real.ToLong()
                   + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value("9223372036854774.5");
                Console.WriteLine("Input :9223372036854774.5 |Return code: " + ret
                  + " |real.ToString(): " + real.ToString()
                  + " |real.ToDouble(): " + real.ToDouble()
                  + " |real.ToLong(): " + real.ToLong()
                  + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value("9223372036854773.5");
                Console.WriteLine("Input :9223372036854773.5 |Return code: " + ret
                  + " |real.ToString(): " + real.ToString()
                  + " |real.ToDouble(): " + real.ToDouble()
                  + " |real.ToLong(): " + real.ToLong()
                  + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value("9223372036854775807.01");
                Console.WriteLine("Input :9223372036854775807.01 |Return code: " + ret
                  + " |real.ToString(): " + real.ToString()
                  + " |real.ToDouble(): " + real.ToDouble()
                  + " |real.ToLong(): " + real.ToLong()
                  + " |real.Hint: " + real.Hint);
                ...
                Console.WriteLine("Input :9223372036854775808 |Return code: " + ret
                   + " |real.ToString(): " + real.ToString()
                   + " |real.ToDouble(): " + real.ToDouble()
                   + " |real.ToLong(): " + real.ToLong()
                   + " |real.Hint: " + real.Hint);
                ...
                Console.WriteLine("Input :9223372036854775808.0 |Return code: " + ret
                  + " |real.ToString(): " + real.ToString()
                  + " |real.ToDouble(): " + real.ToDouble()
                  + " |real.ToLong(): " + real.ToLong()
                  + " |real.Hint: " + real.Hint);
                ...
                Console.WriteLine("Input :9223372036854775808.00 |Return code: " + ret
                   + " |real.ToString(): " + real.ToString()
                   + " |real.ToDouble(): " + real.ToDouble()
                   + " |real.ToLong(): " + real.ToLong()
                   + " |real.Hint: " + real.Hint);
                ...
                Console.WriteLine("Input :-9223372036854775809 |Return code: " + ret
                   + " |real.ToString(): " + real.ToString()
                   + " |real.ToDouble(): " + real.ToDouble()
                   + " |real.ToLong(): " + real.ToLong()
                   + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value("-9223372036854775809.0");
                Console.WriteLine("Input :-9223372036854775809.0 |Return code: " + ret
                   + " |real.ToString(): " + real.ToString()
                   + " |real.ToDouble(): " + real.ToDouble()
                   + " |real.ToLong(): " + real.ToLong()
                   + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value("-9223372036854775809.00");
                Console.WriteLine("Input :-9223372036854775809.00 |Return code: " + ret
                   + " |real.ToString(): " + real.ToString()
                   + " |real.ToDouble(): " + real.ToDouble()
                   + " |real.ToLong(): " + real.ToLong()
                   + " |real.Hint: " + real.Hint);
                ...
                Console.WriteLine("Input :-9223372036854775.808 |Return code: " + ret 
                   + " |real.ToString(): " + real.ToString()
                   + " |real.ToDouble(): " + real.ToDouble()
                   + " |real.ToLong(): " + real.ToLong()
                   + " |real.Hint: " + real.Hint);
                ...
                Console.WriteLine("Input :-9223372036854775.8080 |Return code: " + ret
                   + " |real.ToString(): " + real.ToString()
                   + " |real.ToDouble(): " + real.ToDouble()
                   + " |real.ToLong(): " + real.ToLong()
                   + " |real.Hint: " + real.Hint);
                ...
                Console.WriteLine("Test#2 Real.Value(double, int).------------------------------------");
                real.Clear();
                ret = real.Value(9223372036854775807, RealHints.EXPONENT_1);
                Console.WriteLine("Input :9223372036854775807, RealHints.EXPONENT_1 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value(9223372036854775807, RealHints.EXPONENT_2);
                Console.WriteLine("Input :9223372036854775807, RealHints.EXPONENT_2 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value(9223372036854775807, RealHints.EXPONENT_3);
                Console.WriteLine("Input :9223372036854775807, RealHints.EXPONENT_3 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value(9223372036854775808, RealHints.EXPONENT_1);
                Console.WriteLine("Input :9223372036854775808, RealHints.EXPONENT_1 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value(9223372036854775808, RealHints.EXPONENT_2);
                Console.WriteLine("Input :9223372036854775808, RealHints.EXPONENT_2 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value(9223372036854775808, RealHints.EXPONENT_3);
                Console.WriteLine("Input :9223372036854775808, RealHints.EXPONENT_3 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value(9223372036854775807.0, RealHints.EXPONENT_1);
                Console.WriteLine("Input :9223372036854775807.0, RealHints.EXPONENT_1 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint); ;
                ...
                real.Clear();
                ret = real.Value(9223372036854775.807, RealHints.EXPONENT_1);
                Console.WriteLine("Input :9223372036854775.807, RealHints.EXPONENT_1 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value(9223372036854775.807, RealHints.EXPONENT_2);
                Console.WriteLine("Input :9223372036854775.807, RealHints.EXPONENT_2 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value(9223372036854775.807, RealHints.EXPONENT_3);
                Console.WriteLine("Input :9223372036854775.807, RealHints.EXPONENT_3 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value(-9223372036854775808.0, RealHints.EXPONENT_1);
                Console.WriteLine("Input :-9223372036854775808.0, RealHints.EXPONENT_1 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint); ;
                ...
                real.Clear();
                ret = real.Value(-9223372036854775.808, RealHints.EXPONENT_1);
                Console.WriteLine("Input :-9223372036854775.808, RealHints.EXPONENT_1 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value(-9223372036854775.808, RealHints.EXPONENT_2);
                Console.WriteLine("Input :-9223372036854775.808, RealHints.EXPONENT_2 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);
                ...
                real.Clear();
                ret = real.Value(-9223372036854775.808, RealHints.EXPONENT_3);
                Console.WriteLine("Input :-9223372036854775.808, RealHints.EXPONENT_3 |Return code: " + ret
                    + " |real.ToString(): " + real.ToString()
                    + " |real.ToDouble(): " + real.ToDouble()
                    + " |real.ToLong(): " + real.ToLong()
                    + " |real.Hint: " + real.Hint);
