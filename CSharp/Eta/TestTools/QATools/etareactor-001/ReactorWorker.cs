                    ...
                    case ReactorEventImpl.ImplType.CHANNEL_DOWN:
                        {
                            ...
                            if (reactorChannel != null && reactorChannel.Server == null && !reactorChannel.RecoveryAttemptLimitReached())
                            {
                                ...
                                //APIQA
                                Console.Write("--------------APIQA, ReactorChannel: Using connection {0} \n--------------APIQA, ReactorChannel: reconnectDelay is {1}\n\n",
                                  reactorChannel.GetConnectionListIndex(), reactorChannel.GetReconnectionDelay());
                                //END APIQA
