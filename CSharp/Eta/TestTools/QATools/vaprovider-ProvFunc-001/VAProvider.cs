...
namespace LSEG.Eta.ValueAdd.Provider
{
    public class VAProvider : IRDMLoginMsgCallback, IDirectoryMsgCallback, IDictionaryMsgCallback, IReactorChannelEventCallback, IDefaultMsgCallback
    {
        ...
        private const int defaultOpenWindow = 256;
        //END APIQA
        ...
        private void Init(string[] args)
        {
            ...
            //APIQA
            if (m_ProviderCmdLineParser.OpenWindow != 0)
            {
                openWindow = m_ProviderCmdLineParser.OpenWindow;
            }
            else
            {
            ...
            //APIQA
            Console.WriteLine($"supportView: {m_ProviderCmdLineParser.SupportView}");
            Console.WriteLine($"openWindow: {m_ProviderCmdLineParser.OpenWindow}");
            //END APIQA
            ...
            m_LoginHandler.Init();
            //APIQA
            m_LoginHandler.SupportView = m_ProviderCmdLineParser.SupportView;
            //END APIQA
            ...
            //APIQA
            m_DirectoryHandler.OpenWindow = m_ProviderCmdLineParser.OpenWindow;
            //END APIQA
            m_ItemHandler.Init();
