...
namespace LSEG.Eta.Tools.TransportTest
{
    ...
    public class TransportTest
    {
                                    ...
                                    if (encryptDecrypt == true)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                ByteBuffer newByteBuffer = new(sendbuffer2.Length());
                                                newByteBuffer.Put(sendbuffer2.Data.Contents, sendbuffer2.GetDataStartPosition(), sendbuffer2.Length());
                                                newByteBuffer.Flip();
                                                tempBuffer.Data(newByteBuffer);

                                                DisplayHexData(tempBuffer);
                                                sendbuffer = sendbuffer2;
                                            }
                                        }
                                    }
            ...
            else
            {
                do
                {
                    ...
                    if ((buffer = channel.Read(readArgs, out Error error)) != null)
                    {
                        ...
                        {
                            Console.WriteLine($"SessionId Id={channel.Socket.Handle}  Size {buffer.Length()}");
                            Console.WriteLine($"bytesRead={readArgs.BytesRead}, uncompressedBytesRead={readArgs.UncompressedBytesRead}");
        ...
        private static bool FillAndValidateServerEncryptedOptions(BindOptions serverOptions)
        {
            ...
            certificateFile = GetInput("SSL Certificate: ");
            ...
            privateKeyFile = GetInput("SSL Key: ");
