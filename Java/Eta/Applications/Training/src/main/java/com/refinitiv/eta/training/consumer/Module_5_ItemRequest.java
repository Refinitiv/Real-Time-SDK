...
public class Module_5_ItemRequest
{
                            ...
                            if (msgBuf != null)
                            {
                                ...
                                switch (msg.domainType())
                                {
                                    ...
                                    case DomainTypes.SOURCE:
                                    {
                                         ...
                                         * broken into a multi-part message. ETA
     ...
     * * etaChannelInfo - The channel management information including the
    ...
    static com.refinitiv.eta.codec.Float fidFloatValue = CodecFactory.createFloat();
    static com.refinitiv.eta.codec.Double fidDoubleValue = CodecFactory.createDouble();
    static com.refinitiv.eta.codec.Enum fidEnumValue = CodecFactory.createEnum();
    static com.refinitiv.eta.codec.Date fidDateValue = CodecFactory.createDate();
