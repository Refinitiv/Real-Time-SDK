...
package com.rtsdk.eta.training.niprovider;
...
import com.rtsdk.eta.training.common.TrainingModuleUtils;
...
import com.rtsdk.eta.transport.InProgFlags;
...
public class Module_5_ProvideContent
{
    ...
    public static final String fieldDictionaryFileName = "RDMFieldDictionary";

    /* enum table file name */
    public static final String enumTypeDictionaryFileName = "enumtype.def";
    ...
    public static void main(String[] args)
    {
        ...
        /* _LOCK_NONE is used since this is a single threaded application.
         * For applications with other thread models (_LOCK_GLOBAL_AND_CHANNEL, _LOCK_GLOBAL),
        ...
        */
        ...
        while (true)
        {
            ...
            try
            {
                ...
                {
                    if (isLoginSuccessful && (selector.select() == 0))
    ...
    public static int sendMessage(Channel channel, TransportBuffer msgBuf)
    {
         ...
         * WriteFlags.WRITE_DIRECT_SOCKET_WRITE, see the UPA C developers guide
         * for Write Flag Enumeration Values supported by UPA Transport.
         *
    ...
    public static int sendLoginRequest(Channel channel, int maxFragmentSize, EncodeIterator encIter)
    {
        ...
        /* The initial Login request must be streaming (i.e., a _RQMF_STREAMING flag is required). */
     ...
     * an RefreshMsg, conveying all necessary identification information for the content. Because the provider instantiates
    ...
    public static int sendMarketPriceItemResponse(Channel channel, int maxMsgSize, EncodeIterator encodeIter, int serviceId, DataDictionary dictionary)
    {
        int retval;
        Error error = TransportFactory.createError();
        TransportBuffer msgBuf = null;
        ...
        /* After providing a Source Directory, the NIP application can begin pushing content to the ADH. Each unique information stream should begin with an RefreshMsg,
         ...
         * the message key on all RefreshMsgs. See the component specific documentation for more information. */
