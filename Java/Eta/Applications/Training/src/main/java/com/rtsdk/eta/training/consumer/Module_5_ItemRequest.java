...
package com.rtsdk.eta.training.consumer;
...
public class Module_5_ItemRequest
{
    ...
    static com.rtsdk.eta.codec.Float fidFloatValue = CodecFactory.createFloat();
    static com.rtsdk.eta.codec.Double fidDoubleValue = CodecFactory.createDouble();
    static com.rtsdk.eta.codec.Enum fidEnumValue = CodecFactory.createEnum();
    static com.rtsdk.eta.codec.Date fidDateValue = CodecFactory.createDate();
