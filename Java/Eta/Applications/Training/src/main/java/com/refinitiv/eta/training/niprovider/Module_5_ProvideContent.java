...
public class Module_5_ProvideContent
{
    ...
    public static int sendMessage(Channel channel, TransportBuffer msgBuf)
    {
         ...
         * WriteFlags.WRITE_DIRECT_SOCKET_WRITE, see the ETA C developers guide
         * for Write Flag Enumeration Values supported by ETA Transport.
         *
    ...
    public static int sendMarketPriceItemResponse(Channel channel, int maxMsgSize, EncodeIterator encodeIter, int serviceId, DataDictionary dictionary)
    {
        ...
        if (!marketPriceItemInfo_isRefreshComplete) /* this is a refresh message */
        {
            ...
            System.out.printf("ETA NI Provider application is providing a MarketPrice Item refresh message.\n\n");
        }
        else /* this is an update message */
        {
            ...
            System.out.printf("ETA NI Provider application is providing a MarketPrice Item update message.\n\n");
        }
