package com.rtsdk.eta.perftools.upajconsperf;
...
import com.rtsdk.eta.perftools.common.DictionaryHandler;
import com.rtsdk.eta.perftools.common.DirectoryHandler;
import com.rtsdk.eta.perftools.common.ItemEncoder;
import com.rtsdk.eta.perftools.common.ItemFlags;
import com.rtsdk.eta.perftools.common.ItemInfo;
import com.rtsdk.eta.perftools.common.LatencyRandomArray;
import com.rtsdk.eta.perftools.common.LatencyRandomArrayOptions;
import com.rtsdk.eta.perftools.common.LoginHandler;
import com.rtsdk.eta.perftools.common.MarketPriceItem;
import com.rtsdk.eta.perftools.common.PerfToolsReturnCodes;
import com.rtsdk.eta.perftools.common.ProviderPerfConfig;
import com.rtsdk.eta.perftools.common.ResponseCallback;
import com.rtsdk.eta.perftools.common.ShutdownCallback;
...
public class ConsumerThread implements Runnable, ResponseCallback, ConsumerCallback
{
	...
	private int writeMsg(Msg msg)
	{
        ...
        {
            if (_reactorChannel.state() == com.rtsdk.eta.valueadd.reactor.ReactorChannel.State.READY)
            {
