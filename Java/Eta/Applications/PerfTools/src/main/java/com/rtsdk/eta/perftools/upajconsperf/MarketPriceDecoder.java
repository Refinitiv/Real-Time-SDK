...
/**
 * This is the market price decoder for the upajConsPerf application.
 */
public class MarketPriceDecoder
{
    ...
    private com.rtsdk.eta.codec.Enum _fidEnumValue; /* storage for Enum */
    ...
    private com.rtsdk.eta.codec.Float _fidFloatValue; /* storage for Float */
    private com.rtsdk.eta.codec.Double _fidDoubleValue; /* storage for Double */
