...
import com.rtsdk.eta.perftools.common.ResourceUsageStats;
import com.rtsdk.eta.perftools.common.ShutdownCallback;
import com.rtsdk.eta.perftools.common.TimeRecord;
import com.rtsdk.eta.perftools.common.TimeRecordQueue;
import com.rtsdk.eta.perftools.common.ValueStatistics;
import com.rtsdk.eta.perftools.common.XmlItemInfoList;
import com.rtsdk.eta.perftools.common.XmlMsgData;

/**
 * <p>
 * The upajConsPerf application. Implements a consumer, which requests items from a
 ...
 * determine the end-to-end latency. upajConsPerf also supports measurement of 
...
public class upajConsPerf implements ShutdownCallback
{
	...
	/* Initializes upajConsPerf application. */
	...
	{
		upajConsPerf consumerperf = new upajConsPerf();
