...
import com.rtsdk.eta.perftools.common.ItemAttributes;
import com.rtsdk.eta.perftools.common.ItemFlags;
import com.rtsdk.eta.perftools.common.ItemInfo;
import com.rtsdk.eta.perftools.common.NIProvPerfConfig;
...
import com.rtsdk.eta.valueadd.reactor.NIProviderCallback;
...
public class NIProviderThread extends ProviderThread implements NIProviderCallback
{
    ...
    private NIProviderRole _role; // Use the VA Reactor instead of the ETA Channel for sending and receiving
    ...
    private void initializeChannel()
    {
        ...
        _loginHandler.applicationName("NIProvPerf");
    ...
    private void initializeReactor()
    {
        ...
        _role.rdmLoginRequest().attrib().applicationName().data("NIProvPerf");
