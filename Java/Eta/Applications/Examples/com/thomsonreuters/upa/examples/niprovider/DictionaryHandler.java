...
public class DictionaryHandler
{
    ...
    static final String FIELD_DICTIONARY_DOWNLOAD_NAME = "RWFFld";
    static final String ENUM_TYPE_DOWNLOAD_NAME = "RWFEnum";
    ...
    int sendDictionaryRequests(ChannelSession chnl, Error error, int serviceId)
	{
	...
	int processResponse(Msg msg, DecodeIterator dIter, Error error)
	{
        switch (msg.msgClass())
        {
