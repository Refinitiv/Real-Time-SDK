 ...
 */
public class StreamIdWatchList implements
        Iterable<Map.Entry<StreamIdWatchList.StreamIdKey, WatchListEntry>>
{
    ...
    public static class WatchListEntry
    {
        ...
        public String toString()
        {
            return "isPrivateStream: " + isPrivateStream + ", itemName: " + itemName
                    + ", itemState: " + itemState + ", domainType:"
