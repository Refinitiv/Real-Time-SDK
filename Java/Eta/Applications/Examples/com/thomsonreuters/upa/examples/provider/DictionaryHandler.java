...
public class DictionaryHandler
{
    ...
    public DictionaryHandler(ProviderSession providerSesssion)
    {
    ...
    int sendDictionaryRequests(Channel chnl, Error error, int serviceId)
	{
	...
	int processMessage(Channel chnl,Msg msg, DecodeIterator dIter, Error error)
	{
        switch (msg.msgClass())
        {
