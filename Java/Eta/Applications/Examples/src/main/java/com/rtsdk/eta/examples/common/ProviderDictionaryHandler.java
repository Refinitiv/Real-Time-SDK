...
import com.rtsdk.eta.shared.DictionaryRequestInfo;
import com.rtsdk.eta.shared.DictionaryRequestInfoList;
...
public class ProviderDictionaryHandler
{
	...
	int processRefresh(Msg msg, DecodeIterator dIter, com.rtsdk.eta.transport.Error error)
	{
