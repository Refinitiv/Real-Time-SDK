...
import com.rtsdk.eta.shared.rdm.marketprice.MarketPriceRefreshFlags;
...
public class MarketByOrderRefresh extends MarketByOrderResponseBase
{
    ...
    /* (non-Javadoc)
     * @see com.rtsdk.eta.shared.rdm.marketbyorder.MarketByOrderResponseBase#isRefreshType()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.rtsdk.eta.valueadd.domainrep.rdm.MsgBaseImpl#toString()
     */
    ...
    /* (non-Javadoc)
     * @see com.rtsdk.eta.shared.rdm.marketbyorder.MarketByOrderResponseBase#encodeSummaryData(com.rtsdk.eta.codec.EncodeIterator, com.rtsdk.eta.codec.DataDictionary, com.rtsdk.eta.codec.Map)
     */
    ...
    /* (non-Javadoc)
     * @see com.rtsdk.eta.shared.rdm.marketbyorder.MarketByOrderResponseBase#encodeMapEntries(com.rtsdk.eta.codec.EncodeIterator, com.rtsdk.eta.codec.DataDictionary)
     */
    ...
    /* (non-Javadoc)
     * @see com.rtsdk.eta.shared.rdm.marketbyorder.MarketByOrderResponseBase#encodeMsg()
     */
    ...
    /* (non-Javadoc)
     * @see com.rtsdk.eta.valueadd.domainrep.rdm.MsgBase#domainType()
     */
    @Override
