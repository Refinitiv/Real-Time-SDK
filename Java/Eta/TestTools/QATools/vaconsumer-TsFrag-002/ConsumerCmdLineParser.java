...
class ConsumerCmdLineParser implements CommandLineParser
{
    ...
    // APIQA: adding new parameter
    private int tunnelMsgSize;

    // END APIQA: adding new parameter
    @Override
    public boolean parseArgs(String[] args)
    {
        try
        {
            ...
            while (argsCount < args.length)
            {
                ...
                {
                    // will overwrite connectionArgsParser's connectionList's
                    // connectionType based on the flag
                ...
                // APIQA: Adding msgSize as an input
                else if ("-msgSize".equals(args[argsCount]))
                {
                    tunnelMsgSize = Integer.parseInt(args[++argsCount]);
                    ++argsCount;
                }
                // END APIQA
                else
    ...
    // APIQA: Adding msgsize
    int tunnelMsgSize()
    {
        return tunnelMsgSize;
    }
