...
public class ChannelSession
{
    ...
    public boolean showTransportDetails = false;
    ...
    private long inBytesTotal = 0;
    private long uncompInBytesTotal = 0;
    ...
    public int write(TransportBuffer msgBuf, Error error)
    {
        ...
        if (retval > TransportReturnCodes.FAILURE)
        {
            ...
            if (showTransportDetails)
            {
                ...
                System.out.println("Compression Stats Bytes Out: " + outBytesTotal + " Uncompressed Bytes Out: " + uncompOutBytesTotal);
            }
        }
        else
        {
