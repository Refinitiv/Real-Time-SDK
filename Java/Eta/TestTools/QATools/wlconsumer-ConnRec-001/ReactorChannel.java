...
public class ReactorChannel extends VaNode
{
    ...
    */
	...
	void calculateNextReconnectTime()
	{
		...
		System.out.println("--------------APIQA, ReactorChannel: nextRecoveryTime is " + _nextRecoveryTime + " and reconnectDelay is " + _reconnectDelay +  "\n");
    ...
    Channel reconnect(Error error)
    {
		...
		System.out.println("--------------APIQA, ReactorChannel: Using connection " + _listIndex + "\n");
