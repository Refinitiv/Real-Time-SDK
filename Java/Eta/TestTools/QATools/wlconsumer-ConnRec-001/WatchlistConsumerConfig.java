...
public class WatchlistConsumerConfig 
{
    ...
    private static final String defaultSrvrPortNo = "14002";
	 //APIQA
    private static final String defaultSrvrHostname2 = "localhost";

    private static final String defaultSrvrPortNo2 = "14003";
    private static final String defaultSrvrHostname3 = "localhost";
    private static final String defaultSrvrPortNo3 = "14004";

    private static final int defaultNumConnections = 2;
    private static final int defaultAttemptLimit = 100;
    private static final int defaultMinDelay = 5000;
    private static final int defaultMaxDelay = 30000;
    // END APIQA
    ...
    void addCommandLineArgs()
    {
        ...
        //APIQA
		CommandLine.addOption("h2", defaultSrvrHostname2, "Server host name");
        CommandLine.addOption("p2", defaultSrvrPortNo2, "Server port number");
        CommandLine.addOption("h3", defaultSrvrHostname3, "Server host name");
        CommandLine.addOption("p3", defaultSrvrPortNo3, "Server port number");
        CommandLine.addOption("attempLimit", defaultAttemptLimit, "connection attempt limit ");
        CommandLine.addOption("numConnections", defaultNumConnections, "number of connections ");
        CommandLine.addOption("minDelay", defaultMinDelay, "connection min delay ");
        CommandLine.addOption("maxDelay", defaultMaxDelay, "connection max delay ");
        //END APIQA
