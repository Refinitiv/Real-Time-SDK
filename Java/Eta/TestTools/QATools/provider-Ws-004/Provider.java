...
public class Provider implements ReceivedMsgCallback, HttpCallback
{
    ...
    public void init(String[] args)
    {
        ...
        System.out.println("maxFragmentSize: " + CommandLine.value("maxFragmentSize"));
        //
        ...
        //API QA
        if(CommandLine.value("maxFragmentSize")!= null) 
        	bindOptions.maxFragmentSize(CommandLine.intValue("maxFragmentSize"));
        System.out.println("QA prints : maxFragmentSize : "+ CommandLine.intValue("maxFragmentSize"));
        if(CommandLine.value("testCompressionZlib")!= null)
        {
            ...
            System.out.println("QA prints : Test Zlib with level : "+ CommandLine.intValue("compressionLevel"));
        }
    ...
    private static void addCommandLineArgs()
    {
        ...
        CommandLine.addOption("maxFragmentSize", "Identify maxFragmentSize");
    }
