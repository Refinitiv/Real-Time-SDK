 ...
 *|           Copyright (C) 2018,2020,2025 LSEG. All rights reserved.
 *|-----------------------------------------------------------------------------
 */
...
class LoginHandler
{
    ...
    // openWindow
    private boolean _supportView = false;
    ...
    int sendRefresh(ReactorChannel chnl, LoginRequest loginRequest, ReactorErrorInfo errorInfo)
    {
        ...
        if(_supportView) {
        	_loginRefresh.applyHasFeatures();
        	_loginRefresh.features().applyHasSupportViewRequests();
        	_loginRefresh.features().supportViewRequests(1);       
        }
    ...
    /*
     * Sets the supportView.
     */
    void supportView(boolean supportView)
    {
        this._supportView = supportView;
    }
}
