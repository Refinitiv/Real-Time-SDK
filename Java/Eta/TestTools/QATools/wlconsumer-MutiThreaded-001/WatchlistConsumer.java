 ...
 * com.thomsonreuters.upa.valueadd.examples.multithreadwatchlistconsumer.WatchlistConsumer [-h srvrHostName]
 * [-p srvrPortNo] [-u loginUserName] [-s serviceName] [-mp marketPriceItemName]
 * [-u loginUserName] [-mp marketPriceItemName]
 ...
 * [-sl symbolListName] [ -sld     For each occurance, requests item on the Symbol List domain and data streams for items on that list.
 * [-x] [-c connectionType] [-runTime runTime]
 ...
 * [-server srvrHostName1:srvrPortNo1 serviceName1 -server srvrHostName2:srvrPortNo2 serviceName2] [-itemFile c:/temp/20k.xml] [-itemCount 20000]
 *   
 * <ul>
