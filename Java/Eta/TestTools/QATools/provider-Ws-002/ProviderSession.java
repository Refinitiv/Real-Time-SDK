...
public class ProviderSession
{
    ...
    public int write(Channel channel, TransportBuffer msgBuf, Error error)
    {
        ...
        // API QA
        System.out.println("Compression Stats Bytes Out: " + _writeArgs.bytesWritten() + " Uncompressed Bytes Out: " + _writeArgs.uncompressedBytesWritten());                       
        // END API QA
