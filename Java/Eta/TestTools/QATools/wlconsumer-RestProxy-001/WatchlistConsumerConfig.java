...
//APIQA
	String proxySDHostname()
	{
		return CommandLine.value("proxySDHost");
	}

	String proxySDPort()
	{
		return CommandLine.value("proxySDPort");
	}
//END APIQA
	...
	void addCommandLineArgs()
	{
		...
		//APIQA
		CommandLine.addOption("proxySDHost", "", "Proxy service discovery server host name");
		CommandLine.addOption("proxySDPort", "", "Proxy service discovery port number");
		//END APIQA
