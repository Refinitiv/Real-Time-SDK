...
public class MsgUtilJunit 
{
    ...
    public void copyUpdateMessageTest()
    {
        ...
        /*
         * since our msgKey has opaque that we want to encode, we need to use
         * EncodeMsgInit
         */
        /*
         * EncodeMsgInit should return and inform us to encode our key
         * opaque
         */
    ...
    public void copyPostMessageTest()
    {
         ...
         * 554433 FieldEntry - (111) REAL 867564 EXPONENT_4. FieldListComplete
         */
        // TODO - encode a complex type (Array) once encodeFieldEntryInit and
        // encodeFieldEntryComplete are implemented.
