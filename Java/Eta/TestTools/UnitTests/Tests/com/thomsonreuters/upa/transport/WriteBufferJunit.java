...
public class WriteBufferJunit
{
    ...
    public void upaQueueTest()
    {
    	...
    	UpaNode node2 = new UpaNode();
        UpaNode node3 = new UpaNode();
        UpaNode node4 = new UpaNode();
        UpaNode node5 = new UpaNode();
    	qe.add(node);
    	qe.add(node1);
    	qe.add(node2);
