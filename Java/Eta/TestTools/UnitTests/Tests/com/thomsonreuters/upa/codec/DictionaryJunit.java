...
public class DictionaryJunit
{
    ...
    public void loadZeroFidDictionaryTest()
    {
        ...
        // load field dictionary
        dictionary.clear();
        assertEquals(CodecReturnCodes.FAILURE, dictionary.loadFieldDictionary("Java/Eta/TestTools/UnitTests/TestData/com/thomsonreuters/upa/data/Codec/RDMFieldDictionaryZeroFid", error));
    }
    ...
    public void loadInvalidRWFTypeDictionaryTest()
    {
        ...
        // load field dictionary
        dictionary.clear();
        assertEquals(CodecReturnCodes.FAILURE, dictionary.loadFieldDictionary("Java/Eta/TestTools/UnitTests/TestData/com/thomsonreuters/upa/data/Codec/RDMFieldDictionaryInvalidRWFType", error));
    }
    ...
    public void loadDuplicateFidDictionaryTest()
    {
        ...
        // load field dictionary
        dictionary.clear();
        assertEquals(CodecReturnCodes.FAILURE, dictionary.loadFieldDictionary("Java/Eta/TestTools/UnitTests/TestData/com/thomsonreuters/upa/data/Codec/RDMFieldDictionaryDuplicateFid", error));
    }
    ...
    public void encodeDecodeDictionariesTest()
    {
        ...
        // load field dictionary
        dictionary.clear();
        assertEquals(CodecReturnCodes.SUCCESS, dictionary.loadFieldDictionary("Java/Eta/etc/RDMFieldDictionary", error));
        ...
        // load enumType dictionary
        dictionary.clear();
        assertEquals(CodecReturnCodes.SUCCESS, dictionary.loadEnumTypeDictionary("Java/Eta/etc/enumtype.def", error));
