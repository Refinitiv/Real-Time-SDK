...
class RsslSocketChannel extends UpaNode implements Channel
{
    class BigBuffersPool
    {
        ...
        UpaNode poll(int size, boolean isWriteBuffer)
        {
            UpaNode buffer = null;
    ...
    final private UpaQueue[] _flushOrder = new UpaQueue[MAX_FLUSH_STRATEGY];
    ...
    final UpaQueue _highPriorityQueue = new UpaQueue();
    final UpaQueue _mediumPriorityQueue = new UpaQueue();
    final UpaQueue _lowPriorityQueue = new UpaQueue();
