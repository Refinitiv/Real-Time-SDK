...
public interface BindOptions
{
     ...
     * heartbeats. Enterprise Platform and other Thomson Reuters components
     ...
     * {@link com.thomsonreuters.upa.codec.Codec#majorVersion()}.
     * 
     ...
     * <BR>
     * If the UPA Codec package is being used, this should be set to
     * {@link com.thomsonreuters.upa.codec.Codec#minorVersion()}.
     * 
