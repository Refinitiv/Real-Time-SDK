 ...
 * {@link Channel#getBuffer(int, boolean, com.rtsdk.eta.transport.Error)}
...
public interface EncodeIterator
{
     ...
     * 
     * @see com.rtsdk.eta.codec.StreamStates
     */
     ...
     *         {@link CodecReturnCodes#FAILURE} if the encoded message does not have state
     * 
     * @see com.rtsdk.eta.codec.DataStates
     */
     ...
     *         {@link CodecReturnCodes#FAILURE} if the encoded message does not have state
     * 
     * @see com.rtsdk.eta.codec.StateCodes
     */
