/**
  ...
  The {@link com.rtsdk.eta.codec.DataTypes} enumeration includes values that define the type of a 
  primitive:
  <ul>
  <li>
      <p>
      Values between {@value com.rtsdk.eta.codec.DataTypes#UNKNOWN} 
      and {@value com.rtsdk.eta.codec.DataTypes#BASE_PRIMITIVE_MAX} 
...
<dd>
    When contained in a {@link com.rtsdk.eta.codec.FieldEntry} or 
    {@link com.rtsdk.eta.codec.ElementEntry}, base primitive types can also represent 
    ...
    returns {@link com.rtsdk.eta.codec.CodecReturnCodes#BLANK_DATA}. To encode blank data into a 
    {@link com.rtsdk.eta.codec.FieldEntry} or {@link com.rtsdk.eta.codec.ElementEntry}, 
    use <code>encodeBlank()</code> method.
</dd>
</dl>
  </li>
  <li>
    Values between {@value com.rtsdk.eta.codec.DataTypes#SET_PRIMITIVE_MIN} 
    and {@value com.rtsdk.eta.codec.DataTypes#SET_PRIMITIVE_MAX} are set-defined primitive types, 
    ...
    within a Set Definition and encoded or decoded as part of a {@link com.rtsdk.eta.codec.FieldList} 
    or {@link com.rtsdk.eta.codec.ElementList}.
...
decoding process. UPA defines a single encode iterator type ({@link com.rtsdk.eta.codec.EncodeIterator})
and a single decode iterator type ({@link com.rtsdk.eta.codec.DecodeIterator}). 
...
or decode process. 
See {@link com.rtsdk.eta.codec.DecodeIterator} for more information and code examples.
...
<p>
See {@link com.rtsdk.eta.codec.DecodeIterator} for more information and code examples for using decode iterator.<br>
See {@link com.rtsdk.eta.codec.EncodeIterator} for more information and code examples for using encode iterator.
...
connection (via the {@link com.rtsdk.eta.transport.ConnectOptions} or 
{@link com.rtsdk.eta.transport.BindOptions}).
...
type and protocol version values in  {@link com.rtsdk.eta.codec.Codec} for this purpose.

<dl style='border-left:4px solid;padding: 0 0 0 6px; border-color: #D0C000'>
<dt><b>Note:</b></dt>
<dd>
Specifying appropriate version information on {@link com.rtsdk.eta.codec.DecodeIterator}
and {@link com.rtsdk.eta.codec.EncodeIterator} is important to future-proof applications 
...
<p>
See {@link com.rtsdk.eta.codec.Msg} for more information and code examples.
 */
