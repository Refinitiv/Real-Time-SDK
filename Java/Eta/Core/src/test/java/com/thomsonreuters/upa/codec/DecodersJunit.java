...
public class DecodersJunit
{
    ...
    {
        final String fileName = "src/test/resources/com/thomsonreuters/upa/data/RsslDecodersJunit/CloseMsgInvalidExtHdr.txt";
    ...
    {
        final String fileName = "src/test/resources/com/thomsonreuters/upa/data/RsslDecodersJunit/RequestMsgInvalidExtHdr.txt";
    ...
    {
        final String fileName = "src/test/resources/com/thomsonreuters/upa/data/RsslDecodersJunit/RequestMsgInvalidMsgKeyNameLen.txt";
    ...
    {
        final String fileName = "src/test/resources/com/thomsonreuters/upa/data/RsslDecodersJunit/RequestMsgInvalidMsgKeyLen.txt";
    ...
    public void decodeStatusMsgTest()
    {
        // test and verify decoding of a complete Request message
        byte[] expected = ParseHexFile
                .parse("src/test/resources/com/thomsonreuters/upa/data/RsslEncodersJunit/005_statusMsg.txt");
        assertNotNull(expected);
    ...
    {
        byte[] expected = ParseHexFile
                .parse("src/test/resources/com/thomsonreuters/upa/data/RsslEncodersJunit/015_filter_list_wEntries.txt");
        assertNotNull(expected);
    ...
    public void decodeArrayAndEntriesTest()
    {
        ...
        byte[] expected = ParseHexFile
                .parse("src/test/resources/com/thomsonreuters/upa/data/RsslEncodersJunit/008_array_entries_ascii.txt");
        assertNotNull(expected);
 ...
 //       RsslBuffer arrayEntryBuffer = RsslCodecFactory.createBuffer();
        ...
        expected = ParseHexFile
                .parse("src/test/resources/com/thomsonreuters/upa/data/RsslEncodersJunit/010_array_entries_encData_len2.txt");
        assertNotNull(expected);
        ...
        expected = ParseHexFile
                .parse("src/test/resources/com/thomsonreuters/upa/data/RsslEncodersJunit/016_array_entries_ls_uint.txt");
        assertNotNull(expected);
    ...
    public void decodeMapEntryTest()
    {
        ...
        byte[] expected = ParseHexFile
                .parse("src/test/resources/com/thomsonreuters/upa/data/RsslEncodersJunit/017_map_wEntry.txt");
        assertNotNull(expected);
    ...
    public void decodeElementEntryTest()
    {
        ...
        byte[] expected = ParseHexFile
                .parse("src/test/resources/com/thomsonreuters/upa/data/RsslEncodersJunit/004_elementList_wthrreEntries_middleEntryHasElementList.txt");
        assertNotNull(expected);
    ...
    public void decodeFieldListTest()
    {
        ...
        byte[] expected = ParseHexFile
                .parse("src/test/resources/com/thomsonreuters/upa/data/RsslEncodersJunit/006_encodeFieldList_wEntries_andRollBack.txt");
        assertNotNull(expected);
