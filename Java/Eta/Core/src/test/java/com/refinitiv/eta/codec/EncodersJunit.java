...
import com.refinitiv.eta.codec.ArrayImpl;
...
import com.refinitiv.eta.codec.ElementListImpl;
import com.refinitiv.eta.codec.ElementSetDef;
import com.refinitiv.eta.codec.ElementSetDefImpl;
import com.refinitiv.eta.codec.EncodeIterator;
import com.refinitiv.eta.codec.EncodeIteratorImpl;
import com.refinitiv.eta.codec.Encoders;
import com.refinitiv.eta.codec.EncodingLevel;
...
import com.refinitiv.eta.codec.FilterListImpl;
...
import com.refinitiv.eta.codec.MapImpl;
...
import com.refinitiv.eta.codec.SeriesImpl;
...
import com.refinitiv.eta.codec.VectorImpl;
...
public class EncodersJunit
{
    ...
    public void encodeElementEntryTest()
    {
        ...
        byte[] expectedData = ParseHexFile.parse("src/test/resources/com/refinitiv/eta/data/RsslEncodersJunit/001_elementList_one_entry.txt");
        ...
        expectedData = ParseHexFile.parse("src/test/resources/com/refinitiv/eta/data/RsslEncodersJunit/003_elementList_oneEntry_preencodedAscii.txt");
        assertNotNull(expectedData);
        ...
        expectedData = ParseHexFile.parse("src/test/resources/com/refinitiv/eta/data/RsslEncodersJunit/002_elementList_oneEntry_emptyPreEncodedAscii.txt");
        assertNotNull(expectedData);
        assertArrayEquals(expectedData, convertToByteArray(bigBuf.data()));
    ...
    public void encodeElementEntryInitCompleteTest()
    {
        ...
        byte[] expectedData = ParseHexFile.parse("src/test/resources/com/refinitiv/eta/data/RsslEncodersJunit/004_elementList_wthrreEntries_middleEntryHasElementList.txt");
        assertNotNull(expectedData);
        assertArrayEquals(expectedData, convertToByteArray(buf.data()));
        ...
        expectedData = ParseHexFile.parse("src/test/resources/com/refinitiv/eta/data/RsslEncodersJunit/005_elementList_secondEntryElementList_rollback.txt");
        assertNotNull(expectedData);
        assertArrayEquals(expectedData, convertToByteArray(buf.data()));
    ...
    public void encodeArrayInitEntryCompleteTest()
    {
        ...
        // verify encoded data
        expectedData = ParseHexFile.parse("src/test/resources/com/refinitiv/eta/data/RsslEncodersJunit/010_array_entries_encData_len2.txt");
        assertNotNull(expectedData);
        assertArrayEquals(expectedData, convertToByteArray(buf.data()));
        ...
        // verify encoded data
        expectedData = ParseHexFile.parse("src/test/resources/com/refinitiv/eta/data/RsslEncodersJunit/011_array_entries_encData_len0.txt");
        assertNotNull(expectedData);
        assertArrayEquals(expectedData, convertToByteArray(buf.data()));
        ...
        // verify encoded data
        expectedData = ParseHexFile.parse("src/test/resources/com/refinitiv/eta/data/RsslEncodersJunit/012_array_entry_blankEncData_len4.txt");
        assertNotNull(expectedData);
        assertArrayEquals(expectedData, convertToByteArray(buf.data()));
        ...
        // verify encoded data
        expectedData = ParseHexFile.parse("src/test/resources/com/refinitiv/eta/data/RsslEncodersJunit/013_array_entry_blankEncData_len0.txt");
        assertNotNull(expectedData);
        assertArrayEquals(expectedData, convertToByteArray(buf.data()));
        ...
        // verify encoded data
        expectedData = ParseHexFile.parse("src/test/resources/com/refinitiv/eta/data/RsslEncodersJunit/009_array_entries_uint.txt");
        assertNotNull(expectedData);
        assertArrayEquals(expectedData, convertToByteArray(buf.data()));
    }
    ...
    public void encodePrimitiveTest()
    {
        ...
        // verify encoded data
        byte[] expectedData= ParseHexFile.parse("src/test/resources/com/refinitiv/eta/data/RsslEncodersJunit/014_encodePrimitive_int_len0.txt");
        assertNotNull(expectedData);
        assertArrayEquals(expectedData, convertToByteArray(buf.data()));
    }
    ...
    public void encodeRequestWithIdAndEncAttribTest()
    {
        ...
        byte[] expectedData = ParseHexFile
                .parse("src/test/resources/com/refinitiv/eta/data/RsslEncodersJunit/001_requestMsgWithIdAndEncAttrib.txt");
        assertNotNull(expectedData);
        assertArrayEquals(expectedData, convertToByteArray(buf.data()));
    }
    ...
    public void encodeAckMsgTest()
    {
        ...
        byte[] expectedData= ParseHexFile
                .parse("src/test/resources/com/refinitiv/eta/data/RsslEncodersJunit/022_ackMsg.txt");
        assertNotNull(expectedData);
        assertArrayEquals(expectedData, convertToByteArray(buf.data()));
    }
