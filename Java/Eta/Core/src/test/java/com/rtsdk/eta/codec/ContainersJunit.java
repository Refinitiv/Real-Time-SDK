...
public class ContainersJunit 
{
	...
	public void dataDictionaryTest()
	{
	    ...
	    final String dictionaryFileName1 = "src/test/resources/com/rtsdk/eta/data/Codec/enumtype1.def";
	    final String dictionaryFileName2 = "src/test/resources/com/rtsdk/eta/data/Codec/enumtype2.def";
