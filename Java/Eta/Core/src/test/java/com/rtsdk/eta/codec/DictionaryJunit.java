...
public class DictionaryJunit
{
    ...
    public void loadZeroFidDictionaryTest()
    {
        ...
        // load field dictionary
        dictionary.clear();
        assertEquals(CodecReturnCodes.FAILURE, dictionary.loadFieldDictionary("src/test/resources/com/rtsdk/eta/data/Codec/RDMFieldDictionaryZeroFid", error));
    }
    ...
    public void loadInvalidRWFTypeDictionaryTest()
    {
        ...
        // load field dictionary
        dictionary.clear();
        assertEquals(CodecReturnCodes.FAILURE, dictionary.loadFieldDictionary("src/test/resources/com/rtsdk/eta/data/Codec/RDMFieldDictionaryInvalidRWFType", error));
    }
    ...
    public void loadDuplicateFidDictionaryTest()
    {
        ...
        // load field dictionary
        dictionary.clear();
        assertEquals(CodecReturnCodes.FAILURE, dictionary.loadFieldDictionary("src/test/resources/com/rtsdk/eta/data/Codec/RDMFieldDictionaryDuplicateFid", error));
    }
    ...
    public void decodeEnumTypeDictionaryFailureTest()
    {
        ...
        {
        	@Override
        	int decodeDictionaryTag(DecodeIterator iter, ElementEntryImpl element, int type, com.rtsdk.eta.transport.Error error)
            {
