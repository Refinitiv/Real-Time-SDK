...
import com.rtsdk.eta.transport.RsslSocketChannel;
import com.rtsdk.eta.transport.SocketProtocol.TrackingPool;
...
import com.rtsdk.eta.transport.UnifiedNetworkInfoImpl;

public class TransportJunit
{

    private static final int DEFAULT_LISTEN_PORT = 4324;
    private static final String BASE_TEST_DATA_DIR_NAME = "src/test/resources/com/rtsdk/eta/transport/RsslSocketChannelJunit";
