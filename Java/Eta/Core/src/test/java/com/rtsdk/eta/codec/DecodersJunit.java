...
import com.rtsdk.eta.codec.BufferReader;
import com.rtsdk.eta.codec.DataBufferReaderWireFormatV1;
import com.rtsdk.eta.codec.Array;
import com.rtsdk.eta.codec.Buffer;
import com.rtsdk.eta.codec.BufferImpl;
import com.rtsdk.eta.codec.CloseMsgFlags;
...
import com.rtsdk.eta.codec.DecodeIteratorImpl;
...
import com.rtsdk.eta.codec.PostUserInfo;
...
public class DecodersJunit
{
    ...
    {
        final String fileName = "src/test/resources/com/rtsdk/eta/data/RsslDecodersJunit/CloseMsgInvalidExtHdr.txt";
    ...
    {
        final String fileName = "src/test/resources/com/rtsdk/eta/data/RsslDecodersJunit/RequestMsgInvalidExtHdr.txt";
    ...
    {
        final String fileName = "src/test/resources/com/rtsdk/eta/data/RsslDecodersJunit/RequestMsgInvalidMsgKeyNameLen.txt";
    ...
    {
        final String fileName = "src/test/resources/com/rtsdk/eta/data/RsslDecodersJunit/RequestMsgInvalidMsgKeyLen.txt";
    ...
    public void decodeStatusMsgTest()
    {
        // test and verify decoding of a complete Request message
        byte[] expected = ParseHexFile
                .parse("src/test/resources/com/rtsdk/eta/data/RsslEncodersJunit/005_statusMsg.txt");
        assertNotNull(expected);
    ...
    {
        byte[] expected = ParseHexFile
                .parse("src/test/resources/com/rtsdk/eta/data/RsslEncodersJunit/015_filter_list_wEntries.txt");
        assertNotNull(expected);
    ...
    public void decodeArrayAndEntriesTest()
    {
        ...
        byte[] expected = ParseHexFile
                .parse("src/test/resources/com/rtsdk/eta/data/RsslEncodersJunit/008_array_entries_ascii.txt");
        assertNotNull(expected);
 ...
 //       RsslBuffer arrayEntryBuffer = RsslCodecFactory.createBuffer();
        ...
        expected = ParseHexFile
                .parse("src/test/resources/com/rtsdk/eta/data/RsslEncodersJunit/010_array_entries_encData_len2.txt");
        assertNotNull(expected);
        ...
        expected = ParseHexFile
                .parse("src/test/resources/com/rtsdk/eta/data/RsslEncodersJunit/016_array_entries_ls_uint.txt");
        assertNotNull(expected);
    ...
    public void decodeMapEntryTest()
    {
        ...
        byte[] expected = ParseHexFile
                .parse("src/test/resources/com/rtsdk/eta/data/RsslEncodersJunit/017_map_wEntry.txt");
        assertNotNull(expected);
    ...
    public void decodeElementEntryTest()
    {
        ...
        byte[] expected = ParseHexFile
                .parse("src/test/resources/com/rtsdk/eta/data/RsslEncodersJunit/004_elementList_wthrreEntries_middleEntryHasElementList.txt");
        assertNotNull(expected);
    ...
    public void decodeFieldListTest()
    {
        ...
        byte[] expected = ParseHexFile
                .parse("src/test/resources/com/rtsdk/eta/data/RsslEncodersJunit/006_encodeFieldList_wEntries_andRollBack.txt");
        assertNotNull(expected);
    ...
    public void decodeFieldDictionaryTest()
    {
        ...
        dictionary.clear();
        assertEquals(CodecReturnCodes.SUCCESS, dictionary.loadFieldDictionary("src/test/resources/com/rtsdk/eta/data/Codec/RDMFieldDictionaryBoundary", error));
    ...
    public void decodeEnumTypeDictionaryTest()
    {
        ...
        dictionary.clear();
        assertEquals(CodecReturnCodes.SUCCESS, dictionary.loadEnumTypeDictionary("src/test/resources/com/rtsdk/eta/data/Codec/enumtypeBoundary.def", error));
