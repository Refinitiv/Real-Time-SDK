...
public class WriteBufferJunit
{
    ...
    private static final String BASE_TEST_DATA_DIR_NAME = "src/test/resources/com/rtsdk/eta/transport/SocketChannelJunit";
    private final static String RIPC_BASE_TEST_DATA_DIR_NAME = "src/test/resources/com/rtsdk/eta/transport/RipcHandshakeJunit";
