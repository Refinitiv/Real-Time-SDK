...
import com.rtsdk.eta.valueadd.domainrep.rdm.queue.QueueAck;
import com.rtsdk.eta.valueadd.domainrep.rdm.queue.QueueData;
import com.rtsdk.eta.valueadd.domainrep.rdm.queue.QueueDataExpired;
import com.rtsdk.eta.valueadd.domainrep.rdm.queue.QueueDataTimeoutCode;
import com.rtsdk.eta.valueadd.domainrep.rdm.queue.QueueDataUndeliverableCode;
import com.rtsdk.eta.valueadd.domainrep.rdm.queue.QueueMsg;
import com.rtsdk.eta.valueadd.domainrep.rdm.queue.QueueMsgType;
import com.rtsdk.eta.valueadd.domainrep.rdm.queue.QueueRequest;
import com.rtsdk.eta.valueadd.domainrep.rdm.queue.QueueMsgFactory;
import com.rtsdk.eta.valueadd.reactor.ReactorChannel.State;
import com.rtsdk.eta.valueadd.reactor.TunnelStreamMsg.OpCodes;
import com.rtsdk.eta.valueadd.reactor.TunnelStreamStateInfo.TunnelStreamState;
import com.rtsdk.eta.valueadd.reactor.TunnelSubstream.TunnelSubstreamState;
...
public class TunnelStream
{
	...
	com.rtsdk.eta.codec.State _state;
	...
	static class ManagerLink implements Link<TunnelStream>
	{
		...
		/* (non-Javadoc)
		 * @see com.rtsdk.eta.valueadd.common.VaDoubleLinkList.Link#getPrev(java.lang.Object)
		 */
		public TunnelStream getPrev(TunnelStream thisPrev) { return thisPrev._managerPrev; }
		
		/* (non-Javadoc)
		 * @see com.rtsdk.eta.valueadd.common.VaDoubleLinkList.Link#setPrev(java.lang.Object, java.lang.Object)
		 */
		public void setPrev(TunnelStream thisPrev, TunnelStream thatPrev) { thisPrev._managerPrev = thatPrev; }
		
		/* (non-Javadoc)
		 * @see com.rtsdk.eta.valueadd.common.VaDoubleLinkList.Link#getNext(java.lang.Object)
		 */
		public TunnelStream getNext(TunnelStream thisNext) { return thisNext._managerNext; }
		
		/* (non-Javadoc)
		 * @see com.rtsdk.eta.valueadd.common.VaDoubleLinkList.Link#setNext(java.lang.Object, java.lang.Object)
		 */
     ...
     */
    public com.rtsdk.eta.codec.State state()
	{
		return _state;
	}
	...
	int readMsg(Msg deliveredMsg, Error error)
	{
		...
		{    		
    		...
    		switch (_tunnelStreamState)
    		{
    			...
    			case WAITING_REFRESH:
    			{
    				com.rtsdk.eta.codec.State state;    				
                                ...
                                if (!isProvider()) // consumer tunnel stream
                                {
                                        ...
                                        _decSubMsg.domainType() == DomainTypes.LOGIN)
                                    {
                                        ...
                                        else if (_decSubMsg.msgClass() == MsgClasses.STATUS)
                                        {
                                            ...
                                            com.rtsdk.eta.codec.State state = null;
