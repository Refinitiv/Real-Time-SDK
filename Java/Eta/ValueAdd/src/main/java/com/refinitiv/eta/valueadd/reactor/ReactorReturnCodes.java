...
public class ReactorReturnCodes
{
    ...
    /**
     * Transport Success: {@link ReactorChannel#submit(com.refinitiv.eta.transport.TransportBuffer,
     ...
     * returned from {@link ReactorChannel#submit(com.refinitiv.eta.codec.Msg,
