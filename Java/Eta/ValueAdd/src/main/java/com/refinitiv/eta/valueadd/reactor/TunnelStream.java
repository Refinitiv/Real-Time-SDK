...
import com.refinitiv.eta.valueadd.reactor.TunnelStreamMsg.OpCodes;
import com.refinitiv.eta.valueadd.reactor.TunnelStreamStateInfo.TunnelStreamState;
...
public class TunnelStream
{
	...
	com.refinitiv.eta.codec.State _state;
	...
	static class ManagerLink implements Link<TunnelStream>
	{
		...
		/* (non-Javadoc)
		 * @see com.refinitiv.eta.valueadd.common.VaDoubleLinkList.Link#getPrev(java.lang.Object)
		 */
		public TunnelStream getPrev(TunnelStream thisPrev) { return thisPrev._managerPrev; }
		
		/* (non-Javadoc)
		 * @see com.refinitiv.eta.valueadd.common.VaDoubleLinkList.Link#setPrev(java.lang.Object, java.lang.Object)
		 */
		public void setPrev(TunnelStream thisPrev, TunnelStream thatPrev) { thisPrev._managerPrev = thatPrev; }
		
		/* (non-Javadoc)
		 * @see com.refinitiv.eta.valueadd.common.VaDoubleLinkList.Link#getNext(java.lang.Object)
		 */
		public TunnelStream getNext(TunnelStream thisNext) { return thisNext._managerNext; }
		
		/* (non-Javadoc)
		 * @see com.refinitiv.eta.valueadd.common.VaDoubleLinkList.Link#setNext(java.lang.Object, java.lang.Object)
		 */
     ...
     */
    public com.refinitiv.eta.codec.State state()
	{
		return _state;
	}
	...
	int readMsg(Msg deliveredMsg, Error error)
	{
		...
		{    		
    		...
    		switch (_tunnelStreamState)
    		{
    			...
    			case WAITING_REFRESH:
    			{
    				com.refinitiv.eta.codec.State state;    				
                                ...
                                if (!isProvider()) // consumer tunnel stream
                                {
                                        ...
                                        _decSubMsg.domainType() == DomainTypes.LOGIN)
                                    {
                                        ...
                                        else if (_decSubMsg.msgClass() == MsgClasses.STATUS)
                                        {
                                            ...
                                            com.refinitiv.eta.codec.State state = null;
