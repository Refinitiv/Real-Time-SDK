...
{    
    ...
    HashMap<Integer,WlService> _servicesByIdTable = new HashMap<Integer,WlService>();
    ...
    int processServiceList(List<Service> serviceList, ReactorErrorInfo errorInfo)
    {
        ...
        for (Service service : serviceList)
        {
            switch (service.action())
            {
                ...
                case MapEntryActions.UPDATE:
                    wlService = _servicesByIdTable.get(service.serviceId());
                    if (wlService != null)
                    {
                        ...
                        ret = _watchlist.itemHandler().serviceUpdated(wlService);
                    }
                ...
                case MapEntryActions.DELETE:
                    ...
                    wlService = _servicesByIdTable.remove(service.serviceId());
                    if (wlService != null)
                    {
                        ...
                        ret = _watchlist.itemHandler().serviceDeleted(wlService);
    ...
    WlService addToCache(Service service)
    {
        ...
        _servicesByIdTable.put(service.serviceId(), wlService);
    ...
    {        
        return _servicesByIdTable.get(serviceId);
    }
