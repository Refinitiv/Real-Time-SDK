...
import com.thomsonreuters.upa.examples.newsviewer.StreamIdWatchList.StreamIdKey;
import com.thomsonreuters.upa.examples.newsviewer.StreamIdWatchList.WatchListEntry;
                ...
                if (ret == CodecReturnCodes.SUCCESS)
                {
                    ...
                    switch (fEntry.fieldId())
                    {
                        ...
                        case 258: // SEG_TEXT that is the story
                            ...
                            if (decoder.RMTESApplyToCache(fEntry.encodedData(), cacheBuf) == CodecReturnCodes.SUCCESS)
                            {
                                if (decoder.RMTESToUCS2(rmtesBuffer, cacheBuf) == CodecReturnCodes.SUCCESS)
                                    newsViewer.getStoryViewer().writeBody(rmtesBuffer.toString());
                                else
                        ...
                        case 264: // BCAST_TEXT
                            ...
                            {
                                if (decoder.RMTESToUCS2(rmtesBuffer, cacheBuf) == CodecReturnCodes.SUCCESS)
                                    headline.setText(rmtesBuffer.toString());
                                else
