...
public class ElementListFlags
{
    ...
    /**
     * (0x01) Indicates the presence of has element list number. This member is
     * provided as part of the initial refresh message on a stream or on the
     * first refresh message after a CLEAR_CACHE command.
     */
    public static final int HAS_ELEMENT_LIST_INFO = 0x01;

    /**
     * (0x02) Indicates that {@link ElementList} contains set-defined data. If
     * both standard and set-defined data are present in this
     * {@link ElementList}, this value can be set in addition to
     * {@link #HAS_STANDARD_DATA}. If no entries are present in the
     ...
     * definition to use when encoding or decoding set data on this
     * {@link ElementList}.
     */
