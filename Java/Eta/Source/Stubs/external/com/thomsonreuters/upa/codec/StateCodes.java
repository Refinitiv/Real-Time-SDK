...
public class StateCodes
{
    ...
    /**
     * code is none. Additional state code information is not required nor
     * present.
     */
     ...
     * available at a later time or through changing some parameters used in the
     * request.
     */
    public static final int NOT_FOUND = 1;

    /**
     * Indicates that a timeout occurred somewhere in the system while
     ...
     * the service, to receive requested data, or to receive data at the
     * requested QoS.
     */
     ...
     * User is notified when recovery finishes via a
     * {@link #FAILOVER_COMPLETED} code.
     */
    ...
    /**
     * Indicates that a request cannot be processed because too many other
     * streams are already open.
     */
    public static final int TOO_MANY_ITEMS = 13;

    /**
     * Indicates that a stream is already open on the connection for the
     * requested data.
     */
    ...
    /**
     * Indicates that the stream was not opened. Additional information should
    ...
    /**
     * Indicates that the domain on which a request is made does not support the
     * requested viewType.
     */
    public static final int UNSUPPORTED_VIEW_TYPE = 20;

    /**
     * code indicates that the requested view is invalid, possibly due to bad
     * formatting. Additional information should be available in the text.
     */
    ...
    /**
     * Indicates that a batch request cannot be used for this request. The user
     * can instead split the batched items into individual requests.
     */
