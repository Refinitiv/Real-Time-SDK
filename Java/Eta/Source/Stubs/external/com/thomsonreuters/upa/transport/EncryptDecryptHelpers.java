 ...
 * buffers across multiple {@link Channel} objects, as each {@link Channel} tracks it's own encryption
 * key.
 */
public interface EncryptDecryptHelpers 
{
    ...
    /**
     * Calculates the number of byte needed to encrypt 
     ...
     * @param encryptedOutput the {@link Buffer} to encrypt into.  This must have enough capacity for encryption. See calculateEncryptedSize()
     ...
     * @param decryptedOutput the {@link Buffer} to decrypt into.  This must have enough capacity for encryption.  Should contain at least bufferToDecrypt.length() bytes.
     * @param error the {@link Error}, populated in cases where failure occurs
     * @return {@link TransportReturnCodes} and {@link com.thomsonreuters.upa.codec.CodecReturnCodes}
     */
     ...
     * @param encryptedOutput the {@link TransportBuffer} to encrypt into.  This must have enough capacity for encryption. See calculateEncryptedSize()
     * @param error the {@link Error}, populated in cases where failure occurs
     * @return {@link TransportReturnCodes} and {@link com.thomsonreuters.upa.codec.CodecReturnCodes}
     */
     ...
     * @param decryptedOutput the {@link TransportBuffer} to decrypt into.  This must have enough capacity for encryption.  Should contain at least bufferToDecrypt.length() bytes.
     * @param error the {@link Error}, populated in cases where failure occurs
     * @return {@link TransportReturnCodes} and {@link com.thomsonreuters.upa.codec.CodecReturnCodes}
     */
     ...
     * @param channel the {@link Channel} the content should be encrypted for
     * @param bufferToEncrypt the {@link TransportBuffer} housing the contents to encrypt.
     * @param encryptedOutput the {@link Buffer} to encrypt into.  This must have enough capacity for encryption. See See calculateEncryptedSize()
     * @param error the {@link Error}, populated in cases where failure occurs
     * @return {@link TransportReturnCodes} and {@link com.thomsonreuters.upa.codec.CodecReturnCodes}
     */
     ...
     * @param channel the {@link Channel} the content should be encrypted for
     * @param bufferToEncrypt the {@link Buffer} housing the contents to encrypt.
     * @param encryptedOutput the {@link TransportBuffer} to encrypt into.  This must have enough capacity for encryption. See See calculateEncryptedSize()
     * @param error the {@link Error}, populated in cases where failure occurs
     * @return {@link TransportReturnCodes} and {@link com.thomsonreuters.upa.codec.CodecReturnCodes}
     */
