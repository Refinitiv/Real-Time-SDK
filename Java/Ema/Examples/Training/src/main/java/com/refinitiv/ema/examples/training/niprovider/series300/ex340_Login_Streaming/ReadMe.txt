...
ex340_Login_Streaming is an example of an OMM NiProvider application written
to the EMA library.
...
ex340_Login_Streaming illustrates how to create and publish one OMM streaming item
...
ex340_Login_Streaming implements the following high-level steps:
