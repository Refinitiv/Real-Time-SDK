...
ex511_MP_Session_ProgrammaticCfg is an example of an OMM NiProvider application 
...
ex511_MP_Session_ProgrammaticCfg illustrates how to create and publish two OMM streaming
...
ex511_MP_Session_ProgrammaticCfg implements the following high-level steps:
...
+ Instantiates a Map (configMap object) and populates it with configuration info,
  including a configuration Session with two configured ADH instances
