...
ex260_Custom_NestedMsg is an example of an OMM Interactive Provider application 
...
ex260_Custom_NestedMsg illustrates how to create and publish a single OMM
...
ex260_Custom_NestedMsg implements the following high-level steps:
