...
ex110_MBO_Streaming is an example of an OMM NiProvider application 
...
ex110_MBO_Streaming illustrates how to create and publish a single OMM
...
ex110_MBO_Streaming implements the following high-level steps:
