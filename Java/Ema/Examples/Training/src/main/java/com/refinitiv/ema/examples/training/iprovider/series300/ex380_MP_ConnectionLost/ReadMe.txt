...
ex380_MP_ConnectionLost is an example of an OMM Interactive Provider application 
...
ex380_MP_ConnectionLost illustrates how to create and publish a single OMM
...
ex380_MP_ConnectionLost implements the following high-level steps:
