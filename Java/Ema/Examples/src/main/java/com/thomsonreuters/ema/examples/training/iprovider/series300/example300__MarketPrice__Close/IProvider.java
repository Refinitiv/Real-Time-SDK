...
package com.thomsonreuters.ema.examples.training.iprovider.series300.example300__MarketPrice__Close;
...
class AppClient implements OmmProviderClient
{
	...
	void processMarketPriceClose(ReqMsg reqMsg, OmmProviderEvent event)
	{
		...
		System.out.println("Processing Market Price close item request for: " + reqMsg.name());
	...
	void processInvalidItemClose(ReqMsg reqMsg, OmmProviderEvent event)
	{
		System.out.println("Item to be closed is not found");
	}
}
