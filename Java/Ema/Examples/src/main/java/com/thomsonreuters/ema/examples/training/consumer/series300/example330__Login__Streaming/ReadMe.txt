...
The example330__Login__Streaming application is provided as an example of OMM Consumer
...
example330__Login__Streaming showcases usage of login stream in OMM Consumer.
...
example330__Login__Streaming implements the following high level steps:
