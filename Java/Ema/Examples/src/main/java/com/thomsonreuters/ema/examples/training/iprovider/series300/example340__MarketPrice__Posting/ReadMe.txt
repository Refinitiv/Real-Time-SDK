...
340__MarketPrice__Posting is an example of an OMM Interactive Provider application 
written to the EMA library.

This application demonstrates how to implement a provider that supports post messages.

340__MarketPrice__Posting illustrates how to indicate that provider supports post messages and how
to reply with AckMsg when post message is received.

Detailed Description
====================

340__MarketPrice__Posting implements the following high-level steps:
