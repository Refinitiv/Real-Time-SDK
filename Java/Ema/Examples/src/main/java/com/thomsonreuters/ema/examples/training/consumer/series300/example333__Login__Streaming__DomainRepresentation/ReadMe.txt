...
The example333__Login__Streaming__DomainRepresentation application is provided as an example of OMM Consumer
...
example333__Login__Streaming__DomainRepresentation showcases usage of login stream in OMM Consumer.
...
This application is the Domain Representation version of example330__Login__Streaming. It demonstrates the
ease-of-use Domain Representation functionality.

Detailed Description
====================

example333__Login__Streaming__DomainRepresentation implements the following high level steps:
