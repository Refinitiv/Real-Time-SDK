...
The example423__MarketPrice__AdminDomainConfig__DomainRepresentation application is provided as
...
example423__MarketPrice__AdminDomainConfig__DomainRepresentation showcases customization of the default EMA
...
This application is the Domain Representation version of example420__MarketPrice__AdminDomainConfig. It demonstrates the
ease-of-use Domain Representation functionality.

Detailed Description
====================

example423__MarketPrice__AdminDomainConfig__DomainRepresentation implements the following high level steps:
