...
110__MarketByOrder__Streaming is an example of an OMM NiProvider application 
...
110__MarketByOrder__Streaming illustrates how to create and publish a single OMM
...
110__MarketByOrder__Streaming implements the following high-level steps:
