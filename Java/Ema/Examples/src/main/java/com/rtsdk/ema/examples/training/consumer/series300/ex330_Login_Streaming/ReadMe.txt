...
The ex330_Login_Streaming application is provided as an example of OMM Consumer
...
ex330_Login_Streaming showcases usage of login stream in OMM Consumer.
...
ex330_Login_Streaming implements the following high level steps:
