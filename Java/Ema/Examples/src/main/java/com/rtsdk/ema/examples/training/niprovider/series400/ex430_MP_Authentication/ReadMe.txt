...
The ex430_MP_Authentication utilizes command line options as well as the xml configuration.
...
ex430_MP_Authentication implements the following high level steps:
