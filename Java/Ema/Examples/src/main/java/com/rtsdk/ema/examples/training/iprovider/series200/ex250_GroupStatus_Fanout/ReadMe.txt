...
ex250_GroupStatus_Fanout is an example of an OMM Interactive Provider application 
...
ex250_GroupStatus_Fanout illustrates how to create and publish a single OMM
...
ex250_GroupStatus_Fanout implements the following high-level steps:
...
+ After submitting refresh and 10 updates,
  sends a directory update with group status
