...
example170__MarketPrice__ChannelInfo is an example of an OMM Consumer application
...
example170__MarketPrice__ChannelInfo implements the following high-level steps:
