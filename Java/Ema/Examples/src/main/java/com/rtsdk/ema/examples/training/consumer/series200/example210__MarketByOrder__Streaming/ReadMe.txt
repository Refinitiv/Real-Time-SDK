...
The example210__MarketByOrder__Streaming application is provided as an example of
...
example210__MarketByOrder__Streaming implements the following high level steps:
