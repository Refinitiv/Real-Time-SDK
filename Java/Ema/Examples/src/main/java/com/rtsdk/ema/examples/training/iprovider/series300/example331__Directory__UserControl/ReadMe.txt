...
331__Directory_UserControl is an example of an OMM Interactive Provider application 
...
331__Directory_UserControl illustrates how to create and publish a single OMM
...
331__Directory_UserControl implements the following high-level steps:
