...
The example360__MarketPrice__View application is provided as an example of OMM Consumer
...
example360__MarketPrice__View implements the following high level steps:
