...
ex111_MP_UserSpecifiedFileConfig is an OMM Consumer application example
...
ex111_MP_UserSpecifiedFileConfig illustrates the abilitily of the user
...
if no argument is supplied, the application works the same as ex110_MP_FileConfig.

Detailed Description
====================

ex111_MP_UserSpecifiedFileConfig implements the following high-level steps:
