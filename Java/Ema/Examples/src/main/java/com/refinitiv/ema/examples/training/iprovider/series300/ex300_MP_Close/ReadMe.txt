...
ex300_MP_Close is an example of an OMM Interactive Provider application 
...
ex300_MP_Close illustrates how to create and publish a single OMM
...
ex300_MP_Close implements the following high-level steps:
