...
The ex331_Directory_Streaming application is provided as an example of
...
and parsing of OMM Directory and MarketPrice data from Data Feed 
Direct (LDFD), directly from an OMM Provider application, or from an 
Advanced Distribution Server.

ex331_Directory_Streaming showcases usage of directory stream in OMM
...
ex331_Directory_Streaming implements the following high level steps:
