...
The ex270_SymbolList application is provided as an example of OMM Consumer
application written to the EMA library.

This application demonstrates basic usage of the EMA library for accessing
and parsing of OMM SymbolList data from Refinitiv Data Feed Direct (RDF-D),
directly from an OMM Provider application, or from an Advanced
Distribution Server.

ex270_SymbolList showcases opening and processing of a SymbolList item.
...
ex270_SymbolList implements the following high level steps:
