...
ex300_MP_Streaming is an example of an OMM NiProvider application 
...
ex300_MP_Streaming illustrates how to create and publish a single OMM
...
ex300_MP_Streaming implements the following high-level steps:
