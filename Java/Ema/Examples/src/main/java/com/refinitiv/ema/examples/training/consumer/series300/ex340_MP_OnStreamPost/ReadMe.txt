...
The ex340_MP_OnStreamPost application is provided as an example of
...
ex340_MP_OnStreamPost showcases the usage of on stream posting
...
ex340_MP_OnStreamPost implements the following high level steps:
