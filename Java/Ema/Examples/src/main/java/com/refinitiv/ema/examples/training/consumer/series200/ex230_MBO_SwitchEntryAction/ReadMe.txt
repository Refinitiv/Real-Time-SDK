...
The ex230_MBO_SwitchEntryAction application is provided as an
...
ex230_MBO_SwitchEntryAction showcases application varying processing
...
ex230_MBO_SwitchEntryAction implements the following high level steps:
