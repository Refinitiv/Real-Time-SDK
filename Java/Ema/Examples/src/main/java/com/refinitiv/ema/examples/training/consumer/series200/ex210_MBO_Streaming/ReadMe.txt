...
The ex210_MBO_Streaming application is provided as an example of
...
and parsing of OMM MarketByOrder data from Data Feed Direct (LDFD),
directly from an OMM Provider application, or from the Advanced
Distribution Server.

ex210_MBO_Streaming showcases native or RWF decoding of received
Map and FieldList. This application iterates through the received FieldList and
calls respective (based on the data type) accessor methods to extract data in
native format.
...
ex210_MBO_Streaming implements the following high level steps:
