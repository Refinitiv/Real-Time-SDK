...
The ex220_MBP_PrivateStream application is provided as an example
...
and parsing of OMM MarketByPrice data from Refinitiv Data Feed Direct (RDF-D),
directly from an OMM Provider application, or from the Advanced
Distribution Server.

ex220_MBP_PrivateStream showcases opening and processing of
...
ex220_MBP_PrivateStream implements the following high level steps:
