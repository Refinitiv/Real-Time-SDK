...
ex360_MP_ConnectionRecovery is an example of an OMM NiProvider application 
...
ex360_MP_ConnectionRecovery illustrates how to create and publish one OMM item,
...
ex360_MP_ConnectionRecovery implements the following high-level steps:
