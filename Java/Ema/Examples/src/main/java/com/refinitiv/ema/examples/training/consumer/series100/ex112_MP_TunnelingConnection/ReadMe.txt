...
ex112_MP_TunnelingConnection is an OMM Consumer application example
...
ex112_MP_TunnelingConnection illustrates the abilitily of the user
...
ex112_MP_TunnelingConnection implements the following high-level steps:
