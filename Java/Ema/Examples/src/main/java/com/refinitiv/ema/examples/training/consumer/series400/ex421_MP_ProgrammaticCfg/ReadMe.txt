...
The ex421_MP_ProgrammaticCfg application is provided as an example
...
parsing of OMM MarketPrice Domain data from Reuters Data Feed Direct (RDF-D),
directly from an OMM Provider application, or from an Advanced Distribution Server.

The ex421_MP_ProgrammaticCfg showcases creation and usage of the 
...
The ex421_MP_ProgrammaticCfg implements the following high level steps:
