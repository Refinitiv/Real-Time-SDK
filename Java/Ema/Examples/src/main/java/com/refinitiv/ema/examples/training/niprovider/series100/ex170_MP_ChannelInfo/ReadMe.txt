...
ex170_MP_ChannelInfo is an example of an OMM NiProvider application 
written to the EMA library.

ex170_MP_ChannelInfo illustrates how to  access and parse
...
ex170_MP_ChannelInfo implements the following high-level steps:
