...
The ex410_MP_HorizontalScaling application is provided as an example
...
ex410_MP_HorizontalScaling showcases horizontal scaling capability
...
ex410_MP_HorizontalScaling implements the following high level steps:
