...
ex250_MP_Perf is an example of an OMM NiProvider application written
to the EMA library.
...
ex250_MP_Perf illustrates how to efficiently create and publish a number
...
ex250_MP_Perf implements the following high-level steps:
