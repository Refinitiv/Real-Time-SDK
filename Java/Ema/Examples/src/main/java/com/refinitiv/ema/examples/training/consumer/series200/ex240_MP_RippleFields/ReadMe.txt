...
The ex240_MP_RippleFields application is provided as an example
...
Direct (LDFD), directly from an OMM Provider application, or from 
...
ex240_MP_RippleFields implements the following high level steps:
