...
The ex332_Dictionary_Streaming application is provided as an example of
...
and parsing of OMM Dictionary and MarketPrice data from Refinitiv Data Feed
Direct (RDF-D), directly from an OMM Provider application, or from an 
Advanced Distribution Server.

ex332_Dictionary_Streaming showcases usage of dictionary stream in OMM
...
ex332_Dictionary_Streaming implements the following high level steps:
