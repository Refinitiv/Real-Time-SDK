...
import com.rtsdk.ema.perftools.common.ResourceUsageStats;
import com.rtsdk.ema.perftools.common.ShutdownCallback;
import com.rtsdk.ema.perftools.common.TimeRecord;
import com.rtsdk.ema.perftools.common.TimeRecordQueue;
import com.rtsdk.ema.perftools.common.ValueStatistics;
 ...
 * provider and process the images and updates it receives. It doesn't support
 * for posting and generic messages yet.
 * <p>
 ...
 * determine the end-to-end latency. emajConsPerf also supports measurement of 
 ...
 * see the EMA-J Open Source Performance Tools Guide
 * (Docs/EMAJPerfToolsGuide.pdf).
 * <p>
...
public class emajConsPerf implements ShutdownCallback
{
	...
	private final PostUserInfo _postUserInfo = new PostUserInfo();
