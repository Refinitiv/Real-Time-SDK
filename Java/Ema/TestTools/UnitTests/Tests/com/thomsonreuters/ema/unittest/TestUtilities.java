...
final class TestUtilities extends TestCase
{
    ...
    static void upa_encodeDictionaryMsg(com.thomsonreuters.upa.codec.DataDictionary dictionary)
    {
        ...
        checkResult(CodecReturnCodes.SUCCESS, dictionary.loadFieldDictionary("./Java/Ema/TestTools/UnitTests/TestData/RDMTestDictionary", error));
        checkResult(CodecReturnCodes.SUCCESS, dictionary.loadEnumTypeDictionary("./Java/Ema/TestTools/UnitTests/TestData/testenumtype.def", error));
