...
public class Consumer
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            long enumHandle = consumer.registerClient(reqMsg.clear().domainType(EmaRdm.MMT_DICTIONARY).name("RWFEnum").filter(EmaRdm.DICTIONARY_NORMAL), appClient);
            // APIQA Remove item request
