...
package com.rtsdk.ema.examples.training.consumer.series300.example341__MarketPrice__OffStreamPost;
	...
	static boolean readCommandlineArgs(String[] args)
	{
		try
		{
			...
			while (argsCount < args.length)
			{
				...
				{
					AppClient.serviceId = argsCount < (args.length-1) ? Integer.parseInt(args[++argsCount]) : null;
					++argsCount;
				}
