...
public class Consumer 
{
	public static void main(String[] args)
	{
		...
		{			
			...
			//API QA
			consumer  = EmaFactory.createOmmConsumer(EmaFactory.createOmmConsumerConfig().consumerName("Consumer_10"));			
			
			consumer.registerClient(EmaFactory.createReqMsg().serviceName("DIRECT_FEED").name("LSEG.L"), appClient, consumer);
