...
public class IProvider
{
	...
	static Map createProgrammaticConfig()
	{
		...
		// API QA
		elementList.add(EmaFactory.createElementEntry().intValue("ReactorMsgEventPoolLimit", 1));
		elementList.add(EmaFactory.createElementEntry().intValue("ReactorChannelEventPoolLimit", 1));
		elementList.add(EmaFactory.createElementEntry().intValue("WorkerEventPoolLimit",1));
		elementList.add(EmaFactory.createElementEntry().intValue("TunnelStreamMsgEventPoolLimit", 1));
		elementList.add(EmaFactory.createElementEntry().intValue("TunnelStreamStatusEventPoolLimit",1));
