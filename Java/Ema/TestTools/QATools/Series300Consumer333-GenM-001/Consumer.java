...
public class Consumer
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            /* test case 1: send genericMsg with Consumer Status to provider on LOGIN stream */
            consumer.submit(EmaFactory.createGenericMsg().domainType(EmaRdm.MMT_LOGIN).name(EmaRdm.ENAME_CONS_CONN_STATUS).payload(map).complete(true), loginHandle);
            // END APIQA
