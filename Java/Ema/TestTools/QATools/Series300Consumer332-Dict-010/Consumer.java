...
public class Consumer
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			consumer1.registerClient(reqMsg.domainType(EmaRdm.MMT_DICTIONARY).name("RWFFld").
					 filter(EmaRdm.DICTIONARY_NORMAL), appClient);

			consumer1.registerClient(reqMsg.clear().domainType(EmaRdm.MMT_DICTIONARY).name("RWFEnum").
					filter(EmaRdm.DICTIONARY_NORMAL),appClient);
			...
			consumer1.registerClient(reqMsg.clear().serviceName("DIRECT_FEED").name("IBM.N"), appClient);
