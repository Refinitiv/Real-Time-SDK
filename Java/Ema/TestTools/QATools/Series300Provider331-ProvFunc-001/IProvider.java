...
public class IProvider
{
	...
	try
	{
		...
		while (argsCount < args.length)
		{
			...
			{
				IProvider._delayDir = Integer.parseInt(args[++argsCount]);
				++argsCount;
			}
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			provider = EmaFactory.createOmmProvider(EmaFactory.createOmmIProviderConfig().
					adminControlDirectory(OmmIProviderConfig.AdminControl.USER_CONTROL).port(IProvider._portNumber), appClient);
