...
public class Consumer
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            long fldHandle = consumer.registerClient(reqMsg.domainType(EmaRdm.MMT_DICTIONARY).name("RWFFld").filter(EmaRdm.DICTIONARY_NORMAL).serviceName("DIRECT_FEED"), appClient);
            long enumHandle = consumer.registerClient(reqMsg.clear().domainType(EmaRdm.MMT_DICTIONARY).name("RWFEnum").filter(EmaRdm.DICTIONARY_NORMAL).serviceName("DIRECT_FEED"), appClient);
