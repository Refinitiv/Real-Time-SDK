    ...
    void decode(Msg msg, boolean complete)
    {
        switch (msg.payload().dataType())
        {
            case DataTypes.SERIES:
                ...
                if (msg.name().equals("RWFFld_TEST"))
                {
                ...
                else if (msg.name().equals("RWFEnum_TEST"))
                {
...
public class Consumer
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            // APIQA
            long fldHandle = consumer.registerClient(reqMsg.domainType(EmaRdm.MMT_DICTIONARY).name("RWFFld_TEST").filter(EmaRdm.DICTIONARY_NORMAL).serviceName("DIRECT_FEED"), appClient);

            long enumHandle = consumer.registerClient(reqMsg.clear().domainType(EmaRdm.MMT_DICTIONARY).name("RWFEnum_TEST").serviceName("DIRECT_FEED").filter(EmaRdm.DICTIONARY_NORMAL), appClient);
            // END APIQA
