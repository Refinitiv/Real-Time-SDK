...
class AppClient implements OmmConsumerClient
{
	...
	{
		System.out.println("Item Stream Id: " + (refreshMsg.streamId()));
		System.out.println("Private Stream: " + (refreshMsg.privateStream() ? "True" : "False"));
	...
	{
		System.out.println("Item Stream Id: " + (updateMsg.streamId()));
	...
	{
		System.out.println("Item Stream Id: " + (statusMsg.streamId()));
