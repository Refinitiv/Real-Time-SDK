...
package com.thomsonreuters.ema.examples.training.iprovider.series400.example421__MarketPrice__ProgrammaticConfig;
...
public class IProvider
{
	...
	static Map createProgrammaticConfig()
	{
		...
		innerElementList.add( EmaFactory.createElementEntry().intValue( "AcceptDirMessageWithoutMinFilters", 0)); 
		innerElementList.add( EmaFactory.createElementEntry().intValue( "AcceptMessageSameKeyButDiffStream", 0)); 
		innerElementList.add( EmaFactory.createElementEntry().intValue( "AcceptMessageThatChangesService", 0)); 
		innerElementList.add( EmaFactory.createElementEntry().intValue( "AcceptMessageWithoutAcceptingRequests", 0)); 
		innerElementList.add( EmaFactory.createElementEntry().intValue( "AcceptMessageWithoutBeingLogin", 0)); 
		innerElementList.add( EmaFactory.createElementEntry().intValue( "AcceptMessageWithoutQosInRange", 0)); 
		innerElementList.add( EmaFactory.createElementEntry().intValue( "EnumTypeFragmentSize", 128000)); 
		innerElementList.add( EmaFactory.createElementEntry().intValue( "FieldDictionaryFragmentSize", 8192)); 
		innerElementList.add( EmaFactory.createElementEntry().intValue( "PipePort", 9009 )); 
		innerElementList.add( EmaFactory.createElementEntry().intValue( "RequestTimeout", 15000)); 
		innerElementList.add( EmaFactory.createElementEntry().ascii( "Name", "Series400Provider421-PConfig-001" ));
		...
		innerElementList.add( EmaFactory.createElementEntry().intValue( "ConnectionMinPingTimeout", 20000 ));
		...
		innerElementList.add( EmaFactory.createElementEntry().intValue( "SysRecvBufSize", 10 ));
		innerElementList.add( EmaFactory.createElementEntry().intValue( "SysSendBufSize", 10 ));
	...
	public static void main(String[] args)
	{
		...
		//APIQA
			provider = EmaFactory.createOmmProvider( EmaFactory.createOmmIProviderConfig().config( createProgrammaticConfig())
																						.operationModel( OmmIProviderConfig.OperationModel.USER_DISPATCH ).providerName("Provider_2"),	appClient );
