...
public class Consumer
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            // APIQA
            long fldHandle = consumer.registerClient(reqMsg.domainType(EmaRdm.MMT_DICTIONARY).name("RWFFld").filter(EmaRdm.DICTIONARY_MINIMAL).serviceName("DIRECT_FEED"), appClient);

            long enumHandle = consumer.registerClient(reqMsg.clear().domainType(EmaRdm.MMT_DICTIONARY).name("RWFEnum").serviceName("DIRECT_FEED").filter(EmaRdm.DICTIONARY_MINIMAL), appClient);
            // END APIQA
