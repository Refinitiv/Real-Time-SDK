...
public class Consumer 
{
	public static void main(String[] args)
	{
		...
		try
		{
			...
			array.add(EmaFactory.createOmmArrayEntry().intValue(8927));
			array.add(EmaFactory.createOmmArrayEntry().intValue(8927));
			array.add(EmaFactory.createOmmArrayEntry().intValue(32560));
			array.add(EmaFactory.createOmmArrayEntry().intValue(32560));
			array.add(EmaFactory.createOmmArrayEntry().intValue(32560));
			array.add(EmaFactory.createOmmArrayEntry().intValue(32743));
			array.add(EmaFactory.createOmmArrayEntry().intValue(32743));
			array.add(EmaFactory.createOmmArrayEntry().intValue(32300));
			array.add(EmaFactory.createOmmArrayEntry().intValue(32300));
			array.add(EmaFactory.createOmmArrayEntry().intValue(14251));
			array.add(EmaFactory.createOmmArrayEntry().intValue(14251));
			array.add(EmaFactory.createOmmArrayEntry().intValue(32300));
			array.add(EmaFactory.createOmmArrayEntry().intValue(14250));
			array.add(EmaFactory.createOmmArrayEntry().intValue(14250));
			array.add(EmaFactory.createOmmArrayEntry().intValue(14251));
			array.add(EmaFactory.createOmmArrayEntry().intValue(14251));
			//END API QA
