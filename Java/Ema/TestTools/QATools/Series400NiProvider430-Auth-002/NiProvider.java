...
package com.refinitiv.ema.examples.training.niprovider.series400.ex430_MP_Authentication;
...
public class NiProvider
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			config.addAdminMsg(loginReq.message()).host("localhost:14003");
			
			loginRefresh.domainType(EmaRdm.MMT_LOGIN).complete(true);
			config.addAdminMsg(loginRefresh).instanceId("123");
