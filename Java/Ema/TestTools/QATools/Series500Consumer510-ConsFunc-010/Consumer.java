...
public class Consumer 
{
	public static void main(String[] args)
	{
		...
		try
		{
	        ...
	        long handle1 = consumer.registerClient(EmaFactory.createReqMsg().serviceListName("SVG1").name("LSEG.L"), appClient, 1);
	        long handle2 = consumer.registerClient(EmaFactory.createReqMsg().serviceListName("SVG1").name("TRI.N"), appClient, 2);
