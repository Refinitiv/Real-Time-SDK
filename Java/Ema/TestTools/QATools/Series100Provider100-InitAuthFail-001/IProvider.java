...
import static com.thomsonreuters.upa.codec.StateCodes.NOT_ENTITLED;
...
class AppClient implements OmmProviderClient
{
	...
	{
		event.provider().submit( EmaFactory.createStatusMsg().domainType(EmaRdm.MMT_LOGIN).name(reqMsg.name()).
				nameType(EmaRdm.USER_NAME).
				state(OmmState.StreamState.CLOSED, OmmState.DataState.SUSPECT, NOT_ENTITLED, "Not authorized"),
				event.handle() );
	}
