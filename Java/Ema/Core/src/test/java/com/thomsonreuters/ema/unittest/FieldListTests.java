...
public class FieldListTests extends TestCase
{
	...
	public void testFieldList_EncodeUPA_DecodeEMA_DecodeAll()
	{
		...
		com.thomsonreuters.ema.access.FieldList fl = JUnitTestConnect.createFieldList();
    ...
    public void testFieldList_EncodeUPA_DecodeEMA_EncodeEMA_DecodeUPA()
    {
        ...
        com.thomsonreuters.ema.access.FieldList flCopy = EmaFactory.createFieldList();
    ...
    public void testFieldList_EncodeUPAFLWithPrimitiveTypes_EncodeEMA_ToAnotherFieldList_EMADecode() 
    {
        ...
        com.thomsonreuters.ema.access.FieldList flDecCopy = JUnitTestConnect.createFieldList();
