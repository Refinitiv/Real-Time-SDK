...
public class DataDictionaryJunitTest extends TestCase {
	...
	private static com.rtsdk.eta.codec.DataDictionary globalEtaDataDictionary;
	private static DataDictionary globalDataDictionary;
	private static com.rtsdk.eta.transport.Error rsslError = com.rtsdk.eta.transport.TransportFactory.createError();
...
//	private static String enumTableFileName = "./Java/Ema/TestTools/UnitTests/TestData/testenumtype.def";
	...
	static
	{	
		globalEtaDataDictionary = com.rtsdk.eta.codec.CodecFactory.createDataDictionary();
		globalDataDictionary = com.rtsdk.ema.access.EmaFactory.createDataDictionary();
		...
		{
			TestUtilities.checkResult(false, "Failed to load dictionary information with com.rtsdk.eta.codec.DataDictionary");
		}
		...
		{
			TestUtilities.checkResult(false, "Failed to load enumerated types information with com.rtsdk.eta.codec.DataDictionary");
		}
	...
	boolean comparingEnumType(com.rtsdk.eta.codec.EnumType rsslEnumType, EnumType enumType, StringBuilder failedText, boolean payloadOnly)
	{
		...
		{
			failedText.append("com.rtsdk.eta.codec.EnumTyp is null");
		}
		
		return false;
	}
	
	boolean comparingEnumTable(com.rtsdk.eta.codec.EnumTypeTable rsslEnumTypeTable, EnumTypeTable enumTypeTable, StringBuilder failedText,
			boolean payloadOnly)
	{
	...
	boolean comparingDictionaryEntry(com.rtsdk.eta.codec.DictionaryEntry rsslDictionaryEntry, DictionaryEntry dictionaryEntry, StringBuilder failedText,
			boolean payloadOnly)
	{
		...
		{
			failedText.setLength(0);
			failedText.append("com.rtsdk.eta.codec.DictionaryEntry is null");
		}
		
		return false;
	}
	
	void comparingDataDictionary(com.rtsdk.eta.codec.DataDictionary rsslDataDictionary, 
			DataDictionary dataDictionary, boolean payloadOnly)
	{
		...
		if(result)
		{
			TestUtilities.checkResult(result, "All DictionaryEntry from DataDictionary.entries() is equal with all entries in com.rtsdk.eta.codec.DataDictionary");
		}
		else
		{
		...
		com.rtsdk.eta.codec.EnumTypeTable rsslEnumTypeTable;
		...
		if (result)
		{
			TestUtilities.checkResult(result, "All EnumTypeTable from DataDictionary.enumTables() is equal with com.rtsdk.eta.codec.enumTables()");
		}
		else
		{
			TestUtilities.checkResult(result, errorText.toString());
	...
	public void testDataDictionary_Uninitialize()
	{
		...
		DataDictionary dataDictionary = com.rtsdk.ema.access.EmaFactory.createDataDictionary();
