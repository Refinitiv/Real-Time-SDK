...
public class FilterListTests extends TestCase
{
	...
	public void testFilterListContainsFieldListsElementLists_EncodeDecodeAll()
	{
	 ...
	 public void testFilterList_EncodeETAFilterListWithContainerTypes_EncodeEMA_ToAnotherFilterList_EMADecode() 
	 {
        ...
        com.rtsdk.ema.access.FilterList filterList = JUnitTestConnect.createFilterList();
        ...
        com.rtsdk.ema.access.FilterList filterListCopy = EmaFactory.createFilterList();
        ...
        com.rtsdk.ema.access.FilterList filterListDecCopy = JUnitTestConnect.createFilterList();
