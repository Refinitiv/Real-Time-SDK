...
public class MapTests extends TestCase
{
	...
	public void testMapWithKeyUInt_ContainsFieldLists_EncodeUPA_decodeEMA_DecodeAll()
	{
		...
		// Decode Map with EMA.
		com.rtsdk.ema.access.Map map = JUnitTestConnect.createMap();
		...
		com.rtsdk.ema.access.MapEntry me1 = mapIter.next();
		...
		TestUtilities.checkResult(mapIter.hasNext());
		com.rtsdk.ema.access.MapEntry me2 = mapIter.next();
		...
		TestUtilities.checkResult(mapIter.hasNext());
		com.rtsdk.ema.access.MapEntry me3 = mapIter.next();
	...
	public void testMapWithKeyBuffer_ContainsFieldLists_EncodeUPA_decodeEMA_DecodeAll()
	{
		...
		com.rtsdk.eta.codec.Buffer keyData = CodecFactory.createBuffer();
...
//		{
//		case DataType.DataTypes.ELEMENT_LIST:
//			com.rtsdk.ema.access.ElementList el = map.summaryData().elementList();
//			TestUtilities.EmaDecodeElementListAll(el);
//			break;
//
//		default:
...
//		{
//			com.rtsdk.ema.access.ElementList el = me1.elementList();
//			TestUtilities.EmaDecodeElementListAll(el);
//		}
//
//		// check reseting iteration to start of map
...
//		{
//			com.rtsdk.ema.access.ElementList el = me2.elementList();
//			TestUtilities.EmaDecodeElementListAll(el);
//		}
//
//		// check third map entry
	...
	public void testMap_EncodeUPAMapWithFieldListType_EncodeEMA_ToAnotherSeries_EMADecode() 
	 {
       ...
       com.rtsdk.ema.access.Map mapCopy = EmaFactory.createMap();
