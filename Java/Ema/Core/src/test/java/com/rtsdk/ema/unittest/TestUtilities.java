...
import com.rtsdk.ema.access.Data.DataCode;
...
import com.rtsdk.ema.access.MapEntry.MapAction;
...
import com.rtsdk.eta.codec.FieldListFlags;
...
public final class TestUtilities extends TestCase
{
	...
	private static String fieldDictionaryFileName = "./src/test/resources/com/rtsdk/ema/unittest/DataDictionaryTest/RDMTestDictionary";
	private static String enumTableFileName = "./src/test/resources/com/rtsdk/ema/unittest/DataDictionaryTest/testenumtype.def";
	...
	private static com.rtsdk.eta.codec.DataDictionary dictionary = com.rtsdk.eta.codec.CodecFactory.createDataDictionary();
	...
	static com.rtsdk.eta.codec.DataDictionary getDataDictionary()
	{
		return dictionary;
	}
	...
	public static void eta_EncodeErrorFieldList( Buffer rsslBuf )
	{
		...
		com.rtsdk.eta.codec.FieldEntry rsslFEntry = CodecFactory.createFieldEntry();
		...
		rsslFEntry.dataType( com.rtsdk.eta.codec.DataTypes.UINT);
		...
		rsslFEntry.dataType( com.rtsdk.eta.codec.DataTypes.REAL);
		rsslFEntry.fieldId( 1);
	...
	public static void eta_EncodeErrorElementList( Buffer rsslBuf )
	{
		...
		com.rtsdk.eta.codec.EncodeIterator iter = CodecFactory.createEncodeIterator();
		com.rtsdk.eta.codec.ElementEntry rsslFEntry = CodecFactory.createElementEntry();
	...
	private static int eta_EncodeFieldListAll(com.rtsdk.eta.codec.EncodeIterator encodeIter, int encodeFlag)
	{
		...
		else
		{
			...
			com.rtsdk.eta.codec.FieldEntry fieldEntry = CodecFactory.createFieldEntry();
		    ...
		    if ( (encodeFlag & EncodingTypeFlags.PRIMITIVE_TYPES) != 0 )
		    {
				...
				com.rtsdk.eta.codec.Date date = CodecFactory.createDate();
				date.month(11);
				date.day(30);
				date.year(2010);
				
				com.rtsdk.eta.codec.Real real = CodecFactory.createReal();
				com.rtsdk.eta.codec.Time time = CodecFactory.createTime();
				com.rtsdk.eta.codec.DateTime DATETIME = CodecFactory.createDateTime();
				com.rtsdk.eta.codec.Array array = CodecFactory.createArray();
				com.rtsdk.eta.codec.Qos qos = CodecFactory.createQos();
				com.rtsdk.eta.codec.State state = CodecFactory.createState();
				com.rtsdk.eta.codec.Enum enumValue  = CodecFactory.createEnum();
				com.rtsdk.eta.codec.Buffer buffer = CodecFactory.createBuffer();
			
				com.rtsdk.eta.codec.UInt uInt = CodecFactory.createUInt();
				uInt.value(23456);
				com.rtsdk.eta.codec.Int Int = CodecFactory.createInt();
				Int.value(65432);
				com.rtsdk.eta.codec.Float Float = CodecFactory.createFloat();
				Float.value(3.14f);
				com.rtsdk.eta.codec.Double Double = CodecFactory.createDouble();
				Double.value(3.1416);
	
				// Create a Buffer for UInt to encode into
				com.rtsdk.eta.codec.Buffer encUInt = CodecFactory.createBuffer();
				...
				fieldEntry.dataType(com.rtsdk.eta.codec.DataTypes.TIME);  
				time.hour(8);
				time.minute(39);
				time.second(24);
				...
				fieldEntry.dataType(com.rtsdk.eta.codec.DataTypes.DATETIME);
				DATETIME.month(11);
				DATETIME.day(15);
				DATETIME.year(2011);
				DATETIME.hour(8);
				...
				fieldEntry.dataType(com.rtsdk.eta.codec.DataTypes.QOS);
				qos.timeliness(com.rtsdk.eta.codec.QosTimeliness.REALTIME);
				qos.rate(com.rtsdk.eta.codec.QosRates.TICK_BY_TICK);
				qos.dynamic(true);
				qos.rateInfo(0);
				qos.timeInfo(0);
				...
				fieldEntry.dataType(com.rtsdk.eta.codec.DataTypes.STATE);
				state.streamState(com.rtsdk.eta.codec.StreamStates.OPEN);
				state.dataState(com.rtsdk.eta.codec.DataStates.OK);
				state.code(com.rtsdk.eta.codec.StateCodes.NONE);
				...
				fieldEntry.dataType(com.rtsdk.eta.codec.DataTypes.BUFFER);
				...
				fieldEntry.dataType(com.rtsdk.eta.codec.DataTypes.ARRAY);
				...
				else
				{
					...
					array.primitiveType(com.rtsdk.eta.codec.DataTypes.UINT);
					...
					else
					{
						...
						com.rtsdk.eta.codec.UInt uInt1 = CodecFactory.createUInt();
						uInt1.value(10);
						com.rtsdk.eta.codec.UInt uInt2 = CodecFactory.createUInt();
						uInt2.value(20);
						com.rtsdk.eta.codec.UInt uInt3 = CodecFactory.createUInt();
						uInt3.value(30);
						com.rtsdk.eta.codec.UInt uInt4 = CodecFactory.createUInt();
						uInt4.value(40);
	
						// Array encoding was successful.
	
						System.out.print("\t\tFID " + fieldEntry.fieldId() + " Encoded Array: [");
						com.rtsdk.eta.codec.ArrayEntry ae = CodecFactory.createArrayEntry();
			...
			if ( (encodeFlag & EncodingTypeFlags.CONTAINER_TYPES) != 0 )
			{
				...
				fieldEntry.dataType(com.rtsdk.eta.codec.DataTypes.FIELD_LIST);
				if ( (retVal = fieldEntry.encodeInit(encodeIter, 0)) < CodecReturnCodes.SUCCESS )
				{
					// error condition - switch our success value to false so we can roll back
					success = false;
				...
				fieldEntry.dataType(com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST);
				if ( (retVal = fieldEntry.encodeInit(encodeIter, 0)) < CodecReturnCodes.SUCCESS )
				{
					// error condition - switch our success value to false so we can roll back
					success = false;
				...
				fieldEntry.dataType(com.rtsdk.eta.codec.DataTypes.FILTER_LIST);
				if ( (retVal = fieldEntry.encodeInit(encodeIter, 0)) < CodecReturnCodes.SUCCESS )
				{
					// error condition - switch our success value to false so we can roll back
					success = false;
				...
				fieldEntry.dataType(com.rtsdk.eta.codec.DataTypes.SERIES);
				if ( (retVal = fieldEntry.encodeInit(encodeIter, 0)) < CodecReturnCodes.SUCCESS )
				{
					// error condition - switch our success value to false so we can roll back
					success = false;
				...
				fieldEntry.dataType(com.rtsdk.eta.codec.DataTypes.VECTOR);
				if ( (retVal = fieldEntry.encodeInit(encodeIter, 0)) < CodecReturnCodes.SUCCESS )
				{
					// error condition - switch our success value to false so we can roll back
					success = false;
				...
				fieldEntry.dataType(com.rtsdk.eta.codec.DataTypes.MAP);
				if ( (retVal = fieldEntry.encodeInit(encodeIter, 0)) < CodecReturnCodes.SUCCESS )
				{
					// error condition - switch our success value to false so we can roll back
					success = false;
			...
			if ( (encodeFlag & EncodingTypeFlags.MESSAGE_TYPES) != 0 )
			{
				...
				fieldEntry.dataType(com.rtsdk.eta.codec.DataTypes.MSG);
				if ( (retVal = fieldEntry.encodeInit(encodeIter, 0)) < CodecReturnCodes.SUCCESS )
				{
					// error condition - switch our success value to false so we can roll back
					success = false;
	...
	private static int eta_EncodeArrayAll(EncodeIterator encodeIter)
    {
        ...
        array.primitiveType(com.rtsdk.eta.codec.DataTypes.BUFFER);
        /* values are variable length */
        array.itemLength(8);
	...
	public static int eta_EncodeElementListAll(com.rtsdk.eta.codec.EncodeIterator encodeIter, int encodeFlag)
	{
		...
		if ( (encodeFlag & EncodingTypeFlags.PRIMITIVE_TYPES) != 0 )
	    {
			...
			com.rtsdk.eta.codec.Float floatVal = CodecFactory.createFloat();
			floatVal.value(1.34f);
			
			com.rtsdk.eta.codec.Double doubleVal = CodecFactory.createDouble();
			...
			elemEntry.dataType(com.rtsdk.eta.codec.DataTypes.TIME);
			...
			elemEntry.dataType(com.rtsdk.eta.codec.DataTypes.INT);
			System.out.println("\tEncoding Element Entry (name: " + elemEntry.name() + ")");
			...
			elemEntry.dataType(com.rtsdk.eta.codec.DataTypes.UINT);
			System.out.println("\tEncoding Element Entry (name: " + elemEntry.name() + ")");
			...
			elemEntry.dataType(com.rtsdk.eta.codec.DataTypes.REAL);
			System.out.println("\tEncoding Element Entry (name: " + elemEntry.name() + ")");
			...
			elemEntry.dataType(com.rtsdk.eta.codec.DataTypes.FLOAT);
			System.out.println("\tEncoding Element Entry (name: " + elemEntry.name() + ")");
			...
			elemEntry.dataType(com.rtsdk.eta.codec.DataTypes.DOUBLE);
			System.out.println("\tEncoding Element Entry (name: " + elemEntry.name() + ")");
		...
		if ( (encodeFlag & EncodingTypeFlags.CONTAINER_TYPES) != 0 )
	    {
			...
			elemEntry.dataType(com.rtsdk.eta.codec.DataTypes.FIELD_LIST);
			...
			elemEntry.dataType(com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST);
			if ( (retVal = elemEntry.encodeInit(encodeIter, 0)) < CodecReturnCodes.SUCCESS )
			{
				// error condition - switch our success value to false so we can roll back
				success = false;
			...
			elemEntry.dataType(com.rtsdk.eta.codec.DataTypes.FILTER_LIST);
			if ( (retVal = elemEntry.encodeInit(encodeIter, 0)) < CodecReturnCodes.SUCCESS )
			{
				// error condition - switch our success value to false so we can roll back
				success = false;
			...
			elemEntry.dataType(com.rtsdk.eta.codec.DataTypes.SERIES);
			if ( (retVal = elemEntry.encodeInit(encodeIter, 0)) < CodecReturnCodes.SUCCESS )
			{
				// error condition - switch our success value to false so we can roll back
				success = false;
			...
			elemEntry.dataType(com.rtsdk.eta.codec.DataTypes.VECTOR);
			if ( (retVal = elemEntry.encodeInit(encodeIter, 0)) < CodecReturnCodes.SUCCESS )
			{
				// error condition - switch our success value to false so we can roll back
				success = false;
			...
			elemEntry.dataType(com.rtsdk.eta.codec.DataTypes.MAP);
			if ( (retVal = elemEntry.encodeInit(encodeIter, 0)) < CodecReturnCodes.SUCCESS )
			{
				// error condition - switch our success value to false so we can roll back
				success = false;
		...
		if ( (encodeFlag & EncodingTypeFlags.MESSAGE_TYPES) != 0 )
	    {
			...
			elemEntry.dataType(com.rtsdk.eta.codec.DataTypes.MSG);
			if ( (retVal = elemEntry.encodeInit(encodeIter, 0)) < CodecReturnCodes.SUCCESS )
			{
				// error condition - switch our success value to false so we can roll back
				success = false;
	...
	public static int eta_EncodeMapKeyUIntAll(com.rtsdk.eta.codec.EncodeIterator encodeIter, int containerType)
	{
		...
		else
		{
			...
			com.rtsdk.eta.codec.MapEntry mapEntry = CodecFactory.createMapEntry();
			com.rtsdk.eta.codec.UInt entryKey = CodecFactory.createUInt();
			...
			com.rtsdk.eta.codec.Buffer encUInt = CodecFactory.createBuffer();
			encUInt.data(ByteBuffer.allocate(10));
			com.rtsdk.eta.codec.Buffer encFieldList = CodecFactory.createBuffer();
			...
			switch ( containerType )
			{
				case com.rtsdk.eta.codec.DataTypes.FIELD_LIST:
				{
					...
					System.out.println("\tEncoding Entry's payload type: " + com.rtsdk.eta.codec.DataTypes.toString(containerType));
		...
		public static int eta_EncodeMapKeyIntWithEmptyFLs(com.rtsdk.eta.codec.Buffer etaBuf)
		{
			...
			else
			{
				...
				// create a single MapEntry and FieldList and reuse for each entry
				com.rtsdk.eta.codec.MapEntry mapEntry = CodecFactory.createMapEntry();
				com.rtsdk.eta.codec.Int entryKeyInt = CodecFactory.createInt();

				// Create a Buffer for Int and field list to encode into
				// Here we are heap allocating the buffers (10 bytes is large enough for
				// Int encoding and 500 bytes is large enough for FieldList encoding).
				com.rtsdk.eta.codec.Buffer encBuffer = CodecFactory.createBuffer();
	...
	public static int eta_EncodeMapKeyAsciiStringWithFLs(com.rtsdk.eta.codec.Buffer etaBuf)
	{
		...
		else
		{
			...
			// create a single MapEntry and FieldList and reuse for each entry
			com.rtsdk.eta.codec.MapEntry mapEntry = CodecFactory.createMapEntry();
			com.rtsdk.eta.codec.Buffer entryKey = CodecFactory.createBuffer();
	...
	public static int eta_EncodeMapKeyUIntWithELs(com.rtsdk.eta.codec.Buffer etaBuf)
	{
		...
		else
		{
			...
			com.rtsdk.eta.codec.MapEntry mapEntry = CodecFactory.createMapEntry();
			com.rtsdk.eta.codec.UInt entryKeyUInt = CodecFactory.createUInt();
			...
			com.rtsdk.eta.codec.Buffer encUInt = CodecFactory.createBuffer();
			encUInt.data(ByteBuffer.allocate(10));
			com.rtsdk.eta.codec.Buffer encElementList = CodecFactory.createBuffer();
	...
	public static int eta_EncodeMapKeyIntWithELs(com.rtsdk.eta.codec.Buffer etaBuf)
	{
		...
		else
		{
			...
			// Here we are heap allocating the buffers (10 bytes is large enough for
			// UInt encoding and 500 bytes is large enough for ElementList encoding).
			com.rtsdk.eta.codec.Buffer encInt = CodecFactory.createBuffer();
	...
	public static int eta_EncodeRequestMsgAll(com.rtsdk.eta.codec.EncodeIterator encodeIter, int containerType)
	{
		...
		requestMsg.qos().rate(com.rtsdk.eta.codec.QosRates.TICK_BY_TICK);
		requestMsg.qos().timeliness(com.rtsdk.eta.codec.QosTimeliness.REALTIME);
		...
		requestMsg.msgKey().nameType( com.rtsdk.eta.rdm.InstrumentNameTypes.RIC );
	...
	public static int eta_EncodeRefreshMsgAll(com.rtsdk.eta.codec.EncodeIterator encodeIter, int containerType)
	{
		...
		Buffer permissionData = com.rtsdk.eta.codec.CodecFactory.createBuffer();
	...
	public static int eta_EncodeUpdateMsgAll(com.rtsdk.eta.codec.EncodeIterator encodeIter, int containerType)
	{
		...
		updateMsg.domainType( com.rtsdk.eta.rdm.DomainTypes.MARKET_PRICE );
		...
		updateMsg.msgKey().nameType( com.rtsdk.eta.rdm.InstrumentNameTypes.RIC );
	...
	public static int eta_EncodeFilterListAll(com.rtsdk.eta.codec.EncodeIterator encodeIter, int encodeOption)
	{
		...
		if ( ( encodeOption & EncodingTypeFlags.CONTAINER_TYPES) != 0 )
		{
			...
			filterEntry.id(1);
	        filterEntry.action(com.rtsdk.eta.codec.FilterEntryActions.SET);
	        
	        filterEntry.applyHasContainerType();
	        filterEntry.containerType(com.rtsdk.eta.codec.DataTypes.FIELD_LIST);
	        ...
	        filterEntry.applyHasContainerType();
	        filterEntry.containerType(com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST);
	        ...
	        filterEntry.applyHasContainerType();
	        filterEntry.containerType(com.rtsdk.eta.codec.DataTypes.FILTER_LIST);
	        ...
	        filterEntry.applyHasContainerType();
	        filterEntry.containerType(com.rtsdk.eta.codec.DataTypes.SERIES);
	        ...
	        filterEntry.applyHasContainerType();
	        filterEntry.containerType(com.rtsdk.eta.codec.DataTypes.VECTOR);
	        ...
	        filterEntry.applyHasContainerType();
	        filterEntry.containerType(com.rtsdk.eta.codec.DataTypes.MAP);
		...
		if ( ( encodeOption & EncodingTypeFlags.MESSAGE_TYPES) != 0 )
		{
	        ...
	        filterEntry.applyHasContainerType();
	        filterEntry.containerType(com.rtsdk.eta.codec.DataTypes.MSG);
	...
	public static int eta_EncodeSeriesAll(com.rtsdk.eta.codec.EncodeIterator encodeIter, int containerType )
	{
		...
		if ( containerType < com.rtsdk.eta.codec.DataTypes.FIELD_LIST )
			return CodecReturnCodes.INVALID_ARGUMENT;
		...
		com.rtsdk.eta.codec.SeriesEntry seriesEntry = CodecFactory.createSeriesEntry();
		...
		for ( int i = 0; i < totalCountHint; i++ )
		{
			...
			case com.rtsdk.eta.codec.DataTypes.SERIES:
				...
				if ( i == 0 )
				{
					...
					argument = com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST;
				}
				else if ( i == 1 )
				{
					argument = com.rtsdk.eta.codec.DataTypes.MSG;
				}
			...
			case com.rtsdk.eta.codec.DataTypes.VECTOR:
				...
				if ( i == 0 )
				{
					...
					argument = com.rtsdk.eta.codec.DataTypes.FIELD_LIST;
				}
				else if ( i == 1 )
				{
					argument = com.rtsdk.eta.codec.DataTypes.MSG;
	...
	public static int eta_EncodeVectorAll(com.rtsdk.eta.codec.EncodeIterator encodeIter, int containerType )
	{
		...
		com.rtsdk.eta.codec.VectorEntry vectorEntry = CodecFactory.createVectorEntry();
		...
		for ( int i = 0; i < totalCountHint; i++ )
		{
			...
			case com.rtsdk.eta.codec.DataTypes.FIELD_LIST:
				...
				vectorEntry.action(com.rtsdk.eta.codec.VectorEntryActions.SET);
    ...
    public static void eta_encodeDictionaryMsg(com.rtsdk.eta.codec.DataDictionary dictionary)
    {
        ...
        com.rtsdk.eta.codec.RefreshMsg msg = (com.rtsdk.eta.codec.RefreshMsg)CodecFactory.createMsg();
        com.rtsdk.eta.codec.EncodeIterator encodeIter = CodecFactory.createEncodeIterator();
        com.rtsdk.eta.transport.Error error = com.rtsdk.eta.transport.TransportFactory.createError();
        com.rtsdk.eta.codec.Buffer nameBuf = CodecFactory.createBuffer();
        com.rtsdk.eta.codec.Int dictionaryFid = CodecFactory.createInt();
        ...
        msg.domainType(com.rtsdk.eta.rdm.DomainTypes.DICTIONARY);
        msg.containerType(com.rtsdk.eta.codec.DataTypes.SERIES);
		msg.state().streamState(com.rtsdk.eta.codec.StreamStates.OPEN);
		msg.state().dataState(com.rtsdk.eta.codec.DataStates.OK);
		msg.state().code(com.rtsdk.eta.codec.StateCodes.NONE);
		msg.state().text().data("Field Dictionary Refresh (starting fid " + dictionaryFid.toLong() + ")");    	
		msg.applySolicited();
		msg.applyHasMsgKey();
    	msg.msgKey().filter(com.rtsdk.eta.rdm.Dictionary.VerbosityValues.NORMAL);
        ...
        checkResult(CodecReturnCodes.DICT_PART_ENCODED, dictionary.encodeFieldDictionary(encodeIter, dictionaryFid,
        										com.rtsdk.eta.rdm.Dictionary.VerbosityValues.NORMAL, error));        
...
//	}
	...
	public static void EmaDecode_ETAFieldListAll(com.rtsdk.ema.access.FieldList fl, int encodeOption)
	{
        ...
        Iterator<FieldEntry> iter = fl.iterator();
       	...
       	if ( (encodeOption & EncodingTypeFlags.PRIMITIVE_TYPES ) != 0 )
       	{
	        ...
	        com.rtsdk.ema.access.FieldEntry fe1 = iter.next();
	        checkResult(fe1.loadType(), com.rtsdk.ema.access.DataType.DataTypes.ERROR);
	        checkResult(fe1.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.ERROR);
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe2 = iter.next();
	        checkResult(fe2.fieldId(), 16);
	        checkResult(fe2.name(), "TRADE_DATE");
	        checkResult(fe2.loadType(), com.rtsdk.ema.access.DataType.DataTypes.DATE);
	        checkResult(fe2.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.DATE);
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe3 = iter.next();
	        checkResult(fe3.fieldId(), 147);
	        checkResult(fe3.name(), "OFF_BND_NO");
	        checkResult(fe3.loadType(), com.rtsdk.ema.access.DataType.DataTypes.UINT);
	        checkResult(fe3.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.UINT);
	        checkResult(fe3.code(), Data.DataCode.NO_CODE);
	        checkResult(fe3.uintValue(), 23456);
	
	        // check fourth field entry
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe4 = iter.next();
	        checkResult(fe4.fieldId(), 1080);
	        checkResult(fe4.name(), "PREF_DISP");
	        checkResult(fe4.loadType(), com.rtsdk.ema.access.DataType.DataTypes.UINT);
	        checkResult(fe4.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.UINT);
	        checkResult(fe4.code(), Data.DataCode.NO_CODE);
	        checkResult(fe4.uintValue(), 23456);
	        
	        // check fifth field entry
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe5 = iter.next();
	        checkResult(fe5.fieldId(), 22);
	        checkResult(fe5.name(), "BID");
	        checkResult(fe5.loadType(), com.rtsdk.ema.access.DataType.DataTypes.REAL);
	        checkResult(fe5.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.REAL);
	        checkResult(fe5.code(), Data.DataCode.BLANK);
	        
	        // check sixth field entry
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe6 = iter.next();
	        checkResult(fe6.fieldId(), 24);
	        checkResult(fe6.name(), "BID_2");
	        checkResult(fe6.loadType(), com.rtsdk.ema.access.DataType.DataTypes.REAL);
	        checkResult(fe6.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.REAL);
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe7 = iter.next();
	        checkResult(fe7.fieldId(), 25);
	        checkResult(fe7.name(), "ASK");
	        checkResult(fe7.loadType(), com.rtsdk.ema.access.DataType.DataTypes.REAL);
	        checkResult(fe7.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.REAL);
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe8 = iter.next();
	        checkResult(fe8.fieldId(), 18);
	        checkResult(fe8.name(), "TRDTIM_1");
	        checkResult(fe8.loadType(), com.rtsdk.ema.access.DataType.DataTypes.TIME);
	        checkResult(fe8.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.TIME);
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe9 = iter.next();
	        checkResult(fe9.fieldId(), TestUtilities.INTEGER);
	        checkResult(fe9.name(), "INTEGER");
	        checkResult(fe9.loadType(), com.rtsdk.ema.access.DataType.DataTypes.INT);
	        checkResult(fe9.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.INT);
	        checkResult(fe9.code(), Data.DataCode.NO_CODE);
	        checkResult(fe9.intValue(), 65432);
	        
	        // check tenth field entry
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe10 = iter.next();
	        checkResult(fe10.fieldId(), TestUtilities.MY_FLOAT);
	        checkResult(fe10.name(), "MY_FLOAT");
	        checkResult(fe10.loadType(), com.rtsdk.ema.access.DataType.DataTypes.FLOAT);
	        checkResult(fe10.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.FLOAT);
	        checkResult(fe10.code(), Data.DataCode.NO_CODE);
	        checkResult(fe10.floatValue(), 3.14f);
	
	        // check eleventh field entry
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe11 = iter.next();
	        checkResult(fe11.fieldId(), TestUtilities.MY_DOUBLE);
	        checkResult(fe11.name(), "MY_DOUBLE");
	        checkResult(fe11.loadType(), com.rtsdk.ema.access.DataType.DataTypes.DOUBLE);
	        checkResult(fe11.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.DOUBLE);
	        checkResult(fe11.code(), Data.DataCode.NO_CODE);
	        checkResult(fe11.doubleValue(), 3.1416);
	
	        // check twelveth field entry
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe12 = iter.next();
	        checkResult(fe12.fieldId(), TestUtilities.TRADE_DATETIME);
	        checkResult(fe12.name(), "TRADE_DATE");
	        checkResult(fe12.loadType(), com.rtsdk.ema.access.DataType.DataTypes.DATETIME);
	        checkResult(fe12.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.DATETIME);
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe13 = iter.next();
	        checkResult(fe13.fieldId(), TestUtilities.MY_QOS);
	        checkResult(fe13.name(), "MY_QOS");
	        checkResult(fe13.loadType(), com.rtsdk.ema.access.DataType.DataTypes.QOS);
	        checkResult(fe13.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.QOS);
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe14 = iter.next();
	        checkResult(fe14.fieldId(), TestUtilities.MY_STATE);
	        checkResult(fe14.name(), "MY_STATE");
	        checkResult(fe14.loadType(), com.rtsdk.ema.access.DataType.DataTypes.STATE);
	        checkResult(fe14.code(), Data.DataCode.NO_CODE);
	        checkResult(fe14.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.STATE);
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe15 = iter.next();
	        checkResult(fe15.fieldId(), TestUtilities.MY_BUFFER);
	        checkResult(fe15.name(), "MY_BUFFER");
	        checkResult(fe15.loadType(), com.rtsdk.ema.access.DataType.DataTypes.BUFFER);
	        checkResult(fe15.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.BUFFER);
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe16 = iter.next();
	        checkResult(fe16.fieldId(), 4);
	        checkResult(fe16.name(), "RDN_EXCHID");
	        checkResult(fe16.loadType(), com.rtsdk.ema.access.DataType.DataTypes.ENUM);
	        checkResult(fe16.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.ENUM);
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe17 = iter.next();
	        checkResult(fe17.fieldId(), TestUtilities.MY_ARRAY);
	        checkResult(fe17.name(), "MY_ARRAY");
	        checkResult(fe17.loadType(), com.rtsdk.ema.access.DataType.DataTypes.ARRAY);
	        checkResult(fe17.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.ARRAY);
	        ...
	        Iterator<OmmArrayEntry> ar2Iter = ar2.iterator();
	                ...
	                checkResult(ar2Iter.hasNext());
	                     ...
	                     checkResult(ae1.loadType(), com.rtsdk.ema.access.DataType.DataTypes.UINT);
	                     checkResult(ae1.uintValue(), 10);
	                checkResult(ar2Iter.hasNext());
	                     OmmArrayEntry ae2 = ar2Iter.next();
	                     checkResult(ae2.loadType(), com.rtsdk.ema.access.DataType.DataTypes.UINT);
	                     checkResult(ae2.uintValue(), 20);
	                checkResult(ar2Iter.hasNext());
	                     OmmArrayEntry ae3 = ar2Iter.next();
	                     checkResult(ae3.loadType(), com.rtsdk.ema.access.DataType.DataTypes.UINT);
	                     checkResult(ae3.uintValue(), 30);
	                checkResult(ar2Iter.hasNext());
	                     OmmArrayEntry ae4 = ar2Iter.next();
	                     checkResult(ae4.loadType(), com.rtsdk.ema.access.DataType.DataTypes.UINT);
	                     checkResult(ae4.uintValue(), 40);
	                checkResult(ar2Iter.hasNext());
	                     OmmArrayEntry ae5 = ar2Iter.next();
	                     checkResult(ae5.loadType(), com.rtsdk.ema.access.DataType.DataTypes.UINT);
            ...
            checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe18 = iter.next();
	        checkResult(fe18.fieldId(), 4);
	        checkResult(fe18.name(), "RDN_EXCHID");
	        checkResult(fe18.loadType(), com.rtsdk.ema.access.DataType.DataTypes.ENUM);
	        checkResult(fe18.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.ENUM);
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe19 = iter.next();
	        checkResult(fe19.fieldId(), 4);
	        checkResult(fe19.name(), "RDN_EXCHID");
	        checkResult(fe19.loadType(), com.rtsdk.ema.access.DataType.DataTypes.ENUM);
	        checkResult(fe19.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.ENUM);
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe20 = iter.next();
	        checkResult(fe20.fieldId(), 115);
	        checkResult(fe20.name(), "BID_TICK_1");
	        checkResult(fe20.loadType(), com.rtsdk.ema.access.DataType.DataTypes.ENUM);
	        checkResult(fe20.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.ENUM);
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fe25 = iter.next();
	        checkResult(fe25.fieldId(), 8960);
	        checkResult(fe25.name(), "GBLISS_IND");
	        checkResult(fe25.loadType(), com.rtsdk.ema.access.DataType.DataTypes.ENUM);
	        checkResult(fe25.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.ENUM);
       	...
       	if ( ( encodeOption & EncodingTypeFlags.CONTAINER_TYPES ) != 0 )
       	{
	        ...
	        checkResult(iter.hasNext());
	        com.rtsdk.ema.access.FieldEntry fieldEntry1 = iter.next();
    ...
    public static void EmaDecode_ETAArrayAll(OmmArray array)
    {
        ...
        checkResult(iter.hasNext());
        com.rtsdk.ema.access.OmmArrayEntry ae1 = iter.next();
        checkResult(ae1.loadType(), com.rtsdk.ema.access.DataType.DataTypes.BUFFER);
        checkResult(ae1.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.BUFFER);
        ...
        checkResult(iter.hasNext());
        com.rtsdk.ema.access.OmmArrayEntry ae2 = iter.next();
        checkResult(ae2.loadType(), com.rtsdk.ema.access.DataType.DataTypes.BUFFER);
        checkResult(ae2.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.BUFFER);
        ...
        checkResult(iter.hasNext());
        com.rtsdk.ema.access.OmmArrayEntry ae3 = iter.next();
        checkResult(ae3.loadType(), com.rtsdk.ema.access.DataType.DataTypes.BUFFER);
        checkResult(ae3.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.BUFFER);
        ...
        checkResult(iter.hasNext());
        com.rtsdk.ema.access.OmmArrayEntry ae4 = iter.next();
        checkResult(ae4.loadType(), com.rtsdk.ema.access.DataType.DataTypes.BUFFER);
        checkResult(ae4.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.BUFFER);
	...
	public static void EmaDecode_ETAElementListAll(com.rtsdk.ema.access.ElementList el, int encodeOption)
	{
        ...
        Iterator<ElementEntry> elIter = el.iterator();
       	...
       	if ( (encodeOption & EncodingTypeFlags.PRIMITIVE_TYPES ) != 0 )
       	{
	        ...
	        com.rtsdk.ema.access.ElementEntry ee1 = elIter.next();
	        checkResult(ee1.name(), "Element - Time");
	        checkResult(ee1.loadType(), com.rtsdk.ema.access.DataType.DataTypes.TIME);
	        checkResult(ee1.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.TIME);
	        ...
	        checkResult(elIter.hasNext());
	        com.rtsdk.ema.access.ElementEntry ee2 = elIter.next();
	        checkResult(ee2.name(), "Element - Int");
	        checkResult(ee2.loadType(), com.rtsdk.ema.access.DataType.DataTypes.INT);
	        checkResult(ee2.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.INT);
	        checkResult(ee2.code(), Data.DataCode.NO_CODE);
	        checkResult(ee2.intValue(), 13);
	        
	        // check third element entry
	        checkResult(elIter.hasNext());
	        com.rtsdk.ema.access.ElementEntry ee3 = elIter.next();
	        checkResult(ee3.name(), "Element - UInt");
	        checkResult(ee3.loadType(), com.rtsdk.ema.access.DataType.DataTypes.UINT);
	        checkResult(ee3.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.UINT);
	        checkResult(ee3.code(), Data.DataCode.NO_CODE);
	        checkResult(ee3.uintValue(), 17);
	       
	        // check fourth element entry
	        checkResult(elIter.hasNext());
	        com.rtsdk.ema.access.ElementEntry ee4 = elIter.next();
	        checkResult(ee4.name(), "Element - Real - Blank");
	        checkResult(ee4.loadType(), com.rtsdk.ema.access.DataType.DataTypes.REAL);
	        checkResult(ee4.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.REAL);
	        checkResult(ee4.code(), Data.DataCode.BLANK);
	      
	        // check fifth element entry
	        checkResult(elIter.hasNext());
	        com.rtsdk.ema.access.ElementEntry ee5 = elIter.next();
	        checkResult(ee5.name(), "Element - Float");
	        checkResult(ee5.loadType(), com.rtsdk.ema.access.DataType.DataTypes.FLOAT);
	        checkResult(ee5.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.FLOAT);
	        checkResult(ee5.code(), Data.DataCode.NO_CODE);
	        checkResult(ee5.floatValue(), 1.34f);
	
	        // check sixth element entry
	        checkResult(elIter.hasNext());
	        com.rtsdk.ema.access.ElementEntry ee6 = elIter.next();
	        checkResult(ee6.name(), "Element - Double");
	        checkResult(ee6.loadType(), com.rtsdk.ema.access.DataType.DataTypes.DOUBLE);
	        checkResult(ee6.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.DOUBLE);
     	...
     	if ( (encodeOption & EncodingTypeFlags.CONTAINER_TYPES ) != 0 )
       	{
 			checkResult(elIter.hasNext());
 			com.rtsdk.ema.access.ElementEntry ee7 = elIter.next();
     	...
     	if ( (encodeOption & EncodingTypeFlags.MESSAGE_TYPES ) != 0 )
       	{
     		checkResult(elIter.hasNext());
 			com.rtsdk.ema.access.ElementEntry ee15 = elIter.next();
	...
	public static void EmaDecode_ETAFilterListAll(com.rtsdk.ema.access.FilterList filterList, int encodeOption)
	{
       	...
       	if ( ( encodeOption & EncodingTypeFlags.CONTAINER_TYPES) != 0 )
    	{
	        ...
	        com.rtsdk.ema.access.FilterEntry filterEntry1 = filterIter.next();
	        
	        checkResult(filterEntry1.filterId(), 1);
	        checkResult(filterEntry1.loadType(), com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST);
	        checkResult(filterEntry1.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST);
	        ...
	        checkResult(filterEntry2.loadType(), com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST);
	        checkResult(filterEntry2.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST);
	        ...
	        checkResult(filterEntry3.loadType(), com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST);
	        checkResult(filterEntry3.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST);
	        ...
	        checkResult(filterEntry4.loadType(), com.rtsdk.ema.access.DataType.DataTypes.SERIES);
	        checkResult(filterEntry4.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.SERIES);
	        ...
	        checkResult(filterEntry5.loadType(), com.rtsdk.ema.access.DataType.DataTypes.VECTOR);
	        checkResult(filterEntry5.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.VECTOR);
	        ...
	        checkResult(filterEntry6.loadType(), com.rtsdk.ema.access.DataType.DataTypes.MAP);
	        checkResult(filterEntry6.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.MAP);
    	...
    	{
     		checkResult(filterIter.hasNext());
     		com.rtsdk.ema.access.FilterEntry filterEntry7 = filterIter.next();
	        
	        checkResult(filterEntry7.filterId(), 7);
	        checkResult(filterEntry7.loadType(), com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG);
	        checkResult(filterEntry7.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG);
	        ...
	        checkResult(filterEntry8.loadType(), com.rtsdk.ema.access.DataType.DataTypes.UPDATE_MSG);
	        checkResult(filterEntry8.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.UPDATE_MSG);
	        ...
	        checkResult(filterEntry9.loadType(), com.rtsdk.ema.access.DataType.DataTypes.STATUS_MSG);
	        checkResult(filterEntry9.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.STATUS_MSG);
	        ...
	        checkResult(filterEntry10.loadType(), com.rtsdk.ema.access.DataType.DataTypes.GENERIC_MSG);
	        checkResult(filterEntry10.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.GENERIC_MSG);
	        ...
	        checkResult(filterEntry11.loadType(), com.rtsdk.ema.access.DataType.DataTypes.POST_MSG);
	        checkResult(filterEntry11.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.POST_MSG);
	        ...
	        checkResult(filterEntry12.loadType(), com.rtsdk.ema.access.DataType.DataTypes.ACK_MSG);
	        checkResult(filterEntry12.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.ACK_MSG);
	        ...
	        checkResult(filterEntry13.loadType(), com.rtsdk.ema.access.DataType.DataTypes.REQ_MSG);
	        checkResult(filterEntry13.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.REQ_MSG);
	...
	public static void EmaDecode_ETASeriesAll(com.rtsdk.ema.access.Series series, int containerType)
	{
		...
		case com.rtsdk.eta.codec.DataTypes.FIELD_LIST:
		{
			...
			com.rtsdk.ema.access.SeriesEntry seriesEntry1 = seriesIter.next();
	...
	public static void EmaDecode_ETAVectorAll(com.rtsdk.ema.access.Vector vector, int containerType)
	{
		...
		case com.rtsdk.eta.codec.DataTypes.FIELD_LIST:
		{
			...
			com.rtsdk.ema.access.VectorEntry vectorEntry1 = vectorIter.next();
			
			checkResult(vectorEntry1.position(), 2);
			checkResult(vectorEntry1.action(), com.rtsdk.ema.access.VectorEntry.VectorAction.SET);
			...
			checkResult(vectorEntry2.action(), com.rtsdk.ema.access.VectorEntry.VectorAction.SET);
	...
	public static void EmaDecode_ETAMapKeyUIntAll(com.rtsdk.ema.access.Map map, int containerType)
	{
		...
		case com.rtsdk.eta.codec.DataTypes.FIELD_LIST:
		{
			...
			com.rtsdk.ema.access.MapEntry mapEntry1 = mapIter.next();
			checkResult(mapEntry1.action(), com.rtsdk.ema.access.MapEntry.MapAction.ADD);
			checkResult(mapEntry1.key().dataType(), com.rtsdk.ema.access.DataType.DataTypes.UINT );
			...
			checkResult(mapEntry2.action(), com.rtsdk.ema.access.MapEntry.MapAction.UPDATE);
			checkResult(mapEntry2.key().dataType(), com.rtsdk.ema.access.DataType.DataTypes.UINT );
		...
		checkResult(mapIter.hasNext());
	    com.rtsdk.ema.access.MapEntry mapEntry3 = mapIter.next();
	    checkResult(mapEntry3.action(), com.rtsdk.ema.access.MapEntry.MapAction.DELETE);
	    checkResult(mapEntry3.key().dataType(), com.rtsdk.ema.access.DataType.DataTypes.UINT );
	    checkResult(mapEntry3.key().uintValue(), 3 );
	    checkResult(mapEntry3.loadType(), com.rtsdk.ema.access.DataType.DataTypes.NO_DATA);
		checkResult(mapEntry3.load().dataType(), com.rtsdk.ema.access.DataType.DataTypes.NO_DATA);
...
//		checkResult( ee7..qos().rate() == 1, "ElementEntry::getTime().rate()" );
	...
	public static void EmaDecode_ETARequestMsgAll(ReqMsg reqMsg, int containerType)
	{
		...
		TestUtilities.checkResult(reqMsg.nameType() == com.rtsdk.ema.rdm.EmaRdm.INSTRUMENT_NAME_RIC , "ReqMsg.nameType()");
		...
		switch (containerType)
		{
			case com.rtsdk.eta.codec.DataTypes.FIELD_LIST:
			{
				TestUtilities.checkResult(reqMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "ReqMsg.attrib().dataType()");
				TestUtilities.checkResult(reqMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "ReqMsg.payload().dataType()");
				
				com.rtsdk.eta.codec.Buffer extendedBuffer = CodecFactory.createBuffer();
			...
			case com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST:
			{
				TestUtilities.checkResult(reqMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "ReqMsg.attrib().dataType()");
				TestUtilities.checkResult(reqMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "ReqMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.FILTER_LIST:
			{
				TestUtilities.checkResult(reqMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "ReqMsg.attrib().dataType()");
				TestUtilities.checkResult(reqMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "ReqMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.SERIES:
			{	
				TestUtilities.checkResult(reqMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "ReqMsg.attrib().dataType()");
				TestUtilities.checkResult(reqMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "ReqMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.VECTOR:
			{
				TestUtilities.checkResult(reqMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "ReqMsg.attrib().dataType()");
				TestUtilities.checkResult(reqMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "ReqMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MAP:
			{
				TestUtilities.checkResult(reqMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "ReqMsg.attrib().dataType()");
				TestUtilities.checkResult(reqMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "ReqMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MSG:
			{
				TestUtilities.checkResult(reqMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "ReqMsg.attrib().dataType()");
				TestUtilities.checkResult(reqMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "ReqMsg.payload().dataType()");
	...
	public static void EmaDecode_ETARefreshMsgAll(RefreshMsg refreshMsg, int containerType)
	{
		...
		TestUtilities.checkResult(refreshMsg.nameType() == com.rtsdk.ema.rdm.EmaRdm.INSTRUMENT_NAME_RIC , "RefreshMsg.nameType()");
		...
		switch (containerType)
		{
			case com.rtsdk.eta.codec.DataTypes.FIELD_LIST:
			{
				TestUtilities.checkResult(refreshMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "RefreshMsg.attrib().dataType()");
				TestUtilities.checkResult(refreshMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "RefreshMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST:
			{
				TestUtilities.checkResult(refreshMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "RefreshMsg.attrib().dataType()");
				TestUtilities.checkResult(refreshMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "RefreshMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.FILTER_LIST:
			{
				TestUtilities.checkResult(refreshMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "RefreshMsg.attrib().dataType()");
				TestUtilities.checkResult(refreshMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "RefreshMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.SERIES:
			{	
				TestUtilities.checkResult(refreshMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "RefreshMsg.attrib().dataType()");
				TestUtilities.checkResult(refreshMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "RefreshMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.VECTOR:
			{
				TestUtilities.checkResult(refreshMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "RefreshMsg.attrib().dataType()");
				TestUtilities.checkResult(refreshMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "RefreshMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MAP:
			{
				TestUtilities.checkResult(refreshMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "RefreshMsg.attrib().dataType()");
				TestUtilities.checkResult(refreshMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "RefreshMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MSG:
			{
				TestUtilities.checkResult(refreshMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "RefreshMsg.attrib().dataType()");
				TestUtilities.checkResult(refreshMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "RefreshMsg.payload().dataType()");
	...
	public static void EmaDecode_ETAUpdateMsgAll(UpdateMsg updateMsg, int containerType)
	{
		...
		TestUtilities.checkResult(updateMsg.domainType() == com.rtsdk.ema.rdm.EmaRdm.MMT_MARKET_PRICE, "UpdateMsg.domainType()");
		...
		TestUtilities.checkResult(updateMsg.nameType() == com.rtsdk.ema.rdm.EmaRdm.INSTRUMENT_NAME_RIC , "UpdateMsg.nameType()");
		...
		switch (containerType)
		{
			case com.rtsdk.eta.codec.DataTypes.FIELD_LIST:
			{
				TestUtilities.checkResult(updateMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "UpdateMsg.attrib().dataType()");
				TestUtilities.checkResult(updateMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "UpdateMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST:
			{
				TestUtilities.checkResult(updateMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "UpdateMsg.attrib().dataType()");
				TestUtilities.checkResult(updateMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "UpdateMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.FILTER_LIST:
			{
				TestUtilities.checkResult(updateMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "UpdateMsg.attrib().dataType()");
				TestUtilities.checkResult(updateMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "UpdateMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.SERIES:
			{	
				TestUtilities.checkResult(updateMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "UpdateMsg.attrib().dataType()");
				TestUtilities.checkResult(updateMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "UpdateMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.VECTOR:
			{
				TestUtilities.checkResult(updateMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "UpdateMsg.attrib().dataType()");
				TestUtilities.checkResult(updateMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "UpdateMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MAP:
			{
				TestUtilities.checkResult(updateMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "UpdateMsg.attrib().dataType()");
				TestUtilities.checkResult(updateMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "UpdateMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MSG:
			{
				TestUtilities.checkResult(updateMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "UpdateMsg.attrib().dataType()");
				TestUtilities.checkResult(updateMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "UpdateMsg.payload().dataType()");
	...
	public static void EmaDecode_ETAStatusMsgAll(StatusMsg statusMsg, int containerType)
	{
		...
		TestUtilities.checkResult(statusMsg.nameType() == com.rtsdk.ema.rdm.EmaRdm.INSTRUMENT_NAME_RIC,
				"StatusMsg.nameType()");
		...
		switch (containerType)
		{
			case com.rtsdk.eta.codec.DataTypes.FIELD_LIST:
			{
				TestUtilities.checkResult(statusMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "StatusMsg.attrib().dataType()");
				TestUtilities.checkResult(statusMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "StatusMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST:
			{
				TestUtilities.checkResult(statusMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "StatusMsg.attrib().dataType()");
				TestUtilities.checkResult(statusMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "StatusMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.FILTER_LIST:
			{
				TestUtilities.checkResult(statusMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "StatusMsg.attrib().dataType()");
				TestUtilities.checkResult(statusMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "StatusMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.SERIES:
			{	
				TestUtilities.checkResult(statusMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "StatusMsg.attrib().dataType()");
				TestUtilities.checkResult(statusMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "StatusMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.VECTOR:
			{
				TestUtilities.checkResult(statusMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "StatusMsg.attrib().dataType()");
				TestUtilities.checkResult(statusMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "StatusMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MAP:
			{
				TestUtilities.checkResult(statusMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "StatusMsg.attrib().dataType()");
				TestUtilities.checkResult(statusMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "StatusMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MSG:
			{
				TestUtilities.checkResult(statusMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "StatusMsg.attrib().dataType()");
				TestUtilities.checkResult(statusMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "StatusMsg.payload().dataType()");
	...
	public static void EmaDecode_ETAGenericMsgAll(GenericMsg genericMsg, int containerType)
	{
		...
		TestUtilities.checkResult(genericMsg.domainType() == com.rtsdk.ema.rdm.EmaRdm.MMT_MARKET_PRICE, "GenericMsg.domainType()");
		...
		TestUtilities.checkResult(genericMsg.nameType() == com.rtsdk.ema.rdm.EmaRdm.INSTRUMENT_NAME_RIC , "GenericMsg.nameType()");
		...
		switch (containerType)
		{
			case com.rtsdk.eta.codec.DataTypes.FIELD_LIST:
			{
				TestUtilities.checkResult(genericMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "GenericMsg.attrib().dataType()");
				TestUtilities.checkResult(genericMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "GenericMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST:
			{
				TestUtilities.checkResult(genericMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "GenericMsg.attrib().dataType()");
				TestUtilities.checkResult(genericMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "GenericMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.FILTER_LIST:
			{
				TestUtilities.checkResult(genericMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "GenericMsg.attrib().dataType()");
				TestUtilities.checkResult(genericMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "GenericMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.SERIES:
			{	
				TestUtilities.checkResult(genericMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "GenericMsg.attrib().dataType()");
				TestUtilities.checkResult(genericMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "GenericMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.VECTOR:
			{
				TestUtilities.checkResult(genericMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "GenericMsg.attrib().dataType()");
				TestUtilities.checkResult(genericMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "GenericMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MAP:
			{
				TestUtilities.checkResult(genericMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "GenericMsg.attrib().dataType()");
				TestUtilities.checkResult(genericMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "GenericMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MSG:
			{
				TestUtilities.checkResult(genericMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "GenericMsg.attrib().dataType()");
				TestUtilities.checkResult(genericMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "GenericMsg.payload().dataType()");
	...
	public static void EmaDecode_ETAPostMsgAll(PostMsg postMsg, int containerType)
	{
		...
		TestUtilities.checkResult(postMsg.nameType() == com.rtsdk.ema.rdm.EmaRdm.INSTRUMENT_NAME_RIC , "PostMsg.nameType()");
		...
		switch (containerType)
		{
			case com.rtsdk.eta.codec.DataTypes.FIELD_LIST:
			{
				TestUtilities.checkResult(postMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "PostMsg.attrib().dataType()");
				TestUtilities.checkResult(postMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "PostMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST:
			{
				TestUtilities.checkResult(postMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "PostMsg.attrib().dataType()");
				TestUtilities.checkResult(postMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "PostMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.FILTER_LIST:
			{
				TestUtilities.checkResult(postMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "PostMsg.attrib().dataType()");
				TestUtilities.checkResult(postMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "PostMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.SERIES:
			{	
				TestUtilities.checkResult(postMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "PostMsg.attrib().dataType()");
				TestUtilities.checkResult(postMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "PostMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.VECTOR:
			{
				TestUtilities.checkResult(postMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "PostMsg.attrib().dataType()");
				TestUtilities.checkResult(postMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "PostMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MAP:
			{
				TestUtilities.checkResult(postMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "PostMsg.attrib().dataType()");
				TestUtilities.checkResult(postMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "PostMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MSG:
			{
				TestUtilities.checkResult(postMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "PostMsg.attrib().dataType()");
				TestUtilities.checkResult(postMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "PostMsg.payload().dataType()");
	...
	public static void EmaDecode_ETAAckMsgAll(AckMsg ackMsg, int containerType)
	{
		...
		TestUtilities.checkResult(ackMsg.nackCode() == com.rtsdk.ema.access.AckMsg.NackCode.DENIED_BY_SOURCE, "AckMsg.nackCode()");
		...
		TestUtilities.checkResult(ackMsg.nameType() == com.rtsdk.ema.rdm.EmaRdm.INSTRUMENT_NAME_RIC , "AckMsg.nameType()");
		...
		switch (containerType)
		{
			case com.rtsdk.eta.codec.DataTypes.FIELD_LIST:
			{
				TestUtilities.checkResult(ackMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "AckMsg.attrib().dataType()");
				TestUtilities.checkResult(ackMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FIELD_LIST, "AckMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST:
			{
				TestUtilities.checkResult(ackMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "AckMsg.attrib().dataType()");
				TestUtilities.checkResult(ackMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.ELEMENT_LIST, "AckMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.FILTER_LIST:
			{
				TestUtilities.checkResult(ackMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "AckMsg.attrib().dataType()");
				TestUtilities.checkResult(ackMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.FILTER_LIST, "AckMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.SERIES:
			{	
				TestUtilities.checkResult(ackMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "AckMsg.attrib().dataType()");
				TestUtilities.checkResult(ackMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.SERIES, "AckMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.VECTOR:
			{
				TestUtilities.checkResult(ackMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "AckMsg.attrib().dataType()");
				TestUtilities.checkResult(ackMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.VECTOR, "AckMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MAP:
			{
				TestUtilities.checkResult(ackMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "AckMsg.attrib().dataType()");
				TestUtilities.checkResult(ackMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.MAP, "AckMsg.payload().dataType()");
			...
			case com.rtsdk.eta.codec.DataTypes.MSG:
			{
				TestUtilities.checkResult(ackMsg.attrib().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "AckMsg.attrib().dataType()");
				TestUtilities.checkResult(ackMsg.payload().dataType() == com.rtsdk.ema.access.DataType.DataTypes.REFRESH_MSG, "AckMsg.payload().dataType()");
