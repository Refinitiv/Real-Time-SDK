...
public class SeriesTests extends TestCase
{
	...
	public void testSeriesContainselementLists_EncodeDecodeAll()
	{
	 ...
	 public void testSeries_EncodeETASeriesWithFieldListType_EncodeEMA_ToAnotherSeries_EMADecode() 
	 {
        ...
        if ((retVal = TestUtilities.eta_EncodeSeriesAll(encodeIter, com.refinitiv.eta.codec.DataTypes.FIELD_LIST)) < CodecReturnCodes.SUCCESS)
        {
        ...
        com.refinitiv.ema.access.Series series = JUnitTestConnect.createSeries();
        ...
        com.refinitiv.ema.access.Series seriesCopy = EmaFactory.createSeries();
        ...
        com.refinitiv.ema.access.Series decSeriesCopy = JUnitTestConnect.createSeries();
        ...
        TestUtilities.EmaDecode_ETASeriesAll(decSeriesCopy, com.refinitiv.eta.codec.DataTypes.FIELD_LIST);
	 ...
	 public void testSeries_EncodeETASeriesWithElementListType_EncodeEMA_ToAnotherSeries_EMADecode() 
	 {
        ...
        // Encode Series with ETA.
        if ((retVal = TestUtilities.eta_EncodeSeriesAll(encodeIter, com.refinitiv.eta.codec.DataTypes.ELEMENT_LIST)) < CodecReturnCodes.SUCCESS)
        {
            System.out.println("Error encoding field list.");
            System.out.println("Error " + CodecReturnCodes.toString(retVal) + "(" + retVal
                    + ") encountered with TestUtilities.eta_EncodeSeriesAll for container types.  " + "Error Text: "
        ...
        TestUtilities.EmaDecode_ETASeriesAll(decSeriesCopy, com.refinitiv.eta.codec.DataTypes.ELEMENT_LIST);
	 ...
	 public void testSeries_EncodeETASeriesWithFilterListType_EncodeEMA_ToAnotherSeries_EMADecode() 
	 {
        ...
        // Encode Series with ETA.
        if ((retVal = TestUtilities.eta_EncodeSeriesAll(encodeIter, com.refinitiv.eta.codec.DataTypes.FILTER_LIST)) < CodecReturnCodes.SUCCESS)
        {
            System.out.println("Error encoding field list.");
            System.out.println("Error " + CodecReturnCodes.toString(retVal) + "(" + retVal
                    + ") encountered with TestUtilities.eta_EncodeSeriesAll for container types.  " + "Error Text: "
        ...
        TestUtilities.EmaDecode_ETASeriesAll(decSeriesCopy, com.refinitiv.eta.codec.DataTypes.FILTER_LIST);
	 ...
	 public void testSeries_EncodeETASeriesWithSeriesType_EncodeEMA_ToAnotherSeries_EMADecode() 
	 {
        ...
        // Encode Series with ETA.
        if ((retVal = TestUtilities.eta_EncodeSeriesAll(encodeIter, com.refinitiv.eta.codec.DataTypes.SERIES)) < CodecReturnCodes.SUCCESS)
        {
            System.out.println("Error encoding field list.");
            System.out.println("Error " + CodecReturnCodes.toString(retVal) + "(" + retVal
                    + ") encountered with TestUtilities.eta_EncodeSeriesAll for container types.  " + "Error Text: "
        ...
        TestUtilities.EmaDecode_ETASeriesAll(decSeriesCopy, com.refinitiv.eta.codec.DataTypes.SERIES);
	 ...
	 public void testSeries_EncodeETASeriesWithVectorType_EncodeEMA_ToAnotherSeries_EMADecode() 
	 {
        ...
        // Encode Series with ETA.
        if ((retVal = TestUtilities.eta_EncodeSeriesAll(encodeIter, com.refinitiv.eta.codec.DataTypes.VECTOR)) < CodecReturnCodes.SUCCESS)
        {
            System.out.println("Error encoding field list.");
            System.out.println("Error " + CodecReturnCodes.toString(retVal) + "(" + retVal
                    + ") encountered with TestUtilities.eta_EncodeSeriesAll for container types.  " + "Error Text: "
        ...
        TestUtilities.EmaDecode_ETASeriesAll(decSeriesCopy, com.refinitiv.eta.codec.DataTypes.VECTOR);
	 ...
	 public void testSeries_EncodeETASeriesWithMapType_EncodeEMA_ToAnotherSeries_EMADecode() 
	 {
        ...
        // Encode Series with ETA.
        if ((retVal = TestUtilities.eta_EncodeSeriesAll(encodeIter, com.refinitiv.eta.codec.DataTypes.MAP)) < CodecReturnCodes.SUCCESS)
        {
            System.out.println("Error encoding field list.");
            System.out.println("Error " + CodecReturnCodes.toString(retVal) + "(" + retVal
                    + ") encountered with TestUtilities.eta_EncodeSeriesAll for container types.  " + "Error Text: "
        ...
        TestUtilities.EmaDecode_ETASeriesAll(decSeriesCopy, com.refinitiv.eta.codec.DataTypes.MAP);
	 ...
	 public void testSeries_EncodeETASeriesWithRefreshMsgType_EncodeEMA_ToAnotherSeries_EMADecode() 
	 {
        ...
        // Encode Series with ETA.
        if ((retVal = TestUtilities.eta_EncodeSeriesAll(encodeIter, com.refinitiv.eta.codec.DataTypes.MSG)) < CodecReturnCodes.SUCCESS)
        {
            System.out.println("Error encoding field list.");
            System.out.println("Error " + CodecReturnCodes.toString(retVal) + "(" + retVal
                    + ") encountered with TestUtilities.eta_EncodeSeriesAll for container types.  " + "Error Text: "
        ...
        TestUtilities.EmaDecode_ETASeriesAll(decSeriesCopy, com.refinitiv.eta.codec.DataTypes.MSG);
