...
public class DataDictionaryJunitTest extends TestCase {
	...
	private static com.refinitiv.eta.codec.DataDictionary globalEtaDataDictionary;
	private static DataDictionary globalDataDictionary;
	private static com.refinitiv.eta.transport.Error rsslError = com.refinitiv.eta.transport.TransportFactory.createError();
...
//	private static String enumTableFileName = "./Java/Ema/TestTools/UnitTests/TestData/testenumtype.def";
	...
	static
	{	
		globalEtaDataDictionary = com.refinitiv.eta.codec.CodecFactory.createDataDictionary();
		globalDataDictionary = com.refinitiv.ema.access.EmaFactory.createDataDictionary();
		...
		{
			TestUtilities.checkResult(false, "Failed to load dictionary information with com.refinitiv.eta.codec.DataDictionary");
		}
		...
		{
			TestUtilities.checkResult(false, "Failed to load enumerated types information with com.refinitiv.eta.codec.DataDictionary");
		}
	...
	boolean comparingEnumType(com.refinitiv.eta.codec.EnumType rsslEnumType, EnumType enumType, StringBuilder failedText, boolean payloadOnly)
	{
		...
		{
			failedText.append("com.refinitiv.eta.codec.EnumTyp is null");
		}
		
		return false;
	}
	
	boolean comparingEnumTable(com.refinitiv.eta.codec.EnumTypeTable rsslEnumTypeTable, EnumTypeTable enumTypeTable, StringBuilder failedText,
			boolean payloadOnly)
	{
	...
	boolean comparingDictionaryEntry(com.refinitiv.eta.codec.DictionaryEntry rsslDictionaryEntry, DictionaryEntry dictionaryEntry, StringBuilder failedText,
			boolean payloadOnly)
	{
		...
		{
			failedText.setLength(0);
			failedText.append("com.refinitiv.eta.codec.DictionaryEntry is null");
		}
		
		return false;
	}
	
	void comparingDataDictionary(com.refinitiv.eta.codec.DataDictionary rsslDataDictionary, 
			DataDictionary dataDictionary, boolean payloadOnly)
	{
		if(!payloadOnly)
		{
			TestUtilities.checkResult( rsslDataDictionary.infoEnumDate().toString().equals(dataDictionary.enumDate()) , 
					"Comparing DataDictionary.infoEnumDate() with com.refinitiv.eta.codec.DataDictionary.infoEnumDate()");
			
			TestUtilities.checkResult(rsslDataDictionary.infoEnumDesc().toString().equals(dataDictionary.enumDescription()), 
					"Comparing DataDictionary.infoEnumDesc() with com.refinitiv.eta.codec.DataDictionary.infoEnumDesc()");
			
			TestUtilities.checkResult(rsslDataDictionary.infoEnumFilename().toString().equals(dataDictionary.enumFilename()), 
					"Comparing DataDictionary.infoEnumFilename() with com.refinitiv.eta.codec.DataDictionary.infoEnumFilename()");
			
			TestUtilities.checkResult(rsslDataDictionary.infoFieldBuild().toString().equals(dataDictionary.fieldBuild()), 
					"Comparing DataDictionary.infoFieldBuild() with com.refinitiv.eta.codec.DataDictionary.infoFieldBuild()");
			
			TestUtilities.checkResult(rsslDataDictionary.infoFieldDate().toString().equals(dataDictionary.fieldDate()), 
					"Comparing DataDictionary.infoFieldDate() with com.refinitiv.eta.codec.DataDictionary.infoFieldDate()");
			
			TestUtilities.checkResult(rsslDataDictionary.infoFieldDesc().toString().equals(dataDictionary.fieldDescription()), 
					"Comparing DataDictionary.infoFieldDesc() with com.refinitiv.eta.codec.DataDictionary.infoFieldDesc()");
			
			TestUtilities.checkResult(rsslDataDictionary.infoFieldFilename().toString().equals(dataDictionary.fieldFilename()), 
					"Comparing DataDictionary.infoFieldFilename() with com.refinitiv.eta.codec.DataDictionary.infoFieldFilename()");
		}
		...
		com.refinitiv.eta.codec.DictionaryEntry rsslDictionaryEntry;
		...
		if(result)
		{
			TestUtilities.checkResult(result, "All DictionaryEntry from DataDictionary.entries() is equal with all entries in com.refinitiv.eta.codec.DataDictionary");
		}
		else
		{
		...
		com.refinitiv.eta.codec.EnumTypeTable rsslEnumTypeTable;
		...
		if (result)
		{
			TestUtilities.checkResult(result, "All EnumTypeTable from DataDictionary.enumTables() is equal with com.refinitiv.eta.codec.enumTables()");
		}
		else
		{
			TestUtilities.checkResult(result, errorText.toString());
	...
	public void testDataDictionary_Uninitialize()
	{
		...
		DataDictionary dataDictionary = com.refinitiv.ema.access.EmaFactory.createDataDictionary();
