...
public class ElementListTests extends TestCase
{
	...
	public void testElementList_ReEncodeEMAWithBigBuffer()
	{
		...
		// Decode ElementList and array 
          com.refinitiv.ema.access.ElementList elDec = JUnitTestConnect.createElementList();
	...
	public void testElementList_EncodeETA_decodeEMA_DecodeAll()
	{
		...
		com.refinitiv.ema.access.ElementList el = JUnitTestConnect.createElementList();
    ...
    public void testElementList_EncodeETA_DecodeEMA_EncodeEMA_DecodeETA()
    {
        ...
        com.refinitiv.ema.access.ElementList elCopy = EmaFactory.createElementList();
