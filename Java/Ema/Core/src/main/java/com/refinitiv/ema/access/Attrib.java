...
public interface Attrib
{
	 ...
	 * Return of {@link com.refinitiv.ema.access.DataType.DataTypes#NO_DATA} signifies no data present in Attrib.<br>
	 * Return of {@link com.refinitiv.ema.access.DataType.DataTypes#ERROR} signifies error while extracting content of Attrib.
	 * 
