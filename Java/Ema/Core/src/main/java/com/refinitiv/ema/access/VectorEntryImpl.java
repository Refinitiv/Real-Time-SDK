...
class VectorEntryImpl extends EntryImpl implements VectorEntry
{
	...
	protected com.refinitiv.eta.codec.VectorEntry	_rsslVectorEntry;
	protected int _entryDataType;
	
	VectorEntryImpl()
	{
		_rsslVectorEntry = com.refinitiv.eta.codec.CodecFactory.createVectorEntry();
	}
	
	VectorEntryImpl(com.refinitiv.eta.codec.VectorEntry rsslVectorEntry, DataImpl load, EmaObjectManager objManager)
	{
		super(load);
