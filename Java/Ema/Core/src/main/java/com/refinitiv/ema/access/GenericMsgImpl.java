...
class GenericMsgImpl extends MsgImpl implements GenericMsg
{
	...
	private final static String COPY_METHOD_NAME = GenericMsgImpl.class.getCanonicalName() + ".copy(GenericMsg destGenericMsg)";
	...
	public GenericMsgImpl(int initialSize) 
	{
		super(DataTypes.GENERIC_MSG, com.refinitiv.ema.access.EmaObjectManager.GlobalObjectManager);
	...
	void setMessageAttributes(GenericMsg other)
	{
		MsgImpl otherMsgImpl = (MsgImpl)other;
	...
	{
		boolean copiedMsgBuffer = super.copy(destGenericMsg, COPY_METHOD_NAME);
		
		if(copiedMsgBuffer == false)
		{
			((GenericMsgImpl)destGenericMsg).setMessageAttributes(this);
		}
		else
		{
