...
class GenericMsgImpl extends MsgImpl implements GenericMsg
{
	...
	{
		return ((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).checkHasSeqNum();
	}

	@Override
	public boolean hasSecondarySeqNum()
	{
		return ((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).checkHasSecondarySeqNum();
	}

	@Override
	public boolean hasPartNum()
	{
		return ((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).checkHasPartNum();
	}

	@Override
	public boolean hasPermissionData()
	{
		return ((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).checkHasPermData();
	}
	...
	public long seqNum()
	{
		...
		return ((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).seqNum();
	}
	...
	public long secondarySeqNum()
	{
		...
		return ((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).secondarySeqNum();
	}
	...
	public int partNum()
	{
		...
		return ((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).partNum();
	}
	...
	public ByteBuffer permissionData()
	{
		...
		_permissionData = Utilities.copyFromPool( ((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).permData(), _permissionData, _objManager);
	...
	{
		return ((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).checkMessageComplete();
	}

	@Override
	public boolean isProviderDriven() {
		return ((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).checkIsProviderDriven();
	}
	...
	public GenericMsg secondarySeqNum(long secondarySeqNum)
	{
		...
		((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).applyHasSecondarySeqNum();
		((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).secondarySeqNum(secondarySeqNum);
		return this;
	}
	...
	{
		 int flags = 	((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).flags();	
		 if (complete)
			 flags |= GenericMsgFlags.MESSAGE_COMPLETE;
		 else
			 flags &= ~GenericMsgFlags.MESSAGE_COMPLETE;
		 
		 ((com.refinitiv.eta.codec.GenericMsg)_rsslMsg).flags(flags);
	...
	com.refinitiv.eta.codec.GenericMsg rsslMsg()
	{
		return ((_rsslEncodeIter != null) ? (com.refinitiv.eta.codec.GenericMsg)(_rsslMsg) : null);
	}
}
