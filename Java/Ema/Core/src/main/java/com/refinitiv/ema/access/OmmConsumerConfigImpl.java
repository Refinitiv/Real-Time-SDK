...
class OmmConsumerConfigImpl extends EmaConfigImpl implements OmmConsumerConfig
{
	...
	{
		if (    connectionType != EmaConfig.ConnectionTypeEnum.SOCKET &&
				connectionType != EmaConfig.ConnectionTypeEnum.ENCRYPTED &&
				connectionType != EmaConfig.ConnectionTypeEnum.HTTP &&
				connectionType != EmaConfig.ConnectionTypeEnum.WEBSOCKET)
		{
