...
class OmmJsonImpl extends DataImpl implements OmmJson
{
    OmmJsonImpl()
    {
    ...
    public int dataType()
    {
        return DataType.DataTypes.JSON;
    }
    ...
    @Override
    public OmmJson string(String value)
    {
    ...
    @Override
    public OmmJson buffer(ByteBuffer value)
    {
    ...
    String toString(int indent)
    {
        ...
        Utilities.addIndent(_toString, indent).append("Json");
