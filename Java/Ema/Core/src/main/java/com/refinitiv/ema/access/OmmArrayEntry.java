...
public interface OmmArrayEntry
{
	 ...
	 * Attempts to extract data will cause OmmInvalidUsageException if {@link com.refinitiv.ema.access.Data.DataCode#BLANK} is returned.
	 * 
	...
	/**
	 * Adds a specific simple type of OMM data to the OmmArrayEntry.
	 * Default dataState is {@link com.refinitiv.ema.access.OmmState.DataState#OK}
	 * Default statusCode is {@link com.refinitiv.ema.access.OmmState.StatusCode#NONE}
