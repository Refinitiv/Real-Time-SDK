...
{
	protected com.refinitiv.eta.codec.SeriesEntry _rsslSeriesEntry;
	protected int _entryDataType;
	
	SeriesEntryImpl() 
	{
		_rsslSeriesEntry = com.refinitiv.eta.codec.CodecFactory.createSeriesEntry();
	}
	
	SeriesEntryImpl(com.refinitiv.eta.codec.SeriesEntry rsslSeriesEntry, DataImpl load)
	{
		super(load);
