...
import static com.thomsonreuters.ema.access.ServiceIdConverter.ServiceIdConversionError.*;
import static com.thomsonreuters.ema.access.ServiceIdConverter.ServiceIdConversionError.NONE;
...
public class ServiceIdConverter
{
    ...
    private ServiceIdConversionError encodeServiceIdFromName(String serviceName, com.thomsonreuters.upa.codec.Msg rsslMsg, int hasMsgKeyFlag)
    {
