 ...
 * (see {@link com.rtsdk.ema.access.EmaFactory#createOmmConsumer(OmmConsumerConfig)}
 *  or {@link com.rtsdk.ema.access.EmaFactory#createOmmConsumer(OmmConsumerConfig, OmmConsumerErrorClient)}).</p>
 * 
 * 
