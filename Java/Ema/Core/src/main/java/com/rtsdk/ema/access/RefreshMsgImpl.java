...
class RefreshMsgImpl extends MsgImpl implements RefreshMsg
{
	...
	RefreshMsgImpl(RefreshMsg other)
	{
		...
		((com.rtsdk.eta.codec.RefreshMsg) _rsslMsg).groupId(CodecFactory.createBuffer());
	...
	{
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).checkHasQos(); 
	}
	
	@Override
	public boolean hasSeqNum()
	{
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).checkHasSeqNum();
	}

	@Override
	public boolean hasPartNum()
	{
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).checkHasPartNum();
	}

	@Override
	public boolean hasPermissionData()
	{
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).checkHasPermData();
	}

	@Override
	public boolean hasPublisherId()
	{
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).checkHasPostUserInfo();
	}
	...
	public OmmState state()
	{
		...
		_state.decode(((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).state());
		_stateSet = true;
	...
	public OmmQos qos()
	{
		...
		_qos.decode(((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).qos());
		_qosSet = true;
	...
	public long seqNum()
	{
		...
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).seqNum();
	}
	...
	public int partNum()
	{
		...
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).partNum();
	}

	@Override
	public ByteBuffer itemGroup()
	{
		_itemGroup = Utilities.copyFromPool( ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).groupId(), _itemGroup, _objManager);
		return _itemGroup;
	}
	...
	public ByteBuffer permissionData()
	{
		...
		_permissionData = Utilities.copyFromPool( ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).permData(), _permissionData, _objManager);
	...
	public long publisherIdUserId()
	{
		...
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).postUserInfo().userId();
	}
	...
	public long publisherIdUserAddress()
	{
		...
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).postUserInfo().userAddr();
	}

	@Override
	public boolean solicited()
	{
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).checkSolicited();
	}

	@Override
	public boolean doNotCache()
	{
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).checkDoNotCache();
	}

	@Override
	public boolean complete()
	{
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).checkRefreshComplete();
	}

	@Override
	public boolean clearCache()
	{
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).checkClearCache();
	}

	@Override
	public boolean privateStream()
	{
		return ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).checkPrivateStream();
	}
	...
	{
		((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).applyHasQos();
		Utilities.toRsslQos(rate, timeliness, ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).qos());
	...
	{
		if (CodecReturnCodes.SUCCESS != ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).state().streamState(streamState) ||
				CodecReturnCodes.SUCCESS != ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).state().dataState(dataState) || 
				CodecReturnCodes.SUCCESS != ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).state().code(statusCode) || 
				CodecReturnCodes.SUCCESS != ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).state().text().data(statusText))
		{
	...
	public RefreshMsg itemGroup(ByteBuffer itemGroup)
	{
		...
		Utilities.copy(itemGroup, ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).groupId());
		return this;
	}
	...
	{
		if (solicited)
			((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).applySolicited();
	...
	{
		if (doNotCache)
			((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).applyDoNotCache();
	...
	{
		if (clearCache)
			((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).applyClearCache();
	...
	{
		if (complete)
			((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).applyRefreshComplete();
	...
	{
		if (privateStream)
			((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).applyPrivateStream();
	...
	com.rtsdk.eta.codec.RefreshMsg rsslMsg()
	{
		return ((_rsslEncodeIter != null) ? (com.rtsdk.eta.codec.RefreshMsg)(_rsslMsg) : null);
	}
	...
	{
		 ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).state().streamState(com.rtsdk.eta.codec.StreamStates.OPEN);
		 ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).state().dataState(com.rtsdk.eta.codec.DataStates.OK);
		 ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).state().code(com.rtsdk.eta.codec.StateCodes.NONE);

		 ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).groupId().data( ByteBuffer.wrap(defaultGroupId));
	}
}
