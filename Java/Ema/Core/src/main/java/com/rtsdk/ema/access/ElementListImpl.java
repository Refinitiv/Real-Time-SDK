...
{
	private com.rtsdk.eta.codec.ElementList _rsslElementList = com.rtsdk.eta.codec.CodecFactory
			.createElementList();
		...
		if (_rsslEncodeIter != null)
		{
			...
			if (collectionSize > 0)
			{
				...
				for (int index = 0; index < collectionSize; ++index)
				{
					...
					elementEntryImpl._previousEncodingType = com.rtsdk.eta.codec.DataTypes.UNKNOWN;
				}
				GlobalPool.unlock();
			...
			com.rtsdk.eta.codec.DataDictionary rsslDictionary, Object localElSeDefDb)
	{
		...
		_rsslLocalELSetDefDb = (com.rtsdk.eta.codec.LocalElementSetDefDb) localElSeDefDb;
	...
	void fillCollection()
	{
		...
		while ((retCode = elementEntry._rsslElementEntry
				.decode(_rsslDecodeIter)) != com.rtsdk.eta.codec.CodecReturnCodes.END_OF_CONTAINER)
		{
			switch (retCode)
			{
			case com.rtsdk.eta.codec.CodecReturnCodes.SUCCESS:
	...
	Buffer encodedData()
	{
		...
		for (com.rtsdk.ema.access.ElementEntry elementEntry : _elementListCollection)
		{
	...
	int elementEntryEncode(com.rtsdk.eta.codec.ElementEntry rsslElementEntry, Object cacheEntryData)
	{
		int ret;
		...
		case com.rtsdk.eta.codec.DataTypes.INT:
			while ((ret = rsslElementEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Int) cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			{
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			}
			return ret;
		case com.rtsdk.eta.codec.DataTypes.UINT:
			while ((ret = rsslElementEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.UInt) cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			{
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			}
			return ret;
		case com.rtsdk.eta.codec.DataTypes.REAL:
			while ((ret = rsslElementEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Real) cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			{
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			}
			return ret;
		case com.rtsdk.eta.codec.DataTypes.DOUBLE:
			while ((ret = rsslElementEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Double) cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			{
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			}
			return ret;
		case com.rtsdk.eta.codec.DataTypes.FLOAT:
			while ((ret = rsslElementEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Float) cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			{
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			}
			return ret;
		case com.rtsdk.eta.codec.DataTypes.DATETIME:
			while ((ret = rsslElementEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.DateTime) cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			{
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			}
			return ret;
		case com.rtsdk.eta.codec.DataTypes.DATE:
			while ((ret = rsslElementEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Date) cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			{
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			}
			return ret;
		case com.rtsdk.eta.codec.DataTypes.TIME:
			while ((ret = rsslElementEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Time) cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			{
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			}
			return ret;
		case com.rtsdk.eta.codec.DataTypes.QOS:
			while ((ret = rsslElementEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Qos) cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			{
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			}
			return ret;
		case com.rtsdk.eta.codec.DataTypes.STATE:
			while ((ret = rsslElementEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.State) cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			{
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			}
			return ret;
		case com.rtsdk.eta.codec.DataTypes.ENUM:
			while ((ret = rsslElementEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Enum) cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			{
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			}
			return ret;
		...
		case com.rtsdk.eta.codec.DataTypes.RMTES_STRING:
			while ((ret = rsslElementEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Buffer) cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			{
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			}
			return ret;
	...
	private ElementEntryImpl elementEntryInstance()
	{
        ...
        if(retData == null)
        {
        	retData = new ElementEntryImpl(com.rtsdk.eta.codec.CodecFactory.createElementEntry(), noDataInstance());
