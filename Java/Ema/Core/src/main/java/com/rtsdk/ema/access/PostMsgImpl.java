...
class PostMsgImpl extends MsgImpl implements PostMsg
{
	...
	{
		return ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).checkHasSeqNum();
	}

	@Override
	public boolean hasPostId()
	{
		return ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).checkHasPostId();
	}

	@Override
	public boolean hasPartNum()
	{
		return ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).checkHasPartNum();
	}

	@Override
	public boolean hasPostUserRights()
	{
		return ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).checkHasPostUserRights();
	}

	@Override
	public boolean hasPermissionData()
	{
		return ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).checkHasPermData();
	}
	...
	public long seqNum()
	{
		...
		return ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).seqNum();
	}
	...
	public long postId()
	{
		...
		return ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).postId();
	}
	...
	public int partNum()
	{
		...
		return ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).partNum();
	}
	...
	public int postUserRights()
	{
		...
		return ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).postUserRights();
	}
	...
	public ByteBuffer permissionData()
	{
		...
		_permissionData = Utilities.copyFromPool( ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).permData(), _permissionData, _objManager);
	...
	{
		return ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).postUserInfo().userId();
	}

	@Override
	public long publisherIdUserAddress()
	{
		return ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).postUserInfo().userAddr();
	}

	@Override
	public boolean solicitAck()
	{
		return ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).checkAck();
	}

	@Override
	public boolean complete()
	{
		return ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).checkPostComplete();
	}
	...
	public PostMsg postId(long postId)
	{
		...
		((com.rtsdk.eta.codec.PostMsg)_rsslMsg).applyHasPostId();
		((com.rtsdk.eta.codec.PostMsg)_rsslMsg).postId(postId);
	...
	public PostMsg postUserRights(int postUserRights)
	{
		...
		((com.rtsdk.eta.codec.PostMsg)_rsslMsg).applyHasPostUserRights();
		((com.rtsdk.eta.codec.PostMsg)_rsslMsg).postUserRights(postUserRights);
	...
	{
		if (ack)
			((com.rtsdk.eta.codec.PostMsg)_rsslMsg).applyAck();
	...
	{
		if (complete)
			((com.rtsdk.eta.codec.PostMsg)_rsslMsg).applyPostComplete();
	...
	com.rtsdk.eta.codec.PostMsg rsslMsg()
	{
		return ((_rsslEncodeIter != null) ? (com.rtsdk.eta.codec.PostMsg)(_rsslMsg) : null);
	}
}
