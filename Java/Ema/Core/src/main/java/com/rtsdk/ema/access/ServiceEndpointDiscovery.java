 ...
 * (see {@link com.rtsdk.ema.access.EmaFactory#createServiceEndpointDiscovery()}
 *  or {@link com.rtsdk.ema.access.EmaFactory#createServiceEndpointDiscovery(String, String)}).</p>
 *
