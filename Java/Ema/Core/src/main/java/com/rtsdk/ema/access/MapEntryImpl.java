...
class MapEntryImpl extends EntryImpl implements MapEntry
{
	...
	protected com.rtsdk.eta.codec.MapEntry	_rsslMapEntry;
	...
	MapEntryImpl(com.rtsdk.eta.codec.MapEntry rsslMapEntry, DataImpl mapEntryKey, DataImpl load, EmaObjectManager objManager)
	{
		super(load);
	...
	public MapEntry keyInt(long key, int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		((com.rtsdk.eta.codec.Int) _keyData).value(key);

		entryValue(action, value, permissionData);

		_keyDataType = com.rtsdk.eta.codec.DataTypes.INT;
	...
	public MapEntry keyUInt(long key, int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		((com.rtsdk.eta.codec.UInt) _keyData).value(key);

		entryValue(action, value, permissionData);

		_keyDataType = com.rtsdk.eta.codec.DataTypes.UINT;
	...
	public MapEntry keyReal(long mantissa, int magnitudeType, int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		int ret;
		if (CodecReturnCodes.SUCCESS != (ret = ((com.rtsdk.eta.codec.Real)_keyData).value(mantissa, magnitudeType)) )
		{
		...
		_keyDataType = com.rtsdk.eta.codec.DataTypes.REAL;
	...
	public MapEntry keyReal(double key, int magnitudeType, int action, ComplexType value, ByteBuffer permissionData)
	{
		_keyData = CodecFactory.createReal();
		int ret;
		if (CodecReturnCodes.SUCCESS != (ret = ((com.rtsdk.eta.codec.Real)_keyData).value(key, magnitudeType)) )
		{
			String errText = errorString().append("Attempt to specify invalid real value. Passed in value is='" )
										.append( key ).append( " / " )
										.append( magnitudeType ).append( "'." ).toString();
	...
	public MapEntry keyFloat(float key, int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		((com.rtsdk.eta.codec.Float) _keyData).value(key);

		entryValue(action, value, permissionData);

		_keyDataType = com.rtsdk.eta.codec.DataTypes.FLOAT;
	...
	public MapEntry keyDouble(double key, int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		((com.rtsdk.eta.codec.Double) _keyData).value(key);

		entryValue(action, value, permissionData);

		_keyDataType = com.rtsdk.eta.codec.DataTypes.DOUBLE;
	...
	public MapEntry keyDate(int year, int month, int day, int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		_keyDataType = com.rtsdk.eta.codec.DataTypes.DATE;
			...
			int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		_keyDataType = com.rtsdk.eta.codec.DataTypes.TIME;
			...
			int microsecond, int nanosecond, int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		_keyDataType = com.rtsdk.eta.codec.DataTypes.DATETIME;
	...
	public MapEntry keyQos(int timeliness, int rate, int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		Utilities.toRsslQos(rate, timeliness, (com.rtsdk.eta.codec.Qos) _keyData);

		entryValue(action, value, permissionData);

		_keyDataType = com.rtsdk.eta.codec.DataTypes.QOS;
			...
			ComplexType value, ByteBuffer permissionData)
	{
		...
		if (CodecReturnCodes.SUCCESS != ((com.rtsdk.eta.codec.State)_keyData).streamState(streamState) ||
				CodecReturnCodes.SUCCESS != ((com.rtsdk.eta.codec.State)_keyData).dataState(dataState) ||
				CodecReturnCodes.SUCCESS != ((com.rtsdk.eta.codec.State)_keyData).code(statusCode) || statusText == null ||
				CodecReturnCodes.SUCCESS != bufferText.data(statusText) ||  CodecReturnCodes.SUCCESS != ((com.rtsdk.eta.codec.State)_keyData).text(bufferText) )
		{
		...
		_keyDataType = com.rtsdk.eta.codec.DataTypes.STATE;
	...
	public MapEntry keyEnum(int key, int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		int ret;
		if (CodecReturnCodes.SUCCESS != (ret =((com.rtsdk.eta.codec.Enum)_keyData).value(key)) )
		{
		...
		_keyDataType = com.rtsdk.eta.codec.DataTypes.ENUM;
	...
	public MapEntry keyBuffer(ByteBuffer key, int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		_keyDataType = com.rtsdk.eta.codec.DataTypes.BUFFER;
	...
	public MapEntry keyAscii(String key, int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		_keyDataType = com.rtsdk.eta.codec.DataTypes.ASCII_STRING;
	...
	public MapEntry keyUtf8(ByteBuffer key, int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		_keyDataType = com.rtsdk.eta.codec.DataTypes.UTF8_STRING;
	...
	public MapEntry keyRmtes(ByteBuffer key, int action, ComplexType value, ByteBuffer permissionData)
	{
		...
		_keyDataType = com.rtsdk.eta.codec.DataTypes.RMTES_STRING;
