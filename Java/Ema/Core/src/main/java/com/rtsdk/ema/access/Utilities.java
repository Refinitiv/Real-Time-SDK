...
class Utilities
{
	...
	static int toRsslDataType(int dType)
	{
		...
		case DataTypes.GENERIC_MSG:
			return com.rtsdk.eta.codec.DataTypes.MSG;
		case DataTypes.FIELD_LIST:
			return com.rtsdk.eta.codec.DataTypes.FIELD_LIST;
		case DataTypes.ELEMENT_LIST:
			return com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST;
		case DataTypes.MAP:
			return com.rtsdk.eta.codec.DataTypes.MAP;
		case DataTypes.VECTOR:
			return com.rtsdk.eta.codec.DataTypes.VECTOR;
		case DataTypes.SERIES:
			return com.rtsdk.eta.codec.DataTypes.SERIES;
		case DataTypes.FILTER_LIST:
			return com.rtsdk.eta.codec.DataTypes.FILTER_LIST;
		case DataTypes.OPAQUE:
			return com.rtsdk.eta.codec.DataTypes.OPAQUE;
		case DataTypes.XML:
			return com.rtsdk.eta.codec.DataTypes.XML;
		case DataTypes.ANSI_PAGE:
			return com.rtsdk.eta.codec.DataTypes.ANSI_PAGE;
		case DataTypes.ARRAY:
			return com.rtsdk.eta.codec.DataTypes.ARRAY;
		case DataTypes.INT:
			return com.rtsdk.eta.codec.DataTypes.INT;
		case DataTypes.UINT:
			return com.rtsdk.eta.codec.DataTypes.UINT;
		case DataTypes.REAL:
			return com.rtsdk.eta.codec.DataTypes.REAL;
		case DataTypes.FLOAT:
			return com.rtsdk.eta.codec.DataTypes.FLOAT;
		case DataTypes.DOUBLE:
			return com.rtsdk.eta.codec.DataTypes.DOUBLE;
		case DataTypes.DATE:
			return com.rtsdk.eta.codec.DataTypes.DATE;
		case DataTypes.TIME:
			return com.rtsdk.eta.codec.DataTypes.TIME;
		case DataTypes.DATETIME:
			return com.rtsdk.eta.codec.DataTypes.DATETIME;
		case DataTypes.QOS:
			return com.rtsdk.eta.codec.DataTypes.QOS;
		case DataTypes.STATE:
			return com.rtsdk.eta.codec.DataTypes.STATE;
		case DataTypes.ENUM:
			return com.rtsdk.eta.codec.DataTypes.ENUM;
		case DataTypes.BUFFER:
			return com.rtsdk.eta.codec.DataTypes.BUFFER;
		case DataTypes.ASCII:
			return com.rtsdk.eta.codec.DataTypes.ASCII_STRING;
		case DataTypes.UTF8:
			return com.rtsdk.eta.codec.DataTypes.UTF8_STRING;
		case DataTypes.RMTES:
			return com.rtsdk.eta.codec.DataTypes.RMTES_STRING;
		case DataTypes.NO_DATA:
			return com.rtsdk.eta.codec.DataTypes.NO_DATA;
		default:
			return com.rtsdk.eta.codec.DataTypes.NO_DATA;
		}
	}
	...
	static Buffer realignBuffer(com.rtsdk.eta.codec.EncodeIterator eIter, int newLength)
	{
	...
	static void reallocate(com.rtsdk.eta.codec.EncodeIterator encodeIter, int newLength)
	{
		...
		encodeIter.setBufferAndRWFVersion(bigBuffer, com.rtsdk.eta.codec.Codec.majorVersion(), 
				com.rtsdk.eta.codec.Codec.minorVersion());
	}
