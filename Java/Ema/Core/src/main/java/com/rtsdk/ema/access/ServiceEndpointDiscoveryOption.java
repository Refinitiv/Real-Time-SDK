...
/**
 * ServiceEndpointDiscoveryOption is used to specify query options for {@link com.rtsdk.ema.access.ServiceEndpointDiscovery#registerClient(ServiceEndpointDiscoveryOption, ServiceEndpointDiscoveryClient, Object)}
 *
