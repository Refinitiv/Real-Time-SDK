...
{
	private com.rtsdk.eta.codec.FieldList	_rsslFieldList = com.rtsdk.eta.codec.CodecFactory.createFieldList();
		...
		if (_rsslEncodeIter != null)
		{
			...
			if (collectionSize > 0)
			{
				...
				for (int index = 0; index < collectionSize; ++index)
				{
					...
					fieldEntryImpl._previousEncodingType = com.rtsdk.eta.codec.DataTypes.UNKNOWN;
				}
				GlobalPool.unlock();
	...
	void decode(com.rtsdk.eta.codec.Buffer rsslBuffer, int majVer, int minVer,
				com.rtsdk.eta.codec.DataDictionary rsslDictionary, Object localFlSetDefDb)
	{
		...
		_rsslLocalFLSetDefDb = (com.rtsdk.eta.codec.LocalFieldSetDefDb)localFlSetDefDb;
		...
		case com.rtsdk.eta.codec.CodecReturnCodes.INCOMPLETE_DATA :
			...
			break;
		case com.rtsdk.eta.codec.CodecReturnCodes.SET_SKIPPED :
	...
	{
		DataImpl load;
		com.rtsdk.eta.codec.DictionaryEntry rsslDictionaryEntry = null;
		...
		int retCode;
		while ((retCode  = fieldEntry._rsslFieldEntry.decode(_rsslDecodeIter)) != com.rtsdk.eta.codec.CodecReturnCodes.END_OF_CONTAINER)
		{
			switch(retCode)
			{
			case com.rtsdk.eta.codec.CodecReturnCodes.SUCCESS :
	...
	Buffer encodedData() 
	{
		...
		for (com.rtsdk.ema.access.FieldEntry fieldEntry  : _fieldListCollection)
		{
	...
	private int fieldEntryEncode(com.rtsdk.eta.codec.FieldEntry rsslFieldEntry, Object cacheEntryData)
	{
		int ret;
		...
		case com.rtsdk.eta.codec.DataTypes.INT:
			 while ((ret =  rsslFieldEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Int)cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.UINT:
			 while ((ret =  rsslFieldEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.UInt)cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.REAL:
			 while ((ret =  rsslFieldEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Real)cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.DOUBLE:
			 while ((ret =  rsslFieldEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Double)cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.FLOAT:
			 while ((ret =  rsslFieldEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Float)cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.DATETIME:
			 while ((ret =  rsslFieldEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.DateTime)cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.DATE:
			 while ((ret =  rsslFieldEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Date)cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.TIME:
			 while ((ret =  rsslFieldEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Time)cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.QOS:
			 while ((ret =  rsslFieldEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Qos)cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.STATE:
			 while ((ret =  rsslFieldEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.State)cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.ENUM:
			 while ((ret =  rsslFieldEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Enum)cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		...
		case com.rtsdk.eta.codec.DataTypes.RMTES_STRING:
			 while ((ret =  rsslFieldEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Buffer)cacheEntryData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
	...
	private FieldEntryImpl fieldEntryInstance()
	{
        ...
        if(retData == null)
        {
        	retData = new FieldEntryImpl(com.rtsdk.eta.codec.CodecFactory.createFieldEntry(), noDataInstance());
