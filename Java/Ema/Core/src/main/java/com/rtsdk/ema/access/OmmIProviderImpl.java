...
import com.rtsdk.ema.access.ServiceIdConverter.ServiceIdConversionError;
	...
	public void submit(RefreshMsg refreshMsg, long handle)
	{
		...
		else if (refreshMsgImpl.domainType() == EmaRdm.MMT_DICTIONARY)
		{
			...
			ServiceIdConversionError encodingError = 
					_serviceIdConverter.encodeServiceId(refreshMsgImpl, com.rtsdk.eta.codec.RefreshMsgFlags.HAS_MSG_KEY);
