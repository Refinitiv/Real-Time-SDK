...
import com.rtsdk.eta.codec.UpdateMsgFlags;
...
class MsgImpl extends DataImpl implements Msg
{
	...
	protected com.rtsdk.eta.codec.Msg _rsslMsg; 
	protected com.rtsdk.eta.codec.Msg _rsslNestedMsg = CodecFactory.createMsg();
	...
	protected com.rtsdk.eta.codec.Buffer _copiedBuffer = CodecFactory.createBuffer();
	...
	MsgImpl(int dataType, EmaObjectManager objManager)
	{
		...
		if (objManager == null)
		{
			...
			_rsslMsg.containerType(com.rtsdk.eta.codec.DataTypes.NO_DATA);
	...
	public String name()
	{
		...
		com.rtsdk.eta.codec.Buffer nameBuffer = _rsslMsg.msgKey().name();
	...
	{
		com.rtsdk.eta.codec.MsgKey msgKey = _rsslMsg.msgKey();
		int dType;
		if (msgKey != null)
		{
			int rsslDType =  msgKey.checkHasAttrib() ? msgKey.attribContainerType()
							: com.rtsdk.eta.codec.DataTypes.NO_DATA;
	...
	boolean hasPayload()
	{
		return ((_rsslMsg.containerType() != com.rtsdk.eta.codec.DataTypes.NO_DATA) ? true : false);
	}
	...
	void msgServiceName(String serviceName)
	{
		...
		{
		case DataTypes.REFRESH_MSG:
			((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).applyHasMsgKey();
			break;
		case DataTypes.UPDATE_MSG:
			((com.rtsdk.eta.codec.UpdateMsg)_rsslMsg).applyHasMsgKey();
			break;
		case DataTypes.STATUS_MSG:
			((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).applyHasMsgKey();
			break;
		case DataTypes.REQ_MSG:
			break;
		case DataTypes.GENERIC_MSG:
			((com.rtsdk.eta.codec.GenericMsg)_rsslMsg).applyHasMsgKey();
			break;
		case DataTypes.POST_MSG:
			((com.rtsdk.eta.codec.PostMsg)_rsslMsg).applyHasMsgKey();
			break;
		case DataTypes.ACK_MSG:
			((com.rtsdk.eta.codec.AckMsg)_rsslMsg).applyHasMsgKey();
			break;
		default:
   ...
   void  msgSeqNum(long seqNum)
   {
       ...
       {
	       case DataTypes.POST_MSG :
	   		((com.rtsdk.eta.codec.PostMsg)_rsslMsg).applyHasSeqNum();
	   		((com.rtsdk.eta.codec.PostMsg)_rsslMsg).seqNum(seqNum);
	          break;
           case DataTypes.REFRESH_MSG :
        		((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).applyHasSeqNum();
        		((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).seqNum(seqNum);
               break;
           case DataTypes.GENERIC_MSG :
               ((com.rtsdk.eta.codec.GenericMsg)_rsslMsg).applyHasSeqNum();
       			((com.rtsdk.eta.codec.GenericMsg)_rsslMsg).seqNum(seqNum);
               break;
           case DataTypes.UPDATE_MSG :
       		((com.rtsdk.eta.codec.UpdateMsg)_rsslMsg).applyHasSeqNum();
       		((com.rtsdk.eta.codec.UpdateMsg)_rsslMsg).seqNum(seqNum);
              break;  
           case DataTypes.ACK_MSG :
        		((com.rtsdk.eta.codec.AckMsg)_rsslMsg).applyHasSeqNum();
        		((com.rtsdk.eta.codec.AckMsg)_rsslMsg).seqNum(seqNum);
               break;
           case DataTypes.STATUS_MSG :
           case DataTypes.REQ_MSG :
           default :
   ...
   void  msgPartNum(int partNum)
   {
       ...
       {
           case DataTypes.REFRESH_MSG :
        		((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).applyHasPartNum();
        		((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).partNum(partNum);
               break;
           case DataTypes.GENERIC_MSG :
               ((com.rtsdk.eta.codec.GenericMsg)_rsslMsg).applyHasPartNum();
       			((com.rtsdk.eta.codec.GenericMsg)_rsslMsg).partNum(partNum);
               break;
           case DataTypes.POST_MSG :
        		((com.rtsdk.eta.codec.PostMsg)_rsslMsg).applyHasPartNum();
        		((com.rtsdk.eta.codec.PostMsg)_rsslMsg).partNum(partNum);
               break;
           case DataTypes.UPDATE_MSG :
           case DataTypes.STATUS_MSG :
           case DataTypes.ACK_MSG :
   ...
   void  msgPublisherId(long userId, long userAddress)
   {
       ...
       {
       	   case DataTypes.POST_MSG :
       		((com.rtsdk.eta.codec.PostMsg)_rsslMsg).postUserInfo().userId(userId);
    		((com.rtsdk.eta.codec.PostMsg)_rsslMsg).postUserInfo().userAddr(userAddress);
       		   break;
	       case DataTypes.UPDATE_MSG :
	   		((com.rtsdk.eta.codec.UpdateMsg)_rsslMsg).applyHasPostUserInfo();
	   		((com.rtsdk.eta.codec.UpdateMsg)_rsslMsg).postUserInfo().userId(userId);
	   		((com.rtsdk.eta.codec.UpdateMsg)_rsslMsg).postUserInfo().userAddr(userAddress);
	          break;
           case DataTypes.REFRESH_MSG :
        		((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).applyHasPostUserInfo();
        		((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).postUserInfo().userId(userId);
        		((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).postUserInfo().userAddr(userAddress);
               break;
           case DataTypes.STATUS_MSG :
               ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).applyHasPostUserInfo();
       			((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).postUserInfo().userId(userId);
       			((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).postUserInfo().userAddr(userAddress);
               break;
           case DataTypes.GENERIC_MSG :
           case DataTypes.ACK_MSG :
           case DataTypes.REQ_MSG :
   ...
   void  msgPermissionData(ByteBuffer permissionData)
   {
       ...
       {
       	   case DataTypes.POST_MSG :
       		((com.rtsdk.eta.codec.PostMsg)_rsslMsg).applyHasPermData();
       		Utilities.copy(permissionData, ((com.rtsdk.eta.codec.PostMsg)_rsslMsg).permData());
       		   break;
	       case DataTypes.UPDATE_MSG :
	    		((com.rtsdk.eta.codec.UpdateMsg)_rsslMsg).applyHasPermData();
	    		Utilities.copy(permissionData, ((com.rtsdk.eta.codec.UpdateMsg)_rsslMsg).permData());
	          break;
           case DataTypes.REFRESH_MSG :
        		((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).applyHasPermData();
        		Utilities.copy(permissionData, ((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).permData());
               break;
           case DataTypes.STATUS_MSG :
        		((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).applyHasPermData();
        		Utilities.copy(permissionData, ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).permData());
               break;
           case DataTypes.GENERIC_MSG :
        		((com.rtsdk.eta.codec.GenericMsg)_rsslMsg).applyHasPermData();
        		Utilities.copy(permissionData, ((com.rtsdk.eta.codec.GenericMsg)_rsslMsg).permData());
        		break;
           case DataTypes.ACK_MSG :
           case DataTypes.REQ_MSG :
           default :
	...
	void msgExtendedHeader(ByteBuffer buffer)
	{
        ...
        {
            case DataTypes.UPDATE_MSG :
            	((com.rtsdk.eta.codec.UpdateMsg)_rsslMsg).applyHasExtendedHdr();
                break;
            case DataTypes.REFRESH_MSG :
            	((com.rtsdk.eta.codec.RefreshMsg)_rsslMsg).applyHasExtendedHdr();
                break;
            case DataTypes.STATUS_MSG :
            	((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).applyHasExtendedHdr();
                break;
            case DataTypes.GENERIC_MSG :
            	((com.rtsdk.eta.codec.GenericMsg)_rsslMsg).applyHasExtendedHdr();
                break;
            case DataTypes.REQ_MSG :
            	((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).applyHasExtendedHdr();
                break;
            case DataTypes.POST_MSG :
            	((com.rtsdk.eta.codec.PostMsg)_rsslMsg).applyHasExtendedHdr();
                break;
            case DataTypes.ACK_MSG :
            	((com.rtsdk.eta.codec.AckMsg)_rsslMsg).applyHasExtendedHdr();
                break;
    		default:
    			return;
        }        
	...
	void cloneBufferToMsg(MsgImpl destMsg, MsgImpl other, String functionName)
	{
		...
		else
		{
			...
			{
				com.rtsdk.eta.codec.StatusMsg statusMsg = (com.rtsdk.eta.codec.StatusMsg)other._rsslMsg;
				com.rtsdk.eta.codec.StatusMsg encodeStatusMsg = (com.rtsdk.eta.codec.StatusMsg)CodecFactory.createMsg();
				com.rtsdk.eta.codec.EncodeIterator encIter = CodecFactory.createEncodeIterator();
	...
	com.rtsdk.eta.codec.Msg rsslMsg()
	{
		return _rsslMsg;
	}
}
