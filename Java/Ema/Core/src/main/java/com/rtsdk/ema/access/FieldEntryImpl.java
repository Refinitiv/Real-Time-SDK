...
{
	private com.rtsdk.eta.codec.DictionaryEntry _rsslDictionaryEntry;
	private FieldListImpl _fieldList;
	private com.rtsdk.eta.codec.Enum		_rsslEnumValue;
	protected com.rtsdk.eta.codec.FieldEntry	_rsslFieldEntry;
	...
	FieldEntryImpl(com.rtsdk.eta.codec.FieldEntry rsslFieldEntry, DataImpl load)
	{
		super(load);
		_rsslFieldEntry = rsslFieldEntry;
		_rsslEnumValue = com.rtsdk.eta.codec.CodecFactory.createEnum();
	}
	...
	public int rippleTo(int fieldId)
	{
		...
		com.rtsdk.eta.codec.DictionaryEntry rsslDictEntry = (_fieldList != null) && (_fieldList._rsslDictionary != null) ?
	...
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.MSG, (DataImpl) value);
	}
	...
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.FIELD_LIST, (DataImpl) value);
	}

	@Override
	public FieldEntry elementList(int fieldId, ElementList value)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST, (DataImpl) value);
	}

	@Override
	public FieldEntry map(int fieldId, Map value)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.MAP, (DataImpl) value);
	}

	@Override
	public FieldEntry vector(int fieldId, Vector value)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.VECTOR, (DataImpl) value);
	}

	@Override
	public FieldEntry series(int fieldId, Series value)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.SERIES, (DataImpl) value);
	}

	@Override
	public FieldEntry filterList(int fieldId, FilterList value)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.FILTER_LIST, (DataImpl) value);
	}

	@Override
	public FieldEntry opaque(int fieldId, OmmOpaque value)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.OPAQUE, (DataImpl) value);
	}

	@Override
	public FieldEntry xml(int fieldId, OmmXml value)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.XML, (DataImpl) value);
	}

	@Override
	public FieldEntry ansiPage(int fieldId, OmmAnsiPage value)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.ANSI_PAGE, (DataImpl) value);
	}

	@Override
	public FieldEntry intValue(int fieldId, long value)
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.INT);

		if ( _previousEncodingType != com.rtsdk.eta.codec.DataTypes.INT )
		{
			GlobalPool.lock();
			...
			_previousEncodingType = com.rtsdk.eta.codec.DataTypes.INT;
		}
		
		((com.rtsdk.eta.codec.Int) _entryData).value(value);
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.UINT);

		if ( _previousEncodingType != com.rtsdk.eta.codec.DataTypes.UINT )
		{
			GlobalPool.lock();
			GlobalPool.returnPool(_previousEncodingType, _entryData);
			...
			_previousEncodingType = com.rtsdk.eta.codec.DataTypes.UINT;
		}
		
		((com.rtsdk.eta.codec.UInt) _entryData).value(value);
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.REAL);

		if ( _previousEncodingType != com.rtsdk.eta.codec.DataTypes.REAL )
		{
			GlobalPool.lock();
			GlobalPool.returnPool(_previousEncodingType, _entryData);
			...
			_previousEncodingType = com.rtsdk.eta.codec.DataTypes.REAL;
		}
		
		int ret;
		if (CodecReturnCodes.SUCCESS != (ret = ((com.rtsdk.eta.codec.Real)_entryData).value(mantissa, magnitudeType)) )
		{
	...
	public FieldEntry realFromDouble(int fieldId, double value, int magnitudeType)
	{
		...
		int ret;
		if (CodecReturnCodes.SUCCESS != (ret = ((com.rtsdk.eta.codec.Real)_entryData).value(value, magnitudeType)) )
		{
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.FLOAT);

		if ( _previousEncodingType != com.rtsdk.eta.codec.DataTypes.FLOAT )
		{
			GlobalPool.lock();
			GlobalPool.returnPool(_previousEncodingType, _entryData);
			...
			_previousEncodingType = com.rtsdk.eta.codec.DataTypes.FLOAT;
		}
			
		((com.rtsdk.eta.codec.Float)_entryData).value(value);
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.DOUBLE);

		if ( _previousEncodingType != com.rtsdk.eta.codec.DataTypes.DOUBLE )
		{
			GlobalPool.lock();
			GlobalPool.returnPool(_previousEncodingType, _entryData);
			...
			_previousEncodingType = com.rtsdk.eta.codec.DataTypes.DOUBLE;
		}
		
		((com.rtsdk.eta.codec.Double)_entryData).value(value);
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.DATE);
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.TIME);
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.DATETIME);
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.QOS);

		if ( _previousEncodingType != com.rtsdk.eta.codec.DataTypes.QOS )
		{
			GlobalPool.lock();
			GlobalPool.returnPool(_previousEncodingType, _entryData);
			...
			_previousEncodingType = com.rtsdk.eta.codec.DataTypes.QOS;
		}
		
		Utilities.toRsslQos(rate, timeliness, (com.rtsdk.eta.codec.Qos)_entryData);
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.STATE);
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.ENUM);

		if ( _previousEncodingType != com.rtsdk.eta.codec.DataTypes.ENUM )
		{
			GlobalPool.lock();
			GlobalPool.returnPool(_previousEncodingType, _entryData);
			...
			_previousEncodingType = com.rtsdk.eta.codec.DataTypes.ENUM; 
		}
		
		int ret;
		if (CodecReturnCodes.SUCCESS != (ret = ((com.rtsdk.eta.codec.Enum)_entryData).value(value)) )
		{
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.BUFFER);

		if (value == null)
			throw ommIUExcept().message("Passed in value is null", OmmInvalidUsageException.ErrorCode.INVALID_ARGUMENT);
		
		if ( _previousEncodingType != com.rtsdk.eta.codec.DataTypes.BUFFER )
		{
			GlobalPool.lock();
			GlobalPool.returnPool(_previousEncodingType, _entryData);
			...
			_previousEncodingType = com.rtsdk.eta.codec.DataTypes.BUFFER;
		}
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.ASCII_STRING);
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.UTF8_STRING);
	...
	{
		entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.RMTES_STRING);
	...
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.ARRAY, (DataImpl) value);
	}

	@Override
	public FieldEntry codeInt(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.INT);
	}

	@Override
	public FieldEntry codeUInt(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.UINT);
	}

	@Override
	public FieldEntry codeReal(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.REAL);
	}

	@Override
	public FieldEntry codeFloat(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.FLOAT);
	}

	@Override
	public FieldEntry codeDouble(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.DOUBLE);
	}

	@Override
	public FieldEntry codeDate(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.DATE);
	}

	@Override
	public FieldEntry codeTime(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.TIME);
	}

	@Override
	public FieldEntry codeDateTime(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.DATETIME);
	}

	@Override
	public FieldEntry codeQos(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.QOS);
	}

	@Override
	public FieldEntry codeState(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.STATE);
	}

	@Override
	public FieldEntry codeEnum(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.ENUM);
	}

	@Override
	public FieldEntry codeBuffer(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.BUFFER);
	}

	@Override
	public FieldEntry codeAscii(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.ASCII_STRING);
	}

	@Override
	public FieldEntry codeUtf8(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.UTF8_STRING);
	}

	@Override
	public FieldEntry codeRmtes(int fieldId)
	{
		return entryValue(fieldId, com.rtsdk.eta.codec.DataTypes.RMTES_STRING);
	}
	...
	public boolean hasEnumDisplay()
	{
		...
		{					
			if ( _rsslDictionaryEntry != null )
			{
				...
				com.rtsdk.eta.codec.EnumType enumType = _fieldList._rsslDictionary.entryEnumType( _rsslDictionaryEntry,
						_rsslEnumValue );
	...
	FieldEntryImpl entryValue(FieldListImpl fieldList, com.rtsdk.eta.codec.DictionaryEntry rsslDictionaryEntry, DataImpl load)
	{
		_load = load;
