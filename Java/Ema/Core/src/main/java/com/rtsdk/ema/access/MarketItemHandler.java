...
class MarketItemHandler implements DefaultMsgCallback
{
	...
	private com.rtsdk.eta.codec.Msg _rsslMsg = CodecFactory.createMsg();
	...
	public int defaultMsgCallback(ReactorMsgEvent msgEvent)
	{
		...
		com.rtsdk.eta.codec.Msg msg = msgEvent.msg();
	...
	void sendRejectMessage(ReactorChannel reactorChannel, com.rtsdk.eta.codec.Msg msg, int statusCode, String text)
	{
		ClientSession clientSession = (ClientSession)reactorChannel.userSpecObj();
		
		com.rtsdk.eta.codec.StatusMsg statusMsg = (StatusMsg)_rsslMsg;
		statusMsg.clear();
