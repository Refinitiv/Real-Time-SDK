...
class AckMsgImpl extends MsgImpl implements AckMsg
{
	...
	{
		return ((com.rtsdk.eta.codec.AckMsg) _rsslMsg).checkHasSeqNum();
	}

	@Override
	public boolean hasNackCode()
	{
		return ((com.rtsdk.eta.codec.AckMsg) _rsslMsg).checkHasNakCode();
	}

	@Override
	public boolean hasText()
	{
		return ((com.rtsdk.eta.codec.AckMsg) _rsslMsg).checkHasText();
	}
	...
	public long seqNum()
	{
		...
		return ((com.rtsdk.eta.codec.AckMsg) _rsslMsg).seqNum();
	}

	@Override
	public long ackId()
	{
		return ((com.rtsdk.eta.codec.AckMsg) _rsslMsg).ackId();
	}
	...
	public int nackCode()
	{
		...
		return ((com.rtsdk.eta.codec.AckMsg) _rsslMsg).nakCode();
	}
	...
	public String text()
	{
		...
		if (((com.rtsdk.eta.codec.AckMsg) _rsslMsg).text().length() == 0)
			_text = DataImpl.EMPTY_STRING;
		else
			_text = ((com.rtsdk.eta.codec.AckMsg) _rsslMsg).text().toString();
	...
	{
		return ((com.rtsdk.eta.codec.AckMsg) _rsslMsg).checkPrivateStream();
	}
	...
	public AckMsg ackId(long ackId)
	{
		...
		((com.rtsdk.eta.codec.AckMsg)_rsslMsg).ackId(ackId);
		return this;
	}
	...
	public AckMsg nackCode(int nackCode)
	{
		...
		((com.rtsdk.eta.codec.AckMsg)_rsslMsg).applyHasNakCode();
		((com.rtsdk.eta.codec.AckMsg)_rsslMsg).nakCode(nackCode);
		return this;
	}
	...
	public AckMsg text(String text)
	{
		...
		((com.rtsdk.eta.codec.AckMsg)_rsslMsg).applyHasText();
		((com.rtsdk.eta.codec.AckMsg)_rsslMsg).text().data(text);
	...
	{
		if (privateStream)
			((com.rtsdk.eta.codec.AckMsg)_rsslMsg).applyPrivateStream();
