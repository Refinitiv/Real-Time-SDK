 ...
 * (see {@link com.rtsdk.ema.access.EmaFactory#createOmmProvider(OmmProviderConfig)}
 *  or {@link com.rtsdk.ema.access.EmaFactory#createOmmProvider(OmmProviderConfig, OmmProviderErrorClient)}).</p>
 * 
 * 
