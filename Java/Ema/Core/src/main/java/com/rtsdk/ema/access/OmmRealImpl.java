...
class OmmRealImpl extends DataImpl implements OmmReal
{
	...
	private com.rtsdk.eta.codec.Real _rsslReal = com.rtsdk.eta.codec.CodecFactory.createReal();
	...
	void decode(com.rtsdk.eta.codec.Buffer rsslBuffer, com.rtsdk.eta.codec.DecodeIterator dIter)
	{
		...
		if (com.rtsdk.eta.codec.CodecReturnCodes.SUCCESS == _rsslReal.decode(dIter))
