...
class DataImpl extends VaNode implements Data
{
	...
	protected com.rtsdk.eta.codec.DecodeIterator 	_rsslDecodeIter = com.rtsdk.eta.codec.CodecFactory.createDecodeIterator();
	protected com.rtsdk.eta.codec.DecodeIterator 	_rsslNestedMsgDecodeIter;
	protected int 											_rsslMajVer = com.rtsdk.eta.codec.Codec.majorVersion();
	protected int 											_rsslMinVer = com.rtsdk.eta.codec.Codec.minorVersion();
	protected com.rtsdk.eta.codec.Buffer 			_rsslBuffer;
	...
	int dataType(int rsslType, int majVer, int minVer, com.rtsdk.eta.codec.Buffer rsslBuffer)
	{
		int dType;

		if (com.rtsdk.eta.codec.DataTypes.MSG == rsslType)
		{
			if (_rsslNestedMsgDecodeIter == null)
				_rsslNestedMsgDecodeIter = com.rtsdk.eta.codec.CodecFactory.createDecodeIterator();
			else
