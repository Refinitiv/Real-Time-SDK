...
class OmmStateImpl extends DataImpl implements OmmState
{
	...
	private com.rtsdk.eta.codec.State _rsslState = com.rtsdk.eta.codec.CodecFactory.createState();
	...
	public String toString()
	{
		...
		else
		{
			...
			_toString.append(com.rtsdk.eta.codec.StreamStates.info(_rsslState.streamState()))
			.append(" / ")
			.append(com.rtsdk.eta.codec.DataStates.info(_rsslState.dataState()))
			.append(" / ")
			.append(com.rtsdk.eta.codec.StateCodes.info(_rsslState.code()))
			.append(" / '")
			.append(statusText())
			.append("'");
	...
	void decode(com.rtsdk.eta.codec.Buffer rsslBuffer, com.rtsdk.eta.codec.DecodeIterator dIter)
	{
		...
		if (com.rtsdk.eta.codec.CodecReturnCodes.SUCCESS == _rsslState.decode(dIter))
	...
	void decode(com.rtsdk.eta.codec.State rsslState)
	{
		if (rsslState != null)
		{
			_dataCode = DataCode.NO_CODE;
		...
		else
		{
			...
			_rsslState.code(com.rtsdk.eta.codec.StateCodes.NONE);
			_rsslState.dataState(com.rtsdk.eta.codec.DataStates.OK);
			_rsslState.streamState(com.rtsdk.eta.codec.StreamStates.OPEN);
