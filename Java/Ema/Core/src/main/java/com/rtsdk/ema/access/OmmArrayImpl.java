...
{
	private com.rtsdk.eta.codec.Array	_rsslArray = com.rtsdk.eta.codec.CodecFactory.createArray();
		...
		if (_rsslEncodeIter != null)
		{
			...
			if (collectionSize > 0)
			{
				...
				for (int index = 0; index < collectionSize; ++index)
				{
					...
					arrayEntryImpl._previousEncodingType = com.rtsdk.eta.codec.DataTypes.UNKNOWN;
				}
				GlobalPool.unlock();
	...
	void decode(com.rtsdk.eta.codec.Buffer rsslBuffer, int majVer, int minVer,
				com.rtsdk.eta.codec.DataDictionary rsslDictionary, Object localElSeDefDb)
	{
		...
		switch (retCode)
		{
		case com.rtsdk.eta.codec.CodecReturnCodes.BLANK_DATA :
	...
	void fillCollection()
	{
		...
		int retCode;
		while ((retCode  = arrayEntry._rsslArrayEntry.decode(_rsslDecodeIter)) != com.rtsdk.eta.codec.CodecReturnCodes.END_OF_CONTAINER)
		{
			switch(retCode)
			{
			case com.rtsdk.eta.codec.CodecReturnCodes.SUCCESS :
	...
	Buffer encodedData()
	{
	   ...
	   OmmArrayEntryImpl firstEntry = (OmmArrayEntryImpl)_ommArrayCollection.get(0);
		...
		for (com.rtsdk.ema.access.OmmArrayEntry ommArrayEntry  : _ommArrayCollection)
		{
			...
			if (primitiveType != arrayEntry._entryDataType)
			{
				String errText = errorString().append("Attempt to add entry of ")
						.append(com.rtsdk.eta.codec.DataTypes.toString(arrayEntry._entryDataType))
						.append("while OmmArray contains=")
						.append(com.rtsdk.eta.codec.DataTypes.toString(primitiveType)).toString();
	...
	int arrayEntryEncode(int fixedItemLength, int dataType, ArrayEntry rsslArrayEntry, Object value)
	{
		...
		case com.rtsdk.eta.codec.DataTypes.UINT:
			long uintValue = ((com.rtsdk.eta.codec.UInt)value).toLong(); 
			...
			while ((ret = rsslArrayEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.UInt)value)) == CodecReturnCodes.BUFFER_TOO_SMALL)
		    {
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
		    }
			return ret;
		case com.rtsdk.eta.codec.DataTypes.INT:
			long intValue = ((com.rtsdk.eta.codec.Int)value).toLong(); 
			switch (fixedItemLength)
			{
			case 0 :
			case 8 :
			...
			while ((ret = rsslArrayEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Int)value)) == CodecReturnCodes.BUFFER_TOO_SMALL)
		    {
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
		    }
			return ret;
		case com.rtsdk.eta.codec.DataTypes.ENUM:
			int enumValue = ((com.rtsdk.eta.codec.Enum)value).toInt();
			switch (fixedItemLength)
			{
			case 0 :
				break;
			...
			while ((ret = rsslArrayEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Enum)value)) == CodecReturnCodes.BUFFER_TOO_SMALL)
		    {
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
		    }
			return ret;
		case com.rtsdk.eta.codec.DataTypes.REAL:
			...
			while ((ret = rsslArrayEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Real)value)) == CodecReturnCodes.BUFFER_TOO_SMALL)
		    {
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
		    }
			return ret;
		case com.rtsdk.eta.codec.DataTypes.FLOAT:
			...
			while ((ret = rsslArrayEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Float)value)) == CodecReturnCodes.BUFFER_TOO_SMALL)
		    {
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
		    }
			return ret;
		case com.rtsdk.eta.codec.DataTypes.DOUBLE:
			...
			while ((ret = rsslArrayEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Double)value)) == CodecReturnCodes.BUFFER_TOO_SMALL)
		    {
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
		    }
			return ret;
		case com.rtsdk.eta.codec.DataTypes.DATE:
			...
			while ((ret = rsslArrayEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Date)value)) == CodecReturnCodes.BUFFER_TOO_SMALL)
		    {
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
		    }
			return ret;
		case com.rtsdk.eta.codec.DataTypes.TIME:
			if ( fixedItemLength == 0 || fixedItemLength == 5 || (fixedItemLength == 3 && ((com.rtsdk.eta.codec.Time)value).millisecond() == 0)  )
			{
				while ((ret = rsslArrayEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Time)value)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
					_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
				return ret;
		...
		case com.rtsdk.eta.codec.DataTypes.DATETIME :
			if ( fixedItemLength == 0 || fixedItemLength == 9 || (fixedItemLength == 7 && ((com.rtsdk.eta.codec.DateTime)value).millisecond() == 0)  )
			{
				while ((ret = rsslArrayEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.DateTime)value)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
					_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
				return ret;
		...
		case com.rtsdk.eta.codec.DataTypes.QOS:
			...
			while ((ret = rsslArrayEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Qos)value)) == CodecReturnCodes.BUFFER_TOO_SMALL)
		    {
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
		    }
			return ret;
		case com.rtsdk.eta.codec.DataTypes.STATE:
			...
			while ((ret = rsslArrayEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.State)value)) == CodecReturnCodes.BUFFER_TOO_SMALL)
		    {
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
		    }
			return ret;
		...
		case com.rtsdk.eta.codec.DataTypes.RMTES_STRING:
			...
			while ((ret = rsslArrayEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Buffer)value)) == CodecReturnCodes.BUFFER_TOO_SMALL)
		    {
				_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
		    }
			return ret;
		default:
			{
				...
				.append( com.rtsdk.eta.codec.DataTypes.toString(dataType) ).append( "'. " ).toString();
				 throw ommIUExcept().message(errText, OmmInvalidUsageException.ErrorCode.INVALID_OPERATION);
			}
		}
	}
	...
	private OmmArrayEntryImpl ommArrayEntryInstance()
	{
        ...
        if(retData == null)
        {
        	retData = new OmmArrayEntryImpl(com.rtsdk.eta.codec.CodecFactory.createArrayEntry(), noDataInstance());
