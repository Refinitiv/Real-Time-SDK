...
{
	protected com.rtsdk.eta.codec.ElementEntry	_rsslElementEntry;
	...
	ElementEntryImpl(com.rtsdk.eta.codec.ElementEntry rsslElementEntry, DataImpl load)
	{
		super(load);
	...
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.MSG, (DataImpl) value);
	}
	...
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.FIELD_LIST, (DataImpl) value);
	}

	@Override
	public ElementEntry elementList(String name, ElementList value)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST, (DataImpl) value);
	}

	@Override
	public ElementEntry map(String name, Map value)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.MAP, (DataImpl) value);
	}

	@Override
	public ElementEntry vector(String name, Vector value)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.VECTOR, (DataImpl) value);
	}

	@Override
	public ElementEntry series(String name, Series value)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.SERIES, (DataImpl) value);
	}

	@Override
	public ElementEntry filterList(String name, FilterList value)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.FILTER_LIST, (DataImpl) value);
	}

	@Override
	public ElementEntry opaque(String name, OmmOpaque value)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.OPAQUE, (DataImpl) value);
	}

	@Override
	public ElementEntry xml(String name, OmmXml value)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.XML, (DataImpl) value);
	}

	@Override
	public ElementEntry ansiPage(String name, OmmAnsiPage value)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.ANSI_PAGE, (DataImpl) value);
	}

	@Override
	public ElementEntry intValue(String name, long value)
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.INT);
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.UINT);
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.REAL);
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.FLOAT);
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.DOUBLE);
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.DATE);
	...
	public ElementEntry time(String name, int hour, int minute, int second, int millisecond, int microsecond,
			int nanosecond)
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.TIME);
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.DATETIME);
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.QOS);
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.STATE);
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.ENUM);
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.BUFFER);
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.ASCII_STRING);
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.UTF8_STRING);
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.RMTES_STRING);
	...
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.ARRAY, (DataImpl) value);
	}

	@Override
	public ElementEntry codeInt(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.INT);
	}

	@Override
	public ElementEntry codeUInt(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.UINT);
	}

	@Override
	public ElementEntry codeReal(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.REAL);
	}

	@Override
	public ElementEntry codeFloat(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.FLOAT);
	}

	@Override
	public ElementEntry codeDouble(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.DOUBLE);
	}

	@Override
	public ElementEntry codeDate(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.DATE);
	}

	@Override
	public ElementEntry codeTime(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.TIME);
	}

	@Override
	public ElementEntry codeDateTime(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.DATETIME);
	}

	@Override
	public ElementEntry codeQos(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.QOS);
	}

	@Override
	public ElementEntry codeState(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.STATE);
	}

	@Override
	public ElementEntry codeEnum(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.ENUM);
	}

	@Override
	public ElementEntry codeBuffer(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.BUFFER);
	}

	@Override
	public ElementEntry codeAscii(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.ASCII_STRING);
	}

	@Override
	public ElementEntry codeUtf8(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.UTF8_STRING);
	}

	@Override
	public ElementEntry codeRmtes(String name)
	{
		return entryValue(name, com.rtsdk.eta.codec.DataTypes.RMTES_STRING);
	}
	...
	{
		entryValue(name, com.rtsdk.eta.codec.DataTypes.NO_DATA);
		return this;
	}
}
