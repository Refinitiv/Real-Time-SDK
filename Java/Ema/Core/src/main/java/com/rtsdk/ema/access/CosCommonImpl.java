...
public class CosCommonImpl implements CosCommon
{
	...
	private int _maxMsgSize = com.rtsdk.eta.valueadd.reactor.CosCommon.DEFAULT_MAX_MSG_SIZE;

	@Override
	public CosCommon clear()
	{
		_maxMsgSize = com.rtsdk.eta.valueadd.reactor.CosCommon.DEFAULT_MAX_MSG_SIZE;
		return this;
	}
