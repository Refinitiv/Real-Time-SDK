...
public interface OmmConsumerClient
{
	 ...
	 * 
	 * @param refreshMsg received RefreshMsg ({@link com.rtsdk.ema.access.RefreshMsg})
	 ...
	 * 
	 * @param updateMsg received UpdateMsg ({@link com.rtsdk.ema.access.UpdateMsg})
	 * @param consumerEvent identifies open item for which this message is received
	 */
	 ...
	 * 
	 * @param genericMsg received GenericMsg ({@link com.rtsdk.ema.access.GenericMsg})
	 * @param consumerEvent identifies open item for which this message is received
	 */
	public void onGenericMsg(GenericMsg genericMsg,	OmmConsumerEvent consumerEvent);
	 ...
	 * 
	 * @param ackMsg received AckMsg ({@link com.rtsdk.ema.access.AckMsg})
	 * @param consumerEvent identifies open item for which this message is received
	 */
	public void onAckMsg(AckMsg ackMsg, OmmConsumerEvent consumerEvent);
