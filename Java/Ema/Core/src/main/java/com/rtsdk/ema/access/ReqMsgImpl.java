...
class ReqMsgImpl extends MsgImpl implements ReqMsg
{
	...
	private com.rtsdk.eta.codec.ElementList _rsslElementList;
	private com.rtsdk.eta.codec.Array _rsslArray;
	private com.rtsdk.eta.codec.ElementEntry _rsslElementEntry;
	private com.rtsdk.eta.codec.ArrayEntry _rsslArrayEntry;
	private com.rtsdk.eta.codec.Buffer _rsslItemBuffer;
	...
	{
		return ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).checkHasPriority(); 
	}

	@Override
	public boolean hasQos()
	{
		return ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).checkHasQos(); 
	}
	
	@Override
	public boolean hasView()
	{
		return ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).checkHasView();
	}

	@Override
	public boolean hasBatch()
	{
		return ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).checkHasBatch();
	}
	...
	public int priorityClass()
	{
		...
		return ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).priority().priorityClass();
	}
	...
	public int priorityCount()
	{
		...
		return ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).priority().count();
	}
	...
	public int qosTimeliness()
	{
		...
		com.rtsdk.eta.codec.RequestMsg rsslMsg = ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg);
	...
	{
		return !(((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).checkNoRefresh());
	}

	@Override
	public boolean interestAfterRefresh()
	{
		return ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).checkStreaming();
	}

	@Override
	public boolean conflatedInUpdates()
	{
		return ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).checkConfInfoInUpdates();
	}

	@Override
	public boolean pause()
	{
		return ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).checkPause();
	}

	@Override
	public boolean privateStream()
	{
		return ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).checkPrivateStream();
	}
	...
	public ReqMsg priority(int priorityClass, int priorityCount)
	{
		...
		((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).applyHasPriority();
		((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).priority().priorityClass(priorityClass);
		((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).priority().count(priorityCount);
	...
	{
		((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).applyHasQos();
		Qos rsslQos = ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).qos();
		rsslQos.clear();
		((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).applyHasWorstQos();
		Qos rsslWQos = ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).worstQos();
		rsslWQos.clear();
		...
		{
		case Rate.TICK_BY_TICK :
			rsslQos.rate(com.rtsdk.eta.codec.QosRates.TICK_BY_TICK);
			rsslWQos.rate(com.rtsdk.eta.codec.QosRates.TICK_BY_TICK);
			break;
		case Rate.JIT_CONFLATED :
			rsslQos.rate(com.rtsdk.eta.codec.QosRates.JIT_CONFLATED);
			rsslWQos.rate(com.rtsdk.eta.codec.QosRates.JIT_CONFLATED);
			break;
		case Rate.BEST_CONFLATED_RATE :
			rsslQos.rate(com.rtsdk.eta.codec.QosRates.TIME_CONFLATED);
			rsslQos.rateInfo (1);
		...
		default :
			if ( rate <= 65535 )
			{
				...
				rsslWQos.rate(com.rtsdk.eta.codec.QosRates.TIME_CONFLATED);
		...
		{
		case Timeliness.REALTIME :
			rsslQos.timeliness(com.rtsdk.eta.codec.QosTimeliness.REALTIME);
			rsslWQos.timeliness(com.rtsdk.eta.codec.QosTimeliness.REALTIME);
			break;
		case Timeliness.BEST_DELAYED_TIMELINESS :
			rsslQos.timeliness(com.rtsdk.eta.codec.QosTimeliness.DELAYED);
			rsslQos.timeInfo(1);
			
			hasQosRange = true;
			rsslWQos.timeliness(com.rtsdk.eta.codec.QosTimeliness.DELAYED);
		...
		default :
			...
			{
				rsslQos.timeliness(com.rtsdk.eta.codec.QosTimeliness.DELAYED_UNKNOWN);
				rsslWQos.timeliness(com.rtsdk.eta.codec.QosTimeliness.DELAYED_UNKNOWN);
			}
			break;
		}
		...
		{
			int flags = ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).flags();
			flags &= ~com.rtsdk.eta.codec.RequestMsgFlags.HAS_WORST_QOS;
			((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).flags(flags);
		}
	...
	{
		msgPayload(data);
		if (_rsslMsg.containerType() == com.rtsdk.eta.codec.DataTypes.ELEMENT_LIST)
	...
	{
		if (!initialImage)
			((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).applyNoRefresh();
	...
	{
		int rsslFlags = ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).flags();
		if (interestAfterRefresh)
			rsslFlags |= com.rtsdk.eta.codec.RequestMsgFlags.STREAMING;
		else
			rsslFlags &= ~com.rtsdk.eta.codec.RequestMsgFlags.STREAMING;
		
		((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).flags(rsslFlags);
	...
	{
		if (pause)
			((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).applyPause();
	...
	public ReqMsg conflatedInUpdates(boolean conflatedInUpdates)
	{
		if (conflatedInUpdates)
			((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).applyConfInfoInUpdates();
	...
	{
		if (privateStream)
			((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).applyPrivateStream();
		
		return this;
	}

	com.rtsdk.eta.codec.RequestMsg rsslMsg()
	{
		return ((_rsslEncodeIter != null) ? (com.rtsdk.eta.codec.RequestMsg)(_rsslMsg) : null);
	}
	...
	void qosInt()
	{
		...
		_qos.decode( ((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).qos() );
	}
		...
		while ( true )
		{
			...
			switch ( retCode )
			{
				...
				case CodecReturnCodes.SUCCESS :
					...
					{
						((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).applyHasView();
					}
					else if ( _rsslElementEntry.name().length() == 9 &&	_rsslElementEntry.name().toString().compareTo(ITEM_LIST_STRING) == 0) 
					{
						...
						if ( _rsslElementEntry.dataType() == com.rtsdk.eta.codec.DataTypes.ARRAY )
						{
							if (_rsslArray == null)
							{
							...
							{
								if ( _rsslArray.primitiveType() == com.rtsdk.eta.codec.DataTypes.ASCII_STRING )
								{
									...
									if ( _batchItemList.size() > 0 )
										((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).applyHasBatch();
								}
							}
						}
				}
	...
	{
		((com.rtsdk.eta.codec.RequestMsg)_rsslMsg).applyStreaming();
	}
