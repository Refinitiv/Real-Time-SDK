...
public class JUnitTestConnect
{
	...
	// used only for JUNIT tests
	public static com.rtsdk.eta.codec.DataDictionary loadDictionary(String dictPath)
	{
	...
	// used only for JUNIT tests
	public static void setRsslData(Msg msg, com.rtsdk.eta.codec.Msg rsslMsgEncoded, int majVer, int minVer,
	...
	// used only for JUNIT tests
	public static void setRsslData(Data data, com.rtsdk.eta.codec.Msg rsslMsgEncoded, int majVer, int minVer,
			com.rtsdk.eta.codec.DataDictionary rsslDictionary, Object localFlSetDefDb)
	{
	...
	// used only for JUNIT tests
	public static void setRsslData(Data data, com.rtsdk.eta.codec.Buffer rsslBufferEncoded, int majVer, int minVer,
			com.rtsdk.eta.codec.DataDictionary rsslDictionary, Object localFlSetDefDb)
	{
	...
	public static void setRsslData(Msg msg, com.rtsdk.eta.codec.Buffer rsslBufferEncoded, int majVer, int minVer,
			com.rtsdk.eta.codec.DataDictionary rsslDictionary, Object localFlSetDefDb)
	{
	...
	public static List<com.rtsdk.eta.valueadd.domainrep.rdm.directory.Service> activeConfigGetService(OmmProvider provider, boolean isIProv)
	{
		if (isIProv)
		{
			OmmIProviderImpl iprovImpl = (OmmIProviderImpl) provider;
