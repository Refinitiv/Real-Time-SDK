...
{
	private com.rtsdk.eta.codec.Int _rsslInt = com.rtsdk.eta.codec.CodecFactory.createInt();
	...
	void decode(com.rtsdk.eta.codec.Buffer rsslBuffer, com.rtsdk.eta.codec.DecodeIterator dIter)
	{
		...
		if (com.rtsdk.eta.codec.CodecReturnCodes.SUCCESS == _rsslInt.decode(dIter))
