...
import static com.rtsdk.ema.access.ServiceIdConverter.ServiceIdConversionError.*;
import static com.rtsdk.ema.access.ServiceIdConverter.ServiceIdConversionError.NONE;
...
public class ServiceIdConverter
{
    ...
    private ServiceIdConversionError encodeServiceIdFromName(String serviceName, com.rtsdk.eta.codec.Msg rsslMsg, int hasMsgKeyFlag)
    {
