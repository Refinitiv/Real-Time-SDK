...
class VectorEntryImpl extends EntryImpl implements VectorEntry
{
	...
	protected com.rtsdk.eta.codec.VectorEntry	_rsslVectorEntry;
	protected int _entryDataType;
	
	VectorEntryImpl()
	{
		_rsslVectorEntry = com.rtsdk.eta.codec.CodecFactory.createVectorEntry();
	}
	
	VectorEntryImpl(com.rtsdk.eta.codec.VectorEntry rsslVectorEntry, DataImpl load, EmaObjectManager objManager)
	{
		super(load);
