...
{
	com.rtsdk.eta.codec.Qos _rsslQos = com.rtsdk.eta.codec.CodecFactory.createQos();
	...
	public String rateAsString()
	{
		...
		{
		case com.rtsdk.eta.codec.QosRates.TICK_BY_TICK:
			_toString.append("TickByTick");
			break;
		case com.rtsdk.eta.codec.QosRates.JIT_CONFLATED:
	...
	public String timelinessAsString()
	{
		...
		{
		case com.rtsdk.eta.codec.QosTimeliness.REALTIME:
			_toString.append("RealTime");
			break;
		case com.rtsdk.eta.codec.QosTimeliness.DELAYED_UNKNOWN:
	...
	public int timeliness()
	{
		...
		case com.rtsdk.eta.codec.QosTimeliness.DELAYED_UNKNOWN :
			...
			break;
		case com.rtsdk.eta.codec.QosTimeliness.DELAYED:
	...
	public int rate()
	{
		...
		case com.rtsdk.eta.codec.QosRates.JIT_CONFLATED:
			...
			break;
		case com.rtsdk.eta.codec.QosRates.TIME_CONFLATED:
	...
	void decode(com.rtsdk.eta.codec.Buffer rsslBuffer, com.rtsdk.eta.codec.DecodeIterator dIter)
	{
		...
		if (com.rtsdk.eta.codec.CodecReturnCodes.SUCCESS == _rsslQos.decode(dIter))
	...
	void decode(com.rtsdk.eta.codec.Qos rsslQos)
	{
		if (rsslQos != null)
		{
			_dataCode = DataCode.NO_CODE;
