...
import com.rtsdk.eta.valueadd.domainrep.rdm.login.LoginAttrib;
...
import com.rtsdk.eta.valueadd.reactor.RDMLoginMsgCallback;
...
class LoginCallbackClient<T> extends CallbackClient<T> implements RDMLoginMsgCallback
{
	...
	public com.rtsdk.eta.valueadd.domainrep.rdm.login.LoginRefresh loginRefreshMsg()
	{
	...
	public int rdmLoginMsgCallback(RDMLoginMsgEvent event)
	{
		...
		switch (loginMsg.rdmMsgType())
		{
			case REFRESH :
			{
				...
				com.rtsdk.eta.codec.State state = ((LoginRefresh)loginMsg).state();
			...
			case STATUS:
			{
		    	...
		    	{
					com.rtsdk.eta.codec.State state =((LoginStatus)loginMsg).state();
	...
	int sendLoginClose()
	{
		...
		rsslCloseMsg.containerType(com.rtsdk.eta.codec.DataTypes.NO_DATA);
...
class LoginItem<T> extends SingleItem<T> implements TimeoutClient
{
	...
	boolean submit( com.rtsdk.eta.codec.PostMsg rsslPostMsg, String serviceName )
	{
		ReactorSubmitOptions rsslSubmitOptions = _baseImpl.rsslSubmitOptions();
		ReactorErrorInfo rsslErrorInfo = _baseImpl.rsslErrorInfo();
