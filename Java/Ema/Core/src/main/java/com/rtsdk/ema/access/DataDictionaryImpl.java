...
import com.rtsdk.ema.access.SeriesImpl;
...
{
    private com.rtsdk.eta.codec.DataDictionary 		rsslDataDictionary;
    ...
    private com.rtsdk.eta.codec.DecodeIterator 		rsslDecodeIterator;
    ...
    private com.rtsdk.eta.codec.Enum 					rsslEnumValue = com.rtsdk.eta.codec.CodecFactory.createEnum();
    private com.rtsdk.eta.transport.Error 				rsslError = com.rtsdk.eta.transport.TransportFactory.createError();
	...
	DataDictionaryImpl(boolean ownDataDictionary)
	{
		...
		{
			rsslDataDictionary = com.rtsdk.eta.codec.CodecFactory.createDataDictionary();
		}
	...
	void rsslDataDictionary(com.rtsdk.eta.codec.DataDictionary dataDictionary)
	{
		try {
			dictionaryLock.lock();
	...
	public List<DictionaryEntry> entries() {
		try {
			...
			{
				com.rtsdk.eta.codec.DictionaryEntry dictionaryEntry;
	...
	public List<EnumTypeTable> enumTables() {
		try {
			...
			{
				com.rtsdk.eta.codec.EnumTypeTable enumTypeTable;
	...
	public void decodeFieldDictionary(Series series, long verbosity) {
		try {
			...
			if (ownRsslDataDictionary)
			{
				...
				com.rtsdk.eta.codec.DecodeIterator decodeIterator = decodeIterator();

				int ret = decodeIterator.setBufferAndRWFVersion(encodedBuffer, com.rtsdk.eta.codec.Codec.majorVersion(),
	...
	public int extractDictionaryType(Series series) {
		try {
			...
			com.rtsdk.eta.codec.Int dictionaryType = com.rtsdk.eta.codec.CodecFactory.createInt();
	...
	private void getEntry(int fieldId, DictionaryEntryImpl entryDst) {
		try {
			...
			com.rtsdk.eta.codec.DictionaryEntry dictionaryEntry = rsslDataDictionary.entry(fieldId);
	...
	public EnumType enumType(int fieldId, int value) {
		try {
			...
			if ( dictionaryEntry != null )
			{
				...
				com.rtsdk.eta.codec.EnumType enumType = rsslDataDictionary.entryEnumType(dictionaryEntry, rsslEnumValue);
	...
	private EnumTypeTableImpl getEnumTypeTable(com.rtsdk.eta.codec.EnumTypeTable enumTypeTable)
	{
	...
	private com.rtsdk.eta.codec.DecodeIterator decodeIterator()
	{
		if ( rsslDecodeIterator == null )
		{
			rsslDecodeIterator = com.rtsdk.eta.codec.CodecFactory.createDecodeIterator();
		}
