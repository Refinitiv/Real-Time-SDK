...
class StatusMsgImpl extends MsgImpl implements StatusMsg
{
	...
	{
		return ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).checkHasState();
	}
	...
	public OmmState state()
	{
		...
		_state.decode(((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).state());
		_stateSet = true;
	...
	{
		return ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).checkHasGroupId();
	}

	@Override
	public boolean hasPermissionData()
	{
		return ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).checkHasPermData();
	}

	@Override
	public boolean hasPublisherId()
	{
		return ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).checkHasPostUserInfo();
	}
	...
	public ByteBuffer itemGroup()
	{
		...
		_itemGroup = Utilities.copyFromPool( ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).groupId(), _itemGroup, _objManager);
		return _itemGroup;
	}
	...
	public ByteBuffer permissionData()
	{
		...
		_permissionData = Utilities.copyFromPool( ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).permData(), _permissionData, _objManager);
	...
	public long publisherIdUserId()
	{
		...
		return ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).postUserInfo().userId();
	}
	...
	public long publisherIdUserAddress()
	{
		...
		return ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).postUserInfo().userAddr();
	}

	@Override
	public boolean clearCache()
	{
		return ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).checkClearCache();
	}

	@Override
	public boolean privateStream()
	{
		return ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).checkPrivateStream();
	}
	...
	public StatusMsg state(int streamState, int dataState, int statusCode,
			String statusText)
	{
		((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).applyHasState();
		
		if (CodecReturnCodes.SUCCESS != ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).state().streamState(streamState) ||
				CodecReturnCodes.SUCCESS != ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).state().dataState(dataState) || 
				CodecReturnCodes.SUCCESS != ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).state().code(statusCode) || 
				CodecReturnCodes.SUCCESS != ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).state().text().data(statusText))
		{
			((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).flags( ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).flags() & ~com.rtsdk.eta.codec.StatusMsgFlags.HAS_STATE );
		...
		((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).state().text().data(statusText);
	...
	public StatusMsg itemGroup(ByteBuffer itemGroup)
	{
		...
		((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).applyHasGroupId();
		Utilities.copy(itemGroup, ((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).groupId());
	...
	{
		if (clearCache)
			((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).applyClearCache();
	...
	{
		if (privateStream)
			((com.rtsdk.eta.codec.StatusMsg)_rsslMsg).applyPrivateStream();
	...
	com.rtsdk.eta.codec.StatusMsg rsslMsg()
	{
		return ((_rsslEncodeIter != null) ? (com.rtsdk.eta.codec.StatusMsg)(_rsslMsg) : null);
	}
