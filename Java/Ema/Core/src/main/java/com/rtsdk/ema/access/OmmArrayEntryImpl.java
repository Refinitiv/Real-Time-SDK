...
{
	protected com.rtsdk.eta.codec.ArrayEntry	_rsslArrayEntry;
	...
	OmmArrayEntryImpl(com.rtsdk.eta.codec.ArrayEntry rsslArrayEntry, DataImpl load)
	{
		super(load);
	...
	public OmmArrayEntry intValue(long value)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.INT;
		return this;
	}
	...
	public OmmArrayEntry uintValue(long value)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.UINT;
	...
	public OmmArrayEntry real(long mantissa, int magnitudeType)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.REAL;
	...
	public OmmArrayEntry floatValue(float value)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.FLOAT;
	...
	public OmmArrayEntry doubleValue(double value)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.DOUBLE;
	...
	public OmmArrayEntry date(int year, int month, int day)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.DATE;
	...
	public OmmArrayEntry time(int hour, int minute, int second, int millisecond, int microsecond, int nanosecond)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.TIME;
			...
			int microsecond, int nanosecond)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.DATETIME;
	...
	public OmmArrayEntry qos(int timeliness, int rate)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.QOS;
	...
	public OmmArrayEntry state(int streamState, int dataState, int statusCode, String statusText)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.STATE;
	...
	public OmmArrayEntry enumValue(int value)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.ENUM;
	...
	public OmmArrayEntry buffer(ByteBuffer value)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.BUFFER;
	...
	public OmmArrayEntry ascii(String value)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.ASCII_STRING;
	...
	public OmmArrayEntry utf8(ByteBuffer value)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.UTF8_STRING;
	...
	public OmmArrayEntry rmtes(ByteBuffer value)
	{
		...
		_entryDataType = com.rtsdk.eta.codec.DataTypes.RMTES_STRING;
