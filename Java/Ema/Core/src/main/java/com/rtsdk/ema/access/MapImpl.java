...
{
	private com.rtsdk.eta.codec.Map _rsslMap = com.rtsdk.eta.codec.CodecFactory.createMap();
	private com.rtsdk.eta.codec.DecodeIterator _keyDecodeIter = com.rtsdk.eta.codec.CodecFactory.createDecodeIterator();
	...
	private int _keyType  = com.rtsdk.eta.codec.DataTypes.BUFFER;
	private int _summaryDataType = com.rtsdk.eta.codec.DataTypes.NO_DATA;
	...
	public void clear()
	{
		...
		_keyType  = com.rtsdk.eta.codec.DataTypes.BUFFER;
		_summaryDataType = com.rtsdk.eta.codec.DataTypes.NO_DATA;
			...
			DataDictionary rsslDictionary, Object obj)
	{
		...
		if (com.rtsdk.eta.codec.CodecReturnCodes.SUCCESS != retCode)
		{
		...
		switch (retCode)
		{
		case com.rtsdk.eta.codec.CodecReturnCodes.NO_DATA :
			_errorCode = ErrorCode.NO_ERROR;
			_rsslMap.flags(0);
			_fillCollection = false;
			clearCollection();
			break;
		case com.rtsdk.eta.codec.CodecReturnCodes.SUCCESS :
			_errorCode = ErrorCode.NO_ERROR;
			break;
		case com.rtsdk.eta.codec.CodecReturnCodes.ITERATOR_OVERRUN :
			_errorCode = ErrorCode.ITERATOR_OVERRUN;
			break;
		case com.rtsdk.eta.codec.CodecReturnCodes.INCOMPLETE_DATA :
		...
		if (_errorCode == ErrorCode.NO_ERROR)
		{
			...
			int rsslContainerType = _rsslMap.checkHasSummaryData() ? _rsslMap.containerType() : com.rtsdk.eta.codec.DataTypes.NO_DATA;
	...
	void fillCollection()
	{
		...
		int retCode;
		while ((retCode  = mapEntry._rsslMapEntry.decode(_rsslDecodeIter, null)) != com.rtsdk.eta.codec.CodecReturnCodes.END_OF_CONTAINER)
		{
			switch(retCode)
			{
				case com.rtsdk.eta.codec.CodecReturnCodes.SUCCESS :
					...
					int rsslContainerType = ( mapEntry._rsslMapEntry.action() != MapEntryActions.DELETE)? _rsslMap.containerType() : com.rtsdk.eta.codec.DataTypes.NO_DATA;
				...
				case com.rtsdk.eta.codec.CodecReturnCodes.INCOMPLETE_DATA :
					...
					break;
				case com.rtsdk.eta.codec.CodecReturnCodes.UNSUPPORTED_DATA_TYPE :
					mapEntryKey = dataInstance(((DataImpl)mapEntry._keyDataDecoded.data()), DataTypes.NO_DATA);
					load = dataInstance(mapEntry._load, DataTypes.ERROR);
	...
	Buffer encodedData()
	{
		...
		else
		{
			...
			if( _keyTypeSet && (_keyType != firstEntry._keyDataType) )
			{
				String errText = errorString().append("Attempt to add entry of ")
						.append(com.rtsdk.eta.codec.DataTypes.toString(firstEntry._keyDataType))
						.append(" while Map entry key is set to ")
						.append(com.rtsdk.eta.codec.DataTypes.toString(_keyType))
			...
			if( firstEntry._entryDataType != com.rtsdk.eta.codec.DataTypes.UNKNOWN )
			{
				if ( _summaryDataTypeSet && (entryType !=  firstEntry._entryDataType) )
				{
					String errText = errorString().append("Attempt to add entry of ")
							.append(com.rtsdk.eta.codec.DataTypes.toString(firstEntry._entryDataType))
							.append(" while Map entry load type is set to ")
							.append(com.rtsdk.eta.codec.DataTypes.toString(entryType))
			...
			{
				entryType = com.rtsdk.eta.codec.DataTypes.UNKNOWN;
		...
		for (com.rtsdk.ema.access.MapEntry entry  : _mapCollection)
		{
			mapEntry = ((MapEntryImpl)entry);
			if (keyType != mapEntry._keyDataType)
			{
				String errText = errorString().append("Attempt to add entry of ")
						.append(com.rtsdk.eta.codec.DataTypes.toString(mapEntry._keyDataType))
						.append(" while Map key contains=")
						.append(com.rtsdk.eta.codec.DataTypes.toString(keyType)).toString();
				throw ommIUExcept().message(errText, OmmInvalidUsageException.ErrorCode.INVALID_OPERATION);
			}
			...
			{
				String errText = errorString().append("Attempt to add entry of ")
						.append(com.rtsdk.eta.codec.DataTypes.toString(mapEntry._entryDataType))
						.append(" while Map contains=")
						.append(com.rtsdk.eta.codec.DataTypes.toString(entryType)).toString();
				throw ommIUExcept().message(errText, OmmInvalidUsageException.ErrorCode.INVALID_OPERATION);
			}
	...
	private int mapEntryEncode(int rsslDataType, com.rtsdk.eta.codec.MapEntry rsslMapEntry, Object cacheKeyData)
	{
		int ret;
		...
		switch (rsslDataType)
		{
		case com.rtsdk.eta.codec.DataTypes.INT:
			 while ((ret =  rsslMapEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Int)cacheKeyData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.UINT:
			 while ((ret =  rsslMapEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.UInt)cacheKeyData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.REAL:
			 while ((ret =  rsslMapEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Real)cacheKeyData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 _rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.DOUBLE:
			 while ((ret =  rsslMapEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Double)cacheKeyData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.FLOAT:
			 while ((ret =  rsslMapEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Float)cacheKeyData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.DATETIME:
			 while ((ret =  rsslMapEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.DateTime)cacheKeyData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.DATE:
			 while ((ret =  rsslMapEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Date)cacheKeyData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.TIME:
			 while ((ret =  rsslMapEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Time)cacheKeyData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.QOS:
			 while ((ret =  rsslMapEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Qos)cacheKeyData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.STATE:
			 while ((ret =  rsslMapEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.State)cacheKeyData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.ENUM:
			 while ((ret =  rsslMapEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Enum)cacheKeyData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
		case com.rtsdk.eta.codec.DataTypes.BUFFER:
		case com.rtsdk.eta.codec.DataTypes.UTF8_STRING:
		case com.rtsdk.eta.codec.DataTypes.ASCII_STRING:
		case com.rtsdk.eta.codec.DataTypes.RMTES_STRING:
			 while ((ret =  rsslMapEntry.encode(_rsslEncodeIter, (com.rtsdk.eta.codec.Buffer)cacheKeyData)) == CodecReturnCodes.BUFFER_TOO_SMALL)
			    {
				 	_rsslBuffer = Utilities.realignBuffer(_rsslEncodeIter, _rsslBuffer.capacity() * 2);
			    }
			 return ret;
	...
	private MapEntryImpl mapEntryInstance()
	{
        ...
        if(retData == null)
        {
        	retData = new MapEntryImpl(com.rtsdk.eta.codec.CodecFactory.createMapEntry(), noDataInstance(), noDataInstance(), _objManager);
