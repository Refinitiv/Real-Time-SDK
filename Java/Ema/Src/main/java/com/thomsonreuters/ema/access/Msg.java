...
public interface Msg extends ComplexType
{
	 ...
	 * 
	 * @throw OmmInvalidUsageException if {@link #hasName()} returns false
	 * 
	 ...
	 * 
	 * @throw OmmInvalidUsageException if {@link #hasNameType()} returns false
	 * 
	 ...
	 * 
	 * @throw OmmInvalidUsageException if {@link #hasServiceId()} returns false
	 * 
	 ...
	 * 
	 * @throw OmmInvalidUsageException if {@link #hasId()} returns false
	 * 
	 * @return id value
	 */
	public int id();
	 ...
	 * 
	 * @throw OmmInvalidUsageException if {@link #hasFilter()} returns false
	 * 
	 * @return filter value
	 */
	public long filter();
	 ...
	 * 
	 * @throw OmmInvalidUsageException if {@link #hasExtendedHeader()} returns false
	 * 
