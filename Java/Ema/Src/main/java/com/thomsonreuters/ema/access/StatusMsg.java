...
public interface StatusMsg extends Msg
{
	...
	*/
	 ...
	 * 
	 * @throw OmmInvalidUsageException if {@link #hasState()} returns false
	 * 
	 ...
	 * 
	 * @throw OmmInvalidUsageException if {@link #hasItemGroup()} returns false
	 * 
	 ...
	 * 
	 * @throw OmmInvalidUsageException if {@link #hasPublisherId()} returns false
	 * 
