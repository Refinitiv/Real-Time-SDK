 ...
 * <p>OmmConsumer uses long values, called handles to identify individual item streams.</p>
 * <p>OmmConsumer validates each passed in handle against all open and known handles.</p>
 * 
 * @see OmmException
 */
