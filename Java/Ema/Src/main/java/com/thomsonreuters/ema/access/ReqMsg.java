...
public interface ReqMsg extends Msg
{
	 ...
	 * 
	 * @throw OmmInvalidUsageException if {@link #hasPriority()} returns false
	 * 
	 ...
	 * 
	 * @throw OmmInvalidUsageException if {@link #hasQos()} returns false
	 * 
	 ...
	 * <br>Calling this method must be preceded by a call to {@link #hasQos()}.
	 * 
	 * @throw OmmInvalidUsageException if if {@link #hasQos()} returns false
	 * 
	 * @return Qos Rate
	 */
	public int qosRate();
