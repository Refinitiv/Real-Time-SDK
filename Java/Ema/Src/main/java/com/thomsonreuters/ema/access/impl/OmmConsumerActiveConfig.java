...
class OmmConsumerActiveConfig
{
	...
	//TODO
	//	void setItemCountHint(long value)
	//	void setServiceCountHint(long value)
	//	void setObeyOpenWindow(long value)
	//	void setPostAckTimeout(long value)
	//	void setRequestTimeout(long value)
	//	void setMaxOutstandingPosts(long value)
	//	void setCatchUnhandledException(long value) 
	//	void setMaxDispatchCountApiThread(long value)
	//	void setMaxDispatchCountUserThread(long value)
	//	void setLoginRequestTimeOut(long value)
	//	void setDirectoryRequestTimeOut(long value) 
	//	void setDictionaryRequestTimeOut(long value)
	...
	void intializeDictReq(String clientName)
	{
		...
		{
			if (rsslFldDictRequest.serviceId() != rsslEnumDictRequest.serviceId())
			{
				StringBuilder temp = consumer.consumerStrBuilder();
				
				temp.append("Invalid dictionary configuration was specified through the OmmConsumerConfig::addAdminMsg()")
					.append(OmmLoggerClient.CR).append("Invalid attempt to download dictionaries from different services.");
