...
public interface OmmConsumer
{
	 ...
	 * @throw OmmInvalidHandleException if application passes invalid parent item handle
	 * 
	 ...
	 * <p> This method is ObjectLevelSafe.</p>
	 * 
	 * @throw OmmInvalidUsageException if OperationalModel is not set to {@link OmmConsumerConfig.OperationModel#USER_DISPATCH}
	 * 
