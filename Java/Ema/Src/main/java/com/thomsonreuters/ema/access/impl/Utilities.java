...
class Utilities
{
	...
	static int toEmaDataType[] = { UnknownDT, UnknownDT, UnknownDT, DataTypes.INT,
			DataTypes.UINT, DataTypes.FLOAT, DataTypes.DOUBLE, UnknownDT,
			DataTypes.REAL, DataTypes.DATE, DataTypes.TIME, DataTypes.DATETIME,
			DataTypes.QOS, DataTypes.STATE, DataTypes.ENUM, DataTypes.ARRAY,
			DataTypes.BUFFER, DataTypes.ASCII, DataTypes.UTF8, DataTypes.RMTES,
			...
			UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT,
			UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT,
			DataTypes.NO_DATA, UnknownDT, DataTypes.OPAQUE, DataTypes.XML,
			DataTypes.FIELD_LIST, DataTypes.ELEMENT_LIST, DataTypes.ANSI_PAGE,
			DataTypes.FILTER_LIST, DataTypes.VECTOR, DataTypes.MAP,
			DataTypes.SERIES, UnknownDT, UnknownDT, UnknownDT, UnknownDT,
			UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT,
			UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT,
			UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT,
			UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT,
	...
	static int toEmaMsgClass[] = { UnknownDT, DataTypes.REQ_MSG,
			DataTypes.REFRESH_MSG, DataTypes.STATUS_MSG, DataTypes.UPDATE_MSG,
			UnknownDT, DataTypes.ACK_MSG, DataTypes.GENERIC_MSG,
			DataTypes.POST_MSG, UnknownDT, UnknownDT, UnknownDT, UnknownDT,
			UnknownDT, UnknownDT };

	static int toRsslMsgClass[] = { MsgClasses.REQUEST,
			MsgClasses.REFRESH, MsgClasses.UPDATE, MsgClasses.STATUS,
			MsgClasses.POST, MsgClasses.ACK, MsgClasses.GENERIC, UnknownDT,
			UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT, UnknownDT };
	...
	static int toRsslQosRate(int rate)
	{
		switch (rate)
		{
		case Rate.TICK_BY_TICK :
			return com.thomsonreuters.upa.codec.QosRates.TICK_BY_TICK;
		case Rate.JIT_CONFLATED :
			return com.thomsonreuters.upa.codec.QosRates.JIT_CONFLATED;
		case Rate.BEST_CONFLATED_RATE :
			return com.thomsonreuters.upa.codec.QosRates.TIME_CONFLATED;
		case Rate.BEST_RATE :
			return com.thomsonreuters.upa.codec.QosRates.TICK_BY_TICK;
		default :
			return com.thomsonreuters.upa.codec.QosRates.TIME_CONFLATED;
	...
	static int toRsslQosTimeliness(int timeliness)
	{
		switch (timeliness)
		{
		case Timeliness.REALTIME :
			return com.thomsonreuters.upa.codec.QosTimeliness.REALTIME;
		case Timeliness.BEST_DELAYED_TIMELINESS :
			return com.thomsonreuters.upa.codec.QosTimeliness.DELAYED_UNKNOWN;
		case Timeliness.BEST_TIMELINESS :
			return com.thomsonreuters.upa.codec.QosTimeliness.REALTIME;
		default :
			return com.thomsonreuters.upa.codec.QosTimeliness.DELAYED;
		}
	}
	...
	{
		int charBufLength = buffer.position();
		for(int i = 0; i < charBufLength; i++)
			temp.append(i+1 == charBufLength ? String.format("%02x", buffer.get(i)) : String.format("%02x ", buffer.get(i)));
