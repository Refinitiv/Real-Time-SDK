@ echo off
rem echo java com.thomsonreuters.ema.examples.training.iprovider.series100.example100__MarketPrice__Streaming.IProvider
...
rem %JAVA_BIN% -cp %CLASSPATH% %LOGGINGCONFIGPATH% com.thomsonreuters.ema.examples.training.iprovider.series100.example100__MarketPrice__Streaming.IProvider
rem java -cp %CLASSPATH% %LOGGINGCONFIGPATH% com.thomsonreuters.ema.examples.training.iprovider.series100.example100__MarketPrice__Streaming.IProvider

%JAVA_BIN% -cp %CLASSPATH% com.thomsonreuters.ema.examples.training.iprovider.series100.example100__MarketPrice__Streaming.IProvider
