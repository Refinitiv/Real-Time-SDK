...
package com.thomsonreuters.ema.examples.training.consumer.series300.example370__MarketPrice__Batch;
...
public class Consumer 
{
	public static void main(String[] args)
	{
		try
		{
			...
			consumer.registerClient(reqMsg.serviceName("DIRECT_FEED").payload(batch), appClient);
