...
The example200__MarketPrice__Streaming application is provided as an example of
...
example200__MarketPrice__Streaming showcases native or RWF decoding of received
...
example200__MarketPrice__Streaming implements the following high level steps:
