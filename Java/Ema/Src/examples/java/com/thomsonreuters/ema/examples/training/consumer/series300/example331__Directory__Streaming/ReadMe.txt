...
The example331__Directory__Streaming application is provided as an example of
...
example331__Directory__Streaming showcases usage of directory stream in OMM
...
example331__Directory__Streaming implements the following high level steps:
