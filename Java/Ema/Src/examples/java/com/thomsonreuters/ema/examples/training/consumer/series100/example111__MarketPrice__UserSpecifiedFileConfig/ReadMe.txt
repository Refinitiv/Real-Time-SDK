...
example111__MarketPrice__UserSpecifiedFileConfig is an OMM Consumer application example
...
example111__MarketPrice__UserSpecifiedFileConfig illustrates the abilitily of the user
...
if no argument is supplied, the application works the same as example110__MarketPrice__FileConfig.

Detailed Description
====================

example111__MarketPrice__UserSpecifiedFileConfig implements the following high-level steps:
