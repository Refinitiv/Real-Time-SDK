...
package com.thomsonreuters.ema.examples.training.iprovider.series300.example332__Dictionary__UserControl;
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			provider = EmaFactory.createOmmProvider(EmaFactory.createOmmIProviderConfig().
					adminControlDictionary(OmmIProviderConfig.AdminControl.USER_CONTROL), appClient);
