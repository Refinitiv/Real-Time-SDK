...
package com.thomsonreuters.ema.examples.training.consumer.series300.example360__MarketPrice__View;
...
public class Consumer 
{
	public static void main(String[] args)
	{
		try
		{
			...
			array.fixedWidth(2);
			array.add(EmaFactory.createOmmArrayEntry().uintValue(22));
			array.add(EmaFactory.createOmmArrayEntry().uintValue(25));
			...
			consumer.registerClient(reqMsg.serviceName("DIRECT_FEED").name("IBM.N").payload(view), appClient);
