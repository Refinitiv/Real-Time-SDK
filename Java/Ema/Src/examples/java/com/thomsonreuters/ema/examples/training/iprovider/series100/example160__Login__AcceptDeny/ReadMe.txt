...
example160__Login__AcceptDeny is an example of an OMM Interactive Provider application 
...
example160__Login__AcceptDeny implements the following high-level steps:
