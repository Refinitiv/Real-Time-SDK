...
package com.thomsonreuters.ema.examples.training.consumer.series400.example422__MarketPrice__ErrorClient;
...
public class Consumer 
{
	public static void main(String[] args)
	{
		...
		OmmConsumer consumer = EmaFactory.createOmmConsumer(config.operationModel(OperationModel.USER_DISPATCH).username("user"), appErrorClient);
