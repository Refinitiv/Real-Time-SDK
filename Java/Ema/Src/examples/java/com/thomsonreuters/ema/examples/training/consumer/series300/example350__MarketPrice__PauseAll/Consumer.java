...
package com.thomsonreuters.ema.examples.training.consumer.series300.example350__MarketPrice__PauseAll;
	...
	public void onUpdateMsg(UpdateMsg updateMsg, OmmConsumerEvent event) 
	{
		...
		if(updateMsg.domainType() == EmaRdm.MMT_MARKET_PRICE)
		{
			if(++_updateCount == 10)
			{
				...
				_ommConsumer.reissue(reqMsg.domainType(EmaRdm.MMT_LOGIN).initialImage(false).pause(true).name("user"), _loginHandle);
			}
		}
	}
