...
public class Consumer 
{
	public static void main(String[] args)
	{
		try
		{
			...
			OmmConsumer consumer  = EmaFactory.createOmmConsumer(config.username("user"));
			
			appClient.setOmmConsumer(consumer);
			
			ReqMsg reqMsg = EmaFactory.createReqMsg();
						
			long handle = consumer.registerClient(reqMsg.domainType(200).serviceName("DIRECT_FEED").name("IBM.XYZ").privateStream(true), appClient, (Integer)1);
