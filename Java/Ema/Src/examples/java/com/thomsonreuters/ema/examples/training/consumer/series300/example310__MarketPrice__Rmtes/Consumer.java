...
package com.thomsonreuters.ema.examples.training.consumer.series300.example310__MarketPrice__Rmtes;
	...
	void decode(FieldList fieldList)
	{
		for (FieldEntry fieldEntry : fieldList)
		{
			if (fieldEntry.name().equals("BCAST_TEXT"))
			{
				...
				rmtesBuffer.apply(fieldEntry.rmtes());
...
public class Consumer 
{
	public static void main(String[] args)
	{
		try
		{
			...
			consumer.registerClient(reqMsg.serviceName("DIRECT_FEED").name("N2_UBMS"), appClient, 0);
