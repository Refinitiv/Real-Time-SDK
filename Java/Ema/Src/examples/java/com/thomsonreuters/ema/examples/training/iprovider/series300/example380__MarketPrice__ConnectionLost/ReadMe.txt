...
300__MarketPrice__ConnectionLost is an example of an OMM Interactive Provider application 
...
300__MarketPrice__ConnectionLost illustrates how to create and publish a single OMM
...
300__MarketPrice__ConnectionLost implements the following high-level steps:
