...
set(curl_version_rh9 "8.22.0" CACHE STRING "")
...
if( UNIX AND ( (RCDEV_HOST_SYSTEM_FLAVOR_REL LESS_EQUAL 8)
	...
	if(NOT curl_url)
		set(curl_url "https://github.com/curl/curl/releases/download/curl-8_22_0/curl-${curl_version_rh9}.tar.xz")
	endif()
	if(NOT curl_hash)
		set(curl_hash "SHA256=f7ef3ae8a22e521f289803fe93543eb64c329b58aa73a9e224dfd915a2a5f4f7")
	endif()
	if(NOT curl_version)
