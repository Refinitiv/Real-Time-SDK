...
set(curl_version_rh9 "8.21.0" CACHE STRING "")
...
if( UNIX AND ( (RCDEV_HOST_SYSTEM_FLAVOR_REL LESS_EQUAL 8)
	...
	if(NOT curl_url)
		set(curl_url "https://github.com/curl/curl/releases/download/curl-8_21_0/curl-${curl_version_rh9}.tar.xz")
	endif()
	if(NOT curl_hash)
		set(curl_hash "MD5=230131079987135cbe1eadb77a04af57")
	endif()
	if(NOT curl_version)
