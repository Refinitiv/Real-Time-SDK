...
if( UNIX )
	...
	elseif ( ${CMAKE_BUILD_TYPE} STREQUAL "OptimizedDebug" )
		set ( CMAKE_C_FLAGS "${RCDEV_C_FLAGS_INIT} -ggdb3 -O3 -fbuiltin ${CMAKE_FLAGS_CLANG}" CACHE STRING "" FORCE)
	endif()
	...
	elseif ( ${CMAKE_BUILD_TYPE} STREQUAL "OptimizedDebug" )
		set ( CMAKE_CXX_FLAGS "${RCDEV_CXX_FLAGS_INIT} -ggdb3 -O3 -fbuiltin ${CMAKE_FLAGS_CLANG}"  CACHE STRING "" FORCE)
	endif()
