...
int main(int argc, char **argv)
{
	...
	if (argc > 1) 
	{
		...
		while (i < argc)
		{
			...
			else
			{
				...
				printf("Usage: %s or\n%s [-h <SrvrHostname>] [-p <SrvrPortNo>] [-i <InterfaceName>] [-s <ServiceName>] [-id <ServiceId>] \n", argv[0], argv[0]);
	 ...
	 * locally in a file.
	 *
	 * We will just use dictionaries that are available locally in a file. We will exit the NIP application
	 ...
	 * if they exist, at the earlier stage of the NIP applications.
	 * 
