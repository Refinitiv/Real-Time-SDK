...
package com.thomsonreuters.ema.examples.training.series200.example291__Custom__DownCast;
	...
	void decode( Data data )
	{
		if ( Data.DataCode.BLANK == data.code() )
			...
			case DataTypes.INT :
				...
				break;
			case DataTypes.UINT :
				System.out.println( "OmmUInt: " + ((OmmUInt)data).longUIntValue() );
				break;
			case DataTypes.ENUM :
...
public class Consumer 
{
	public static void main( String[] args )
	{
		try
		{
			...
			consumer.registerClient( reqMsg.domainType( 133 ).serviceName( "DIRECT_FEED" ).name( "IBM.XYZ" ), appClient, 1 );
