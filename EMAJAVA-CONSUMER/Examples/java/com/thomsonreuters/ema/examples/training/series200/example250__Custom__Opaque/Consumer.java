...
package com.thomsonreuters.ema.examples.training.series200.example250__Custom__Opaque;
...
class AppClient implements OmmConsumerClient
{
	...
	{
		System.out.println( "OmmOpaque data: " + oq.asHex() );
	}
}
...
public class Consumer 
{
	public static void main( String[] args )
	{
		try
		{
			...
			consumer.registerClient( reqMsg.domainType( 200 ).serviceName( "DIRECT_FEED" ).name( "IBM.XYZ" ), appClient, 0 );
