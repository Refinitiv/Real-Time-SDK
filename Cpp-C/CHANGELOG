...
------------------
[GitHub Pull Request # 97] - [ESDK-3244] - Catch polymorphic type by reference, not by value
[Case Number: 07645599] - [ESDK-3274] - EMAC++ 'OmmInvalidUsageException', Text='The Field name STOCK_TYPE does not exist in the field dictionary'
[GitHub # 113] - [ESDK-3437] - Add port info into OmmConsumerEvent::getChannelInformation
