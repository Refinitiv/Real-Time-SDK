 ...
 *|           Copyright (C) 2018-2021,2024-2026 LSEG. All rights reserved.
 *|-----------------------------------------------------------------------------
 */
...
RSSL_API const char* rsslRDMUpdateEventFilterTypeToOmmString(RsslUInt type)
{
	switch (type)
	{
		...
		case RDM_UPD_EVENT_FILTER_TYPE_NEWS_ALERT: return RDM_OMMSTR_UPD_EVENT_FILTER_TYPE_NEWS_ALERT.data;
		case RDM_UPD_EVENT_FILTER_TYPE_VOLUME_ALERT: return RDM_OMMSTR_UPD_EVENT_FILTER_TYPE_VOLUME_ALERT.data;
		case RDM_UPD_EVENT_FILTER_TYPE_ORDER_INDICATION: return RDM_OMMSTR_UPD_EVENT_FILTER_TYPE_ORDER_INDICATION.data;
		case RDM_UPD_EVENT_FILTER_TYPE_CLOSING_RUN: return RDM_OMMSTR_UPD_EVENT_FILTER_TYPE_CLOSING_RUN.data;
		case RDM_UPD_EVENT_FILTER_TYPE_CORRECTION: return RDM_OMMSTR_UPD_EVENT_FILTER_TYPE_CORRECTION.data;
		case RDM_UPD_EVENT_FILTER_TYPE_MARKET_DIGEST: return RDM_OMMSTR_UPD_EVENT_FILTER_TYPE_MARKET_DIGEST.data;
		case RDM_UPD_EVENT_FILTER_TYPE_QUOTES_TRADE: return RDM_OMMSTR_UPD_EVENT_FILTER_TYPE_QUOTES_TRADE.data;
