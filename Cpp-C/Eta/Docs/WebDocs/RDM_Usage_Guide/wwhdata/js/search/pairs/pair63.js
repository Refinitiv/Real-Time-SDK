...
x.t("rssl_dt_element_list","required");
x.t("domain","4.3");
x.t("function","[r]");
...
x.t("rsslmapentry","permission");
x.t("rsslmapentry","elements");
x.t("directory","rdm");
...
x.t("transport","api");
x.t("rsslelemententry","indicates");
x.t("message","payload");
x.t("message","rsslmap");
x.t("message","rsslmapentry");
x.t("value","type");
x.t("4.3","data");
x.t("send","pageview");
