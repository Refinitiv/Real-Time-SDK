...
x.t("name","type");
x.t("rssl_dt_uint","payload");
x.t("rssl_dt_uint","65535");
x.t("rssl_dt_uint","(standby)");
x.t("follows","table");
...
x.t("loaded","65535");
x.t("loaded","first");
x.t("loaded","rsslvector");
x.t("find","least");
x.t("servertype","rssl_dt_uint");
x.t("address","hostname");
x.t("warm","standby");
x.t("numstandbyservers","rssl_dt_uint");
...
x.t("attempted","rsslvectorentry");
x.t("first","rsslvectorentry");
x.t("domain","3.3");
...
x.t("systemid","rssl_dt_ascii_string");
...
x.t("hostname","rssl_dt_ascii_string");
x.t("hostname","port");
x.t("consumer","need");
...
x.t("sorted","consumer");
x.t("sorted","order");
x.t("sorted","rsslvector");
x.t("rsslvectorentry","contain");
...
x.t("value","non-zero");
x.t("send","pageview");
x.t("rsslelementlist","vector");
x.t("rsslelementlist","list");
x.t("rsslelementlist","describing");
...
x.t("rssl_dt_ascii_string","payload");
...
x.t("information","rsslrefreshmsg");
