...
x.t("type","version");
x.t("type","dictionary");
x.t("rsslarray","rssl_dt_ascii_string");
...
x.t("rsslrequestmsg","rdm_dictionary_info");
x.t("requests","higher");
x.t("transport","api");
x.t("section","4.3.1.1");
x.t("directory","parse");
...
x.t("rssl_dt_ascii_string","dictionary");
x.t(".push","(arguments)");
