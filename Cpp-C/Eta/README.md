...
##### Static Library Manifest
    ...
    ------------              ---------------
    librssl.lib*              eta3.6.3.L2
    librsslVA.lib             eta3.6.3.L2
    librsslVACache.lib        eta3.6.3.L2
    libansi.lib               eta3.6.3.L2
    libdacs.lib               eta3.6.3.L2
...
##### Shared Library Manifest
    ...
    Library Name              Package Version
    -------------             ---------------
    librssl.dll               eta3.6.3.L2
    librssl.lib               eta3.6.3.L2
    librssl.pdb               eta3.6.3.L2
    librsslVA.dll             eta3.6.3.L2
    librsslVA.lib             eta3.6.3.L2
    librsslVA.pdb             eta3.6.3.L2
    librsslVACache.dll        eta3.6.3.L2
    librsslVACache.lib        eta3.6.3.L2
    librsslVACache.pdb        eta3.6.3.L2
    librsslJsonConverter.dll  eta3.6.3.L2
    librsslJsonConverter.lib  eta3.6.3.L2
    librsslJsonConverter.pdb  eta3.6.3.L2
...
##### Static Library Manifest
    ...
    ------------                       ---------------
    librssl.a                          eta3.6.3.L2
    librsslVA.a                        eta3.6.3.L2
    librsslVACache.a                   eta3.6.3.L2
    libansi.lib                        eta3.6.3.L2
    libdacs.lib                        eta3.6.3.L2
...
# Reference Information
    ...
    Load Number: 2
    Windows Load ID: eta3.6.3.L2.win
        Supersedes: eta3.6.3.L1.win.rrg
    Linux Load ID: eta3.6.3.L2.linux
        Supersedes: eta3.6.3.L1.linux.rrg
    Release Status: RRG
    Release Type: RRG
    US ECCN: EAR99
    EU ECCN: None
