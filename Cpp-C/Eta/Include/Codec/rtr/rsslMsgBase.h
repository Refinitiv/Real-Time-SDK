...
typedef struct {
	...
	RsslUInt8			domainType;		/*!< @brief Domain Type of this message, corresponds to a domain model definition Values less than 128 are LSEG defined domain models, values between 128 � 255 are user defined domain models. */
...
/**
 *	@defgroup RSSLWFDomainHelpers LSEG Domain Model Helper Functions
 * 	@{
 */
