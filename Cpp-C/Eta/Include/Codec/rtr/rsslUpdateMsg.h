...
typedef struct {
	...
	RsslUInt8			updateType;		/*!< @brief Indicates domain-specific information about the type of content contained in this update. See rsslRDM.h for domain-specific enumerations for usage with the Domain Models. */
