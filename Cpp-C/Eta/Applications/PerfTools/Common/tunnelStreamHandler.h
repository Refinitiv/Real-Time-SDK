 ...
 * The PerfTunnelMsgHandler has this structure
...
typedef struct
{
	...
	/* Guaranteed Output Tunnel Buffers. See tunnelStreamOpenOptions in call rsslReactorOpenTunnelStream. */
							...
							RsslUInt32 guaranteedOutputTunnelBuffers)
{
    ...
    pTunnelHandler->guaranteedOutputTunnelBuffers = guaranteedOutputTunnelBuffers;
}
