...
class WatchlistDirectoryUnitTest_Multicast : public ::testing::Test {
public:
...
TEST_F(WatchlistDirectoryUnitTest_Multicast, OneService)
{
	watchlistDirectoryTest_OneService();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, ServiceUpdate)
{
	watchlistDirectoryTest_ServiceUpdate();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, ServiceUpdatePartialFilter)
{
	watchlistDirectoryTest_ServiceUpdatePartialFilter();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, ServiceUpdateLinkFilterOnly)
{
	watchlistDirectoryTest_ServiceUpdateLinkFilterOnly();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, RsslMsgClose)
{
	watchlistDirectoryTest_RsslMsgClose();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, MultipleRequests)
{
	watchlistDirectoryTest_MultipleRequests();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, NoRdmCallbacks_WTF_CB_NONE)
{
	watchlistDirectoryTest_NoRdmCallbacks(WTF_CB_NONE);
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, NoRdmCallbacks_WTF_CB_RAISE_TO_DEFAULT_CB)
{
	watchlistDirectoryTest_NoRdmCallbacks(WTF_CB_RAISE_TO_DEFAULT_CB);
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, DirectoryStatus)
{
	watchlistDirectoryTest_DirectoryStatus();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, DataTest_OneService)
{
	watchlistDirectoryDataTest_OneService();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, DataFilterOnly_OneService)
{
	watchlistDirectoryDataTestDataFilterOnly_OneService();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, DataTest_Links)
{
	watchlistDirectoryDataTest_Links();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, DataTestLinkFilterOnly_Links)
{
	watchlistDirectoryDataTestLinkFilterOnly_Links();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, DataTest_Groups)
{
	watchlistDirectoryDataTest_Groups();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, DataTestGroupFilterOnly_Groups)
{
	watchlistDirectoryDataTestGroupFilterOnly_Groups();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, DataTestDataFilterOnly_Data)
{
	watchlistDirectoryDataTestDataFilterOnly_Data();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, DeleteService)
{
	watchlistDirectoryTest_DeleteService();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, BigDirectory)
{
	watchlistDirectoryTest_BigDirectory();
}

TEST_F(WatchlistDirectoryUnitTest_Multicast, DuplicateServiceName)
{
	watchlistDirectoryTest_DuplicateServiceName();
}
#endif
