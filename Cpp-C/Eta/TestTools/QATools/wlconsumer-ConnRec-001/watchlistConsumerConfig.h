...
typedef struct
{
	...
	//APIQA
	char				hostName1[255];					/* Host to connect to. */
	char				port1[255];						/* Port to connect to. */
	char                hostName2[255];                 /* Host to connect to. */
    char                port2[255];                     /* Port to connect to. */
    char                hostName3[255];                 /* Host to connect to. */
    char                port3[255];                     /* Port to connect to. */
    RsslUInt16          minDelay;                   /* reconnectMinDelay (millisecond). */
    RsslUInt16          maxDelay;                   /* reconnectMaxDelay (milliseconds). */
    RsslUInt8           attempLimit;                    /* attemptLimit. */
    RsslUInt8           numConnections;                 /* number of connections. */
    //END APIQA
