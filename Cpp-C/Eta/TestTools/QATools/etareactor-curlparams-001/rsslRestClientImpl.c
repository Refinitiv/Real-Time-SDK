...
CURLcode commonCurlOptions(CURL* curl, RsslRestRequestArgs* requestArgs)
{
	...
	{
		// API QA
		printf("requestArgs->networkArgs.proxyArgs.proxyUserName = %s\n", requestArgs->networkArgs.proxyArgs.proxyUserName.data);
		printf("requestArgs->networkArgs.proxyArgs.proxyPassword = %s\n", requestArgs->networkArgs.proxyArgs.proxyPassword.data);
		// END API QA
		...
		{
			// API QA
			printf("requestArgs->networkArgs.proxyArgs.proxyDomain = %s\n", requestArgs->networkArgs.proxyArgs.proxyDomain.data);
			// END API QA
	...
	{
		// API QA
		printf("requestArgs->networkArgs.proxyArgs.proxyHostName = %s\n", requestArgs->networkArgs.proxyArgs.proxyHostName.data);
		// END API QA
	...
	if (requestArgs->networkArgs.proxyArgs.proxyPort.length)
	{
		...
		{
			// API QA
			printf("requestArgs->networkArgs.proxyArgs.proxyPort = %d\n", proxyPortNum);
			// END API QA
