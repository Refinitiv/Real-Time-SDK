...
RsslRet rsslWrite(RsslChannel *chnl, RsslBuffer *buffer, RsslWritePriorities rsslPriority, RsslUInt8 writeFlags, RsslUInt32 *bytesWritten, RsslUInt32 *uncompressedBytesWritten, RsslError *error)
{
	...
	// API QA
	static RsslUInt8 save_writeFlags = 0xFF;
	// END API QA
	...
	{
		save_writeFlags = writeFlags;
		printf("rsslWrite. RSSL_WRITE_DIRECT_SOCKET_WRITE = %d\n", (writeFlags & RSSL_WRITE_DIRECT_SOCKET_WRITE ? 1 : 0));
	}
	// END API QA
...
RsslRet rsslWriteEx(RsslChannel *chnl, RsslBuffer *buffer, RsslWriteInArgs *writeInArgs, RsslWriteOutArgs *writeOutArgs, RsslError *error)
{
	...
	{
		save_writeFlags = writeInArgs->writeInFlags;
		printf("rsslWriteEx. RSSL_WRITE_DIRECT_SOCKET_WRITE = %d\n", (writeInArgs->writeInFlags & RSSL_WRITE_DIRECT_SOCKET_WRITE ? 1 : 0));
	}
	// END API QA
