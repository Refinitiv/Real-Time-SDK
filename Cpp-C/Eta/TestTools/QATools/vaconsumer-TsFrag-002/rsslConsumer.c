...
{
	// APIQA: Added bufSize	
	printf("Usage: %s or\n%s  [-tcp [<hostname>:<port> <service name>]] [<domain>:<item name>,...] ] [-uname <LoginUsername>] [-view] [-post] [-offpost] [-snapshot] [-runtime <seconds>] [-cache] [-cacheInterval <seconds>] [-bufSize <size>] [-tunnel] [-tsDomain <number> ] [-tsAuth] [ -qSourceName <name> ] [ -qDestName <name> ] [-tsServiceName] [-x] [-runtime]\n"
	// END APIQA
