...
#ifndef __rtsdk_ema_access_ServiceEndpointDiscoveryOption_h
#define __rtsdk_ema_access_ServiceEndpointDiscoveryOption_h
...
#endif // __rtsdk_ema_access_ServiceEndpointDiscoveryOption_h
