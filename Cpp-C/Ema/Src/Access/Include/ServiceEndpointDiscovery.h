...
#ifndef __rtsdk_ema_access_ServiceEndpointDiscovery_h
#define __rtsdk_ema_access_ServiceEndpointDiscovery_h
...
#endif // __rtsdk_ema_access_ServiceEndpointDiscovery_h
