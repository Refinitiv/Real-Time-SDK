...
#ifndef __thomsonreuters_ema_access_MarketItemHandler_h
#define __thomsonreuters_ema_access_MarketItemHandler_h
...
#endif // __thomsonreuters_ema_access_MarketItemHandler_h
