...
#ifndef __refinitiv_ema_access_OmmJsonDecoder_h
#define __refinitiv_ema_access_OmmJsonDecoder_h
...
class OmmJsonDecoder : public Decoder
{
public :

	OmmJsonDecoder();

	virtual ~OmmJsonDecoder();
...
#endif // __refinitiv_ema_access_OmmJsonDecoder_h
