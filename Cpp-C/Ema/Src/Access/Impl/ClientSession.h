 ...
 *|           Copyright (C) 2016-2017,2019-2020,2024 LSEG. All rights reserved.
 *|-----------------------------------------------------------------------------
 */

#ifndef __refinitiv_ema_access_ClientSession_h
#define __refinitiv_ema_access_ClientSession_h
...
#endif // __refinitiv_ema_access_ClientSession_h
