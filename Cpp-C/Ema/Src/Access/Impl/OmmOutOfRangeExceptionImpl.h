...
#ifndef __rtsdk_ema_access_OmmOutOfRangeExceptionImpl_h
#define __rtsdk_ema_access_OmmOutOfRangeExceptionImpl_h
...
#endif // __rtsdk_ema_access_OmmOutOfRangeExceptionImpl_h
