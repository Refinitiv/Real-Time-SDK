...
#ifndef __rtsdk_ema_access_OmmUnsupportedDomainTypeExceptionImpl_h
#define __rtsdk_ema_access_OmmUnsupportedDomainTypeExceptionImpl_h
...
#endif // __rtsdk_ema_access_OmmUnsupportedDomainTypeExceptionImpl_h
