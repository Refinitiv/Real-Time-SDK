...
#ifndef __rtsdk_ema_access_ServiceEndpointDiscoveryImpl_h
#define __rtsdk_ema_access_ServiceEndpointDiscoveryImpl_h
...
#endif // __rtsdk_ema_access_ServiceEndpointDiscoveryImpl_h
