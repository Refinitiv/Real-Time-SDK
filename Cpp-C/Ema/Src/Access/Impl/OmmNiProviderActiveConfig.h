...
#ifndef __rtsdk_ema_access_OmmNiProviderActiveConfig_h
#define __rtsdk_ema_access_OmmNiProviderActiveConfig_h
...
#endif // __rtsdk_ema_access_OmmNiProviderActiveConfig_h
