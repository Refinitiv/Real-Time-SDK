...
#ifndef __rtsdk_ema_access_OmmInaccessibleLogFileExceptionImpl_h
#define __rtsdk_ema_access_OmmInaccessibleLogFileExceptionImpl_h
...
#endif // __rtsdk_ema_access_OmmInaccessibleLogFileExceptionImpl_h
