...
*/
static const refinitiv::ema::access::UInt8 MMT_LOGIN					= 1;	/*!< Login Message Model Type */
static const refinitiv::ema::access::UInt8 MMT_DIRECTORY				= 4;	/*!< Source Message Model Type */
static const refinitiv::ema::access::UInt8 MMT_DICTIONARY				= 5;	/*!< Dictionary Message Model Type */
static const refinitiv::ema::access::UInt8 MMT_MARKET_PRICE				= 6;	/*!< MarketPrice Message Model Type */
static const refinitiv::ema::access::UInt8 MMT_MARKET_BY_ORDER			= 7;	/*!< Market by Order/Order Book Model Message Type */
static const refinitiv::ema::access::UInt8 MMT_MARKET_BY_PRICE			= 8;	/*!< Market by Price/Market Depth Model Message Type */
static const refinitiv::ema::access::UInt8 MMT_MARKET_MAKER				= 9;	/*!< Market Maker Message Model Type */
static const refinitiv::ema::access::UInt8 MMT_SYMBOL_LIST				= 10;	/*!< Symbol List Messages Model Type */
static const refinitiv::ema::access::UInt8 MMT_SERVICE_PROVIDER_STATUS	= 11;	/*!< Service Provider Status Message Model Type*/
static const refinitiv::ema::access::UInt8 MMT_HISTORY					= 12;	/*!< History Message Model Type */
static const refinitiv::ema::access::UInt8 MMT_HEADLINE					= 13;	/*!< Headline Message Model Type */
static const refinitiv::ema::access::UInt8 MMT_STORY					= 14;	/*!< Story Message Model Type */
static const refinitiv::ema::access::UInt8 MMT_REPLAYHEADLINE			= 15;	/*!< Replay Headline Message Model Type */
static const refinitiv::ema::access::UInt8 MMT_REPLAYSTORY				= 16;	/*!< Replay Story Message Model Type */
static const refinitiv::ema::access::UInt8 MMT_TRANSACTION				= 17;	/*!< Transaction Message Model Type */
static const refinitiv::ema::access::UInt8 MMT_YIELD_CURVE				= 22;	/*!< Yield Curve Message Model Type */
static const refinitiv::ema::access::UInt8 MMT_CONTRIBUTION				= 27;	/*!< Contribution Message Model Type */
static const refinitiv::ema::access::UInt8 MMT_PROVIDER_ADMIN			= 29;	
static const refinitiv::ema::access::UInt8 MMT_ANALYTICS				= 30;	/*!< Analytics content */
static const refinitiv::ema::access::UInt8 MMT_REFERENCE				= 31;	/*!< Reference content */
static const refinitiv::ema::access::UInt8 MMT_NEWS_TEXT_ANALYTICS		= 33;	/*!< News Text Analytics domain for machine readable news content */
...
*/
static const refinitiv::ema::access::UInt8 USER_NAME	        =	1;	/*!< String defining User Name */
static const refinitiv::ema::access::UInt8 USER_EMAIL_ADDRESS	=	2;	/*!< String defining Email address */
static const refinitiv::ema::access::UInt8 USER_TOKEN			=	3;	/*!< String defining User Token */
static const refinitiv::ema::access::UInt8 USER_COOKIE			=   4;	/*!< String defining Cookie */
static const refinitiv::ema::access::UInt8 USER_AUTH_TOKEN		=   5;	/*!< String defining User Auth Token */
//@}
...
*/
static const refinitiv::ema::access::UInt32 LOGIN_ROLE_CONS     = 0;    /*!< log in as consumer */
static const refinitiv::ema::access::UInt32 LOGIN_ROLE_PROV     = 1;    /*!< log in as provider */
//@}
...
*/
static const refinitiv::ema::access::UInt32 DICTIONARY_INFO      = 0x00;	/*!< "Dictionary Info" Verbosity, no data - version information only */
static const refinitiv::ema::access::UInt32 DICTIONARY_MINIMAL   = 0x03;   /*!< "Minimal" Verbosity, e.g. Cache + ShortName */
static const refinitiv::ema::access::UInt32 DICTIONARY_NORMAL    = 0x07;   /*!< "Normal" Verbosity, e.g. all but description */
static const refinitiv::ema::access::UInt32 DICTIONARY_VERBOSE   = 0x0F;   /*!< "Verbose" Verbosity, e.g. all with description */
//@}
...
*/
static const refinitiv::ema::access::UInt32 DICTIONARY_UNSPECIFIED			= 0; /*!< Unspecified dictionary type */
static const refinitiv::ema::access::UInt32 DICTIONARY_FIELD_DEFINITIONS	= 1; /*!< Field Definition dictionary */
static const refinitiv::ema::access::UInt32 DICTIONARY_ENUM_TABLES			= 2; /*!< Enumeration dictionary */
static const refinitiv::ema::access::UInt32 DICTIONARY_RECORD_TEMPLATES		= 3; /*!< Record template dictionary */
static const refinitiv::ema::access::UInt32 DICTIONARY_DISPLAY_TEMPLATES	= 4; /*!< Display template dictionary */
static const refinitiv::ema::access::UInt32 DICTIONARY_DATA_DEFINITIONS		= 5; /*!< DataDef dictionary */
static const refinitiv::ema::access::UInt32 DICTIONARY_STYLE_SHEET			= 6; /*!< Style sheet */
static const refinitiv::ema::access::UInt32 DICTIONARY_REFERENCE			= 7; /*!< Reference dictionary */
//@}
...
*/
static const refinitiv::ema::access::UInt32 SERVICE_INFO_FILTER     = 0x00000001;  /*!< Service Info Filter */
static const refinitiv::ema::access::UInt32 SERVICE_STATE_FILTER    = 0x00000002;  /*!< Service State Filter */
static const refinitiv::ema::access::UInt32 SERVICE_GROUP_FILTER    = 0x00000004;  /*!< Service Group Filter */
static const refinitiv::ema::access::UInt32 SERVICE_LOAD_FILTER     = 0x00000008;  /*!< Service Load Filter */
static const refinitiv::ema::access::UInt32 SERVICE_DATA_FILTER     = 0x00000010;  /*!< Service Data Filter */
static const refinitiv::ema::access::UInt32 SERVICE_LINK_FILTER     = 0x00000020;	/*!< Service Symbol List Filter */
//@}
...
*/
static const refinitiv::ema::access::UInt8 SERVICE_INFO_ID			= 1; /*!< Service Info Filter */
static const refinitiv::ema::access::UInt8 SERVICE_STATE_ID			= 2; /*!< Service State Filter */
static const refinitiv::ema::access::UInt8 SERVICE_GROUP_ID			= 3; /*!< Service Group Filter */
static const refinitiv::ema::access::UInt8 SERVICE_LOAD_ID			= 4; /*!< Service Load Filter */
static const refinitiv::ema::access::UInt8 SERVICE_DATA_ID			= 5; /*!< Service Data Filter */
static const refinitiv::ema::access::UInt8 SERVICE_LINK_ID			= 6;/*!< Service Symbol List Filter */
//@}
...
*/
static const refinitiv::ema::access::UInt32 SERVICE_YES	= 1;	/*!< Service up, Service accepting requests, or link up */
static const refinitiv::ema::access::UInt32 SERVICE_NO	= 0;	/*!< Service down, Service not accepting requests, or link down */
//@}
...
/** Service accepting requests describes if a given service accepts item requests.
*/
static const refinitiv::ema::access::UInt32 SERVICE_UP		= 1;	/*!< Service up */
static const refinitiv::ema::access::UInt32 SERVICE_DOWN	= 0;	/*!< Service down */
//@}
...
*/
static const refinitiv::ema::access::UInt32 SERVICE_LINK_INTERACTIVE	= 1;	/*!< Link type is interactive */
static const refinitiv::ema::access::UInt32 SERVICE_LINK_BROADCAST		= 2;	/*!< Link type is broadcast */
//@}
...
*/
static const refinitiv::ema::access::UInt32 SERVICE_LINK_CODE_NONE					= 0;	/*!< No information is available */
static const refinitiv::ema::access::UInt32 SERVICE_LINK_CODE_OK					= 1;	/*!< Link is ok */
static const refinitiv::ema::access::UInt32 SERVICE_LINK_CODE_RECOVERY_STARTED		= 2;	/*!< Link has started to recover */
static const refinitiv::ema::access::UInt32 SERVICE_LINK_CODE_RECOVERY_COMPLETED	= 3;	/*!< Link has completed recovery */
//@}
...
*/
static const refinitiv::ema::access::UInt32 SERVICE_DATA_TIME		= 1;	/*!< Data is a time */
static const refinitiv::ema::access::UInt32 SERVICE_DATA_ALERT		= 2;	/*!< Data is an alert */
static const refinitiv::ema::access::UInt32 SERVICE_DATA_HEADLINE	= 3;	/*!< Data is a headline */
static const refinitiv::ema::access::UInt32 SERVICE_DATA_STATUS		= 4;	/*!< Data is a status */
//@}
...
*/
static const refinitiv::ema::access::UInt8 INSTRUMENT_UPDATE_UNSPECIFIED		= 0;		/*!< Not specified */
static const refinitiv::ema::access::UInt8 INSTRUMENT_UPDATE_QUOTE				= 1;		/*!< Quote */
static const refinitiv::ema::access::UInt8 INSTRUMENT_UPDATE_TRADE				= 2;		/*!< Trade */
static const refinitiv::ema::access::UInt8 INSTRUMENT_UPDATE_NEWS_ALERT			= 3;		/*!< News Alert */
static const refinitiv::ema::access::UInt8 INSTRUMENT_UPDATE_VOLUME_ALERT		= 4;		/*!< Volume Alert */
static const refinitiv::ema::access::UInt8 INSTRUMENT_UPDATE_ORDER_INDICATION	= 5;		/*!< Order Indication */
static const refinitiv::ema::access::UInt8 INSTRUMENT_UPDATE_CLOSING_RUN		= 6;		/*!< Closing Run */
static const refinitiv::ema::access::UInt8 INSTRUMENT_UPDATE_CORRECTION			= 7;		/*!< Correction */
static const refinitiv::ema::access::UInt8 INSTRUMENT_UPDATE_MARKET_DIGEST		= 8;		/*!< Official information from the exchange */
static const refinitiv::ema::access::UInt8 INSTRUMENT_UPDATE_QUOTES_TRADE		= 9;		/*!< One or more conflated quotes followed by a trade */
static const refinitiv::ema::access::UInt8 INSTRUMENT_UPDATE_MULTIPLE			= 10;		/*!< Update with other filtering and conflation applied */
static const refinitiv::ema::access::UInt8 INSTRUMENT_UPDATE_VERIFY				= 11;		/*!< Fields may have changed */
//@}
...
*/
static const refinitiv::ema::access::UInt32 VT_FIELD_ID_LIST       = 1;	/*!< View data is array of field ids  */
static const refinitiv::ema::access::UInt32 VT_ELEMENT_NAME_LIST   = 2;	/*!< View data is array of element names */
//@}
...
*/
static const refinitiv::ema::access::UInt32 SUPPORT_BATCH_REQUEST	= 0x001;	/*!< Support batch request */
static const refinitiv::ema::access::UInt32 SUPPORT_BATCH_REISSUE	= 0x002;	/*!< Support batch reissue */
static const refinitiv::ema::access::UInt32 SUPPORT_BATCH_CLOSE		= 0x004;	/*!< Support batch close */
//@}
...
*/
static const refinitiv::ema::access::UInt32 SUPPORT_SYMBOL_LIST_NAMES_ONLY		= 0x000;	/*!< Supports Symbol List names only. */
static const refinitiv::ema::access::UInt32 SUPPORT_SYMBOL_LIST_DATA_STREAMS	= 0x001;	/*!< Supports Symbol List data streams. */
//@}
...
*/
static const refinitiv::ema::access::UInt32 SYMBOL_LIST_NAMES_ONLY		= 0x000;	/*!< Requesting for names only and no data. */
static const refinitiv::ema::access::UInt32 SYMBOL_LIST_DATA_STREAMS	= 0x001;	/*!< Requesting for streaming behavior of datastreams. */
static const refinitiv::ema::access::UInt32 SYMBOL_LIST_DATA_SNAPSHOTS	= 0x002;	/*!< Requesting for snapshot behavior of datastreams. */
//@}
