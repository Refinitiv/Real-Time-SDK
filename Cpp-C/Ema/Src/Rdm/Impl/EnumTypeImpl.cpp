...
thomsonreuters::ema::access::UInt16 EnumTypeImpl::getValue() const
{
	return _pRsslEnumType->value;
}

const thomsonreuters::ema::access::EmaString& EnumTypeImpl::getDisplay() const
{
...
const thomsonreuters::ema::access::EmaString& EnumTypeImpl::getMeaning() const
{
...
const thomsonreuters::ema::access::EmaString& EnumTypeImpl::toString() const
{
