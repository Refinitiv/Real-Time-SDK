...
public:
	...
	void setThreadName( const rtsdk::ema::access::EmaString& name ) { _threadName = name; }
	...
	const rtsdk::ema::access::EmaString& getThreadName() const { return _threadName; }
...
private:
	...
	long										_requestedCPU;
	long										_boundCPU;
	rtsdk::ema::access::EmaString		_threadName;
};
