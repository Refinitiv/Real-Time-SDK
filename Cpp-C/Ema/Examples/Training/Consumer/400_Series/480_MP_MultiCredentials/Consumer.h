...
class oAuthClient : public refinitiv::ema::access::OmmOAuth2ConsumerClient
{
protected :
	void onCredentialRenewal(const refinitiv::ema::access::OmmConsumerEvent& );
};

class LoginClient : public refinitiv::ema::access::OmmLoginCredentialConsumerClient
{
protected:
	void onLoginCredentialRenewal(const refinitiv::ema::access::OmmConsumerEvent&);
};
