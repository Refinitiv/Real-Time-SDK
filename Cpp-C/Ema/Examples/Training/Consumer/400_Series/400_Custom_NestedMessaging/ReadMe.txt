...
The 400_Custom_NestedMessaging application is provided as an example of
...
Provider application, or from Advanced Distribution Server.

The 400_Custom_NestedMessaging opens up a parent stream on which, when 
...
The 400_Custom_NestedMessaging implements the following high level steps:
