...
The 230__MarketByOrder__SwitchEntryAction application is provided as an
...
The 230__MarketByOrder__SwitchEntryAction showcases application varying processing
of Map Entry based on this Map Entry's Action value (see decode( const Map& ( ) )
for details.
...
The 230__MarketByOrder__SwitchEntryAction implements the following high level steps:
