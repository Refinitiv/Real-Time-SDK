...
The 290_Custom_Decode application is provided as an example of OMM Consumer
application written to the EMA library.

This application demonstrates basic usage of the EMA library for accessing
and parsing of OMM Custom data from Refinitiv Data Feed Direct, directly
from an OMM Provider application, or from the Advanced Distribution
Server.

The 290_Custom_Decode showcases decoding of items on custom OMM domain.
...
The 290_Custom_Decode implements the following high level steps:
