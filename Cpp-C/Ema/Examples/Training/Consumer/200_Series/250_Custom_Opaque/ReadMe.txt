...
and parsing of OMM Custom Domain data from Data Feed Direct,
directly from an OMM Provider application, or from the Advanced
Distribution Server.

The 250_Custom_Opaque showcases opening and processing of a custom domain
...
The 250_Custom_Opaque implements the following high level steps:
