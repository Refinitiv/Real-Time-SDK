...
and parsing of OMM SymbolList data from Refinitiv Data Feed Direct,
directly from an OMM Provider application, or from the Advanced
Distribution Server.

The 270_SymbolList showcases opening and processing of SymbolList item.
...
The 270_SymbolList implements the following high level steps:
