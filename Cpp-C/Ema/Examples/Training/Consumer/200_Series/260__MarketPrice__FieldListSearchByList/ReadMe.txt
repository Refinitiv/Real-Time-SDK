...
The 260__MarketPrice__FieldListSearchByList application is provided as an
...
and searching with a list of field IDs of OMM MarketPrice data from Refinitiv
...
The 260__MarketPrice__FieldListSearchByList implements the following high level steps:
