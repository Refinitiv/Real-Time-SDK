...
The 200_MP_Streaming application is provided as an example of
...
and parsing of OMM MarketPrice data from Refinitiv Data Feed Direct,
directly from an OMM Provider application, or from the Advanced
Distribution Server.

The 200_MP_Streaming showcases native or RWF decoding of received
...
The 200_MP_Streaming implements the following high level steps:
