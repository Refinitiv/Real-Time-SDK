...
110_MP_FileCfg is an OMM Consumer application example
...
110_MP_FileCfg illustrates an implicit dependence of the 
...
110_MP_FileCfg implements the following high-level steps:
