...
111__MarketPrice__UserSpecifiedFileConfig illustrates the ability of the user
to specify a configuration file used when creating OmmConsumerConfig.

Detailed Description
====================

111__MarketPrice__UserSpecifiedFileConfig implements the following high-level steps:
...
+ works the same as 110__MarketPrice__FileConfig.
+
+ Note that 111__MarketPrice__UserSpecifiedFileConfig requires a configuration file
+ to work properly.
