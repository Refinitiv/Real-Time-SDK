...
The 320__Consumer__GenericMsg application is provided as an example of
...
and parsing of OMM Custom data from Data Feed Direct,
...
The 320__Consumer__GenericMsg implements the following high level steps:
