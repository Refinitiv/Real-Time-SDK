...
data from Refinitiv Data Feed Direct, directly from an OMM Provider
application, or from Advanced Distribution Server.

The 360_MP_View showcases usage of view request feature supported
...
The 360_MP_View implements the following high level steps:
