...
login and item streams and pausing item response messages from LSEG Data
Feed Direct, directly from an OMM Provider application, or from
Advanced Distribution Server with login stream.

The 350_MP_PauseAll showcases the pause all feature of OMM Consumer.
...
The 350_MP_PauseAll implements the following high level steps:
