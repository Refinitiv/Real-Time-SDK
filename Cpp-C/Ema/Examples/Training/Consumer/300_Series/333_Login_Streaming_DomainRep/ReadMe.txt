...
The 333_Login_Streaming_DomainRep showcases usage of login stream in OMM Consumer.
...
This application is the Domain Representation version of example 330_Login_Streaming. It demonstrates the
ease-of-use Domain Representation functionality.

Detailed Description
====================

The 333_Login_Streaming_DomainRep implements the following high level steps:
