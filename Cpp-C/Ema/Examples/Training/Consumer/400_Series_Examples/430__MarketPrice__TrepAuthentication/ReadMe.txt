...
The 430_MarketPrice_TrepAuthentication application is a simple application written to demonstrate
usage of the TREP Authentication Feature.

LIMITATIONS
===========

To demonstrate the TREP Authentication Feature the 430_MarketPrice_TrepAuthentication application
must be connected to an ADH that supports the feature.

USAGE
=====

The 430_MarketPrice_TrepAuthentication utilizes command line options as well as the xml configuration.
