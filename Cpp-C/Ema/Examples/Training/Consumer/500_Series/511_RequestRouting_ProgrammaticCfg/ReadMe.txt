...
ex511_RequestRouting_ProgrammaticCfg is an example of an OMM Consumer application
...
ex511_RequestRouting_ProgrammaticCfg implements the following high-level steps:
