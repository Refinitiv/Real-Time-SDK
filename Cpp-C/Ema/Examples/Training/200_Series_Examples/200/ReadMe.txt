...
200__NiProvider__X is an example of an OMM NiProvider application written to the EMA library.
...
and sending a single update for multiple items.
...
200__NiProvider__X implements the following high-level steps:
...
+ Creates and sends an update message for item IBM.N
+ Exits
