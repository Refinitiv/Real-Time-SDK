...
protected :
	...
	void printSessionInfo( const refinitiv::ema::access::OmmProviderEvent& );
	
	refinitiv::ema::access::EmaVector<refinitiv::ema::access::ChannelInformation> _channelInfoVector;
};
