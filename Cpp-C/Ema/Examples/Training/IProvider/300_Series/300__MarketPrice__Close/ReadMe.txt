...
300__MarketPrice__Close is an example of an OMM Interactive Provider application 
...
300__MarketPrice__Close illustrates how to create and publish a single OMM
...
300__MarketPrice__Close implements the following high-level steps:
