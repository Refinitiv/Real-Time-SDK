...
300_MP_ConnectionLost is an example of an OMM Interactive Provider application 
...
300_MP_ConnectionLost illustrates how to create and publish a single OMM
...
300_MP_ConnectionLost implements the following high-level steps:
