...
210_MBP_Streaming is an example of an OMM Interactive Provider application 
...
210_MBP_Streaming illustrates how to create and publish a single OMM
...
210_MBP_Streaming implements the following high-level steps:
