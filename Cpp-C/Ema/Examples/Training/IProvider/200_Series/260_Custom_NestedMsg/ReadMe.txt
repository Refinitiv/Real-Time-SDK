...
260_Custom_NestedMsg is an example of an OMM Interactive Provider application 
...
260_Custom_NestedMsg illustrates how to create and publish a single OMM
...
260_Custom_NestedMsg implements the following high-level steps:
