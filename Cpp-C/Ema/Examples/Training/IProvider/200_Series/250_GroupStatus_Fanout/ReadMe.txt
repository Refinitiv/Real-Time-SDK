...
250_GroupStatus_Fanout is an example of an OMM Interactive Provider application 
...
250_GroupStatus_Fanout illustrates how to create and publish a single OMM
...
250_GroupStatus_Fanout implements the following high-level steps:
