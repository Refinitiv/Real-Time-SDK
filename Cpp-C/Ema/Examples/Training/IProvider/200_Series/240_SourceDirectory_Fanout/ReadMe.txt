...
240_SourceDirectory_Fanout is an example of an OMM Interactive Provider application 
...
240_SourceDirectory_Fanout illustrates how to create and publish a single OMM
...
240_SourceDirectory_Fanout implements the following high-level steps:
