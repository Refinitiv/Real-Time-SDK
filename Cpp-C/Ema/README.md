...
##### Static Library Manifest
    ...
    Library Name                Package Version  
    -------------               -------------- 
    libema.a                    ema3.7.1.L1
    
##### Shared Library Manifest

    Library Name                Binary Version       Package Version
    -------------               --------------       ----------------
    libema.so.3.7.1.L1          libema.so.17          ema3.7.1.L1
...
# Reference Information
    ...
    Load Number: 1
    Windows Load ID: ema3.7.1.L1.win
        Supersedes: ema3.7.0.L1.win
    Linux Load ID: ema3.7.1.L1.linux
        Supersedes: ema3.7.0.L1.linux
    Release Status: RRG
    Release Type: RRG
    US ECCN: EAR99
    EU ECCN: None
