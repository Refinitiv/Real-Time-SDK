...
x.t(".itemlist","acceptingconsumerstatus");
x.t(".itemlist","means");
x.t("text","field");
x.t("single","service");
x.t("items","provided");
...
x.t("dictionary_3","dictionariesprovidedentry");
x.t("dictionary_3","dictionariesusedentry");
...
x.t("dictionary_4","dictionariesprovided");
x.t("dictionary_4","dictionariesused");
...
x.t("dictionarygroup","directorygroup");
...
x.t("statefilter","servicestate");
x.t("statefilter","service");
x.t("streamstate::open","possible");
x.t("streamstate::open","datastate");
x.t("streamstate::open","possibe");
x.t("datastate","value");
x.t("statuscode::none","text");
x.t("statuscode::none","statustext");
...
x.t("value","supportsoutofbandsnapshots");
x.t("value","df_1");
