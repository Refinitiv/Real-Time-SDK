...
{
	cout << endl << "Item Stream Id: " << refreshMsg.getStreamId() << endl
		<< "Private Stream: " << ( refreshMsg.getPrivateStream() ? EmaString( "True" ) : EmaString( "False" ) ) << endl
...
{
	cout << endl << "Item Stream Id: " << updateMsg.getStreamId() << endl
		<< "Item Name: " << ( updateMsg.hasName() ? updateMsg.getName() : EmaString( "<not set>" ) ) << endl
...
{
	cout << endl << "Item Stream Id: " << statusMsg.getStreamId() << endl
		<< "Item Name: " << ( statusMsg.hasName() ? statusMsg.getName() : EmaString( "<not set>" ) ) << endl
...
{ 
	try { 
		...
		consumer.registerClient( ReqMsg().domainType( MMT_MARKET_BY_PRICE ).serviceName( "DIRECT_FEED" ).name( "BBH.ITC" ).privateStream( true ), client );
		consumer.registerClient( ReqMsg().domainType( MMT_MARKET_BY_PRICE ).serviceName( "DIRECT_FEED" ).name( "BBH.ITC" ).privateStream( false ), client );
		consumer.registerClient( ReqMsg().domainType( MMT_MARKET_BY_PRICE ).serviceName( "DIRECT_FEED" ).name( "BBH.ITC" ).privateStream( false ), client );
