...
protected :
	...
	void sendConsumerStatus(const thomsonreuters::ema::access::OmmConsumerEvent& ommEvent);
	void processDirectoryDomainGenericMsg(const thomsonreuters::ema::access::GenericMsg&, const thomsonreuters::ema::access::OmmConsumerEvent&);
};
