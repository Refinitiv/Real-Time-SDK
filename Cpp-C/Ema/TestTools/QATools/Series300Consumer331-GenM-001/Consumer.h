...
public :
	...
	void decode( const rtsdk::ema::access::OmmArray& );			// print content of passed in Array to screen
...
protected :
	...
	void sendConsumerStatus(const rtsdk::ema::access::OmmConsumerEvent& ommEvent);
	void processDirectoryDomainGenericMsg(const rtsdk::ema::access::GenericMsg&, const rtsdk::ema::access::OmmConsumerEvent&);
};
