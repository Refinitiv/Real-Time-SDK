...
protected :
	...
	void sendConsumerStatus(const refinitiv::ema::access::OmmConsumerEvent& ommEvent);
	void processDirectoryDomainGenericMsg(const refinitiv::ema::access::GenericMsg&, const refinitiv::ema::access::OmmConsumerEvent&);
};
