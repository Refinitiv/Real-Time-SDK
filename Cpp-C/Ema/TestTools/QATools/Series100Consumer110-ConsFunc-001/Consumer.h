...
public :
	...
	void decodeEList( const thomsonreuters::ema::access::ElementList& );			// print content of passed in ElementList to screen
	void decodeM( const thomsonreuters::ema::access::Map& );					// print content of passed in Map to screen
	void decode( const thomsonreuters::ema::access::OmmOpaque& oq );
...
protected :
	...
	void processRespMsg( const thomsonreuters::ema::access::RefreshMsg& , const thomsonreuters::ema::access::OmmConsumerEvent& );		// process all response messages (single and multi part refresh, update and status)
};
