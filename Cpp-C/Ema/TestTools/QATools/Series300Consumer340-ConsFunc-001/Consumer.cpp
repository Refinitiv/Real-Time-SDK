...
void AppClient::onRefreshMsg( const RefreshMsg& refreshMsg, const OmmConsumerEvent& ommEvent )
{
	...
	decode( refreshMsg );
        //APIQA
        {
                ...
                cout << "Clone RefreshMsg" << endl;
                cout << cloneRefreshMsg << endl;
	        cout << endl << "Clone Refresh Item State: " << cloneRefreshMsg.getState().toString() << endl << endl;
        }
        //END APIQA
...
void AppClient::onUpdateMsg( const UpdateMsg& updateMsg, const OmmConsumerEvent& ommEvent )
{
	...
	decode( updateMsg );
        //APIQA
        {
                ...
                cout << "Clone UpdateMsg" << endl;
                cout << cloneUpdateMsg << endl;
        }
        //END APIQA
}
...
void AppClient::onStatusMsg( const StatusMsg& statusMsg, const OmmConsumerEvent& ommEvent )
{
	...
	if ( statusMsg.hasState() )
        ...
        //APIQA
        {
                StatusMsg cloneStatusMsg(statusMsg);
                cout << "Clone StatusMsg" << endl;
                cout << cloneStatusMsg << endl;
	        if ( cloneStatusMsg.hasState() )
	        	cout << endl << "Clone StatusMsg Item State: " << cloneStatusMsg.getState().toString() << endl << endl;
        } 
        //END APIQA
}
...
void AppClient::onAckMsg( const AckMsg& ackMsg, const OmmConsumerEvent& event )
{
	...
	decode( ackMsg );
        //APIQA
        {
                ...
                cout << "Clone AckMsg" << endl;
                cout << cloneAckMsg << endl;
                cout << endl << "Decode Of Clone AckMsg" << endl;
	        decode( cloneAckMsg );
        }
        //END APIQA
}
