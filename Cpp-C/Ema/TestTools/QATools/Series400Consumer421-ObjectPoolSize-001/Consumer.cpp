...
void createProgramaticConfig( Map& configMap )
{
	...
	//API QA
	elementList.addUInt( "EmaObjectManagerMsgTypeLimit", 10000 )
		.addUInt( "EmaObjectManagerComplexTypeLimit", 10000 )
		.addUInt( "EmaObjectManagerDataTypeLimit", 10000 )
		.complete();
	configMap.addKeyAscii("GlobalConfig", MapEntry::AddEnum, elementList);
...
void createProgramaticConfig2(Map& configMap)
{
	Map innerMap;
	ElementList elementList;

	//API QA
	elementList.addUInt("EmaObjectManagerMsgTypeLimit", 50000)
		.addUInt("EmaObjectManagerComplexTypeLimit", 50000)
		.addUInt("EmaObjectManagerDataTypeLimit", 50000)
		.complete();
	configMap.addKeyAscii("GlobalConfig", MapEntry::AddEnum, elementList);
	elementList.complete();
	elementList.clear();
...
{ 
	try { 
		...
		cout << "---Test Set Values via ProgrammaticConfig---" << endl;
		...
		GlobalConfig::setComplexTypePoolLimit(5000);
		GlobalConfig::setMsgTypePoolLimit(5000);
		GlobalConfig::setDataTypePoolLimit(5000);
		...
		cout << "GlobalConfig::getStatusMsgInPoolCount(): " << GlobalConfig::getStatusMsgInPoolCount() << endl;
		cout << "GlobalConfig::getUpdateMsgInPoolCount(): " << GlobalConfig::getUpdateMsgInPoolCount() << endl;
		cout << "---Test when 2nd attempt to set Values via ProgrammaticConfig---" << endl;

		Map configMap2;
		createProgramaticConfig2(configMap2);
		OmmConsumer consumer2(OmmConsumerConfig().config(configMap2));
		cout << "GlobalConfig::getComplexTypePoolLimit(): " << GlobalConfig::getComplexTypePoolLimit() << endl;
		cout << "GlobalConfig::getMsgTypePoolLimit(): " << GlobalConfig::getMsgTypePoolLimit() << endl;
		cout << "GlobalConfig::getDataTypePoolLimit(): " << GlobalConfig::getDataTypePoolLimit() << endl;
		cout << "GlobalConfig::getAckMsgInPoolCount(): " << GlobalConfig::getAckMsgInPoolCount() << endl;
