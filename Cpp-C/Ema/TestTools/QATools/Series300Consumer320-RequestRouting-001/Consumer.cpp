...
int main()
{
	try {
		...
		OmmConsumer consumer( OmmConsumerConfig().operationModel( OmmConsumerConfig::UserDispatchEnum ).consumerName("Consumer_10").username("user"));
		//END APIQA
