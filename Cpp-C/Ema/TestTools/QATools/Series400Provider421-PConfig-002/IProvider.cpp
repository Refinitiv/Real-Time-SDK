...
void createProgrammaticConfig( Map& configMap )
{
	...
	innerMap.addKeyAscii( "Provider_1", MapEntry::AddEnum, ElementList()
		...
		.addUInt("DispatchTimeoutApiThread", -1)
...
int main( int argc, char* argv[] )
{
	try
	{
		...
		//APIQA
		OmmProvider provider( OmmIProviderConfig().config( configMap ).operationModel( OmmIProviderConfig::UserDispatchEnum ).providerName("Provider_2"), appClient );
