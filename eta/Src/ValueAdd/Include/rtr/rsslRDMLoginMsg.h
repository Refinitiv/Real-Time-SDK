 ...
 */
typedef enum {
	RDM_LG_RQF_NONE						= 0x0000,	/*!< (0x0000) No flags set */
	RDM_LG_RQF_HAS_ALLOW_SUSPECT_DATA	= 0x0001,	/*!< (0x0001) Indicates presence of the allowSuspectData member. */
	RDM_LG_RQF_HAS_APPLICATION_ID		= 0x0002,	/*!< (0x0002) Indicates presence of the applicationId member */
	RDM_LG_RQF_HAS_APPLICATION_NAME		= 0x0004,	/*!< (0x0004) Indicates presence of the applicationName member */
	RDM_LG_RQF_HAS_DOWNLOAD_CONN_CONFIG	= 0x0008,	/*!< (0x0008) Indicates presence of the downloadConnectionConfig member */	
	RDM_LG_RQF_HAS_INSTANCE_ID			= 0x0010,	/*!< (0x0010) Indicates presence of the instanceId member */
	RDM_LG_RQF_HAS_PASSWORD				= 0x0020,	/*!< (0x0020) Indicates presence of the password member */
	RDM_LG_RQF_HAS_POSITION				= 0x0040,	/*!< (0x0040) Indicates presence of the position member */
	RDM_LG_RQF_HAS_PROVIDE_PERM_EXPR	= 0x0080,	/*!< (0x0080) Indicates presence of the providePermissionExpressions member */
	RDM_LG_RQF_HAS_PROVIDE_PERM_PROFILE = 0x0100,	/*!< (0x0100) Indicates presence of the providePermissionProfile member */
	RDM_LG_RQF_HAS_ROLE					= 0x0200,	/*!< (0x0200) Indicates presence of the role member */
	RDM_LG_RQF_HAS_SINGLE_OPEN			= 0x0400,	/*!< (0x0400) Indicates presence of the singleOpen member */
	RDM_LG_RQF_HAS_USERNAME_TYPE		= 0x0800,	/*!< (0x0800) Indicates presence of the userNameType member */
	RDM_LG_RQF_NO_REFRESH				= 0x1000,	/*!< (0x1000) Indicates the Consumer or Noninteractive provider does not require a refresh. */
	RDM_LG_RQF_PAUSE_ALL						= 0x2000,	/*!< (0x2000) Used by a Consumer to request that all open items on a channel be paused. Support for this request is indicated by the supportOptimizedPauseResume member of the RsslRDMLoginRefresh */
	RDM_LG_RQF_HAS_SUPPORT_PROV_DIC_DOWNLOAD	= 0x4000,    /*!< (0x4000) Indiactes presence of the supportProviderDictionaryDownload member */
...
typedef struct {
	...
	RsslBuffer	userName;						/*!< The UserName being used to login. */
...
typedef enum
{
	RDM_LG_RFF_NONE                      		= 0x000000,	/*!< (0x000000) No flags set. */
	RDM_LG_RFF_CLEAR_CACHE               		= 0x000001,	/*!< (0x000001) Indicates whether the receiver of the refresh should clear any associated cache information. */
	RDM_LG_RFF_HAS_ALLOW_SUSPECT_DATA    		= 0x000002,	/*!< (0x000002) Indicates presence of the allowSuspectData member. */
	RDM_LG_RFF_HAS_APPLICATION_ID        		= 0x000004,	/*!< (0x000004) Indicates presence of the applicationId member. */
	RDM_LG_RFF_HAS_APPLICATION_NAME      		= 0x000008,	/*!< (0x000008) Indicates presence of the applicationName member. */
	RDM_LG_RFF_HAS_CONN_CONFIG           		= 0x000010,	/*!< (0x000010) Indicates presence of the numStandbyServers and serverList members. */
	RDM_LG_RFF_HAS_POSITION              		= 0x000020,	/*!< (0x000020) Indicates presence of the position member. */
	RDM_LG_RFF_HAS_PROVIDE_PERM_EXPR     		= 0x000040,	/*!< (0x000040) Indicates presence of the providePermissionExpressions member. */
	RDM_LG_RFF_HAS_PROVIDE_PERM_PROFILE  		= 0x000080,	/*!< (0x000080) Indicates presence of the providePermissionProfile member. */
	RDM_LG_RFF_HAS_SEQ_NUM               		= 0x000100,	/*!< (0x000100) Indicates presence of the sequenceNumber member. */
	RDM_LG_RFF_HAS_SINGLE_OPEN           		= 0x000200,	/*!< (0x000200) Indicates presence of the singleOpen member. */
	RDM_LG_RFF_HAS_SUPPORT_BATCH         		= 0x000400,	/*!< (0x000400) Indicates presence of the supportBatchRequests member. */
	RDM_LG_RFF_HAS_SUPPORT_POST          		= 0x000800,	/*!< (0x000800) Indicates presence of the supportOMMPost member. */
	RDM_LG_RFF_HAS_SUPPORT_OPT_PAUSE     		= 0x001000,	/*!< (0x001000) Indicates presence of the supportOptimizedPauseResume member. */
	RDM_LG_RFF_HAS_SUPPORT_STANDBY       		= 0x002000,	/*!< (0x002000) Indicates presence of the supportStandby member. */
	RDM_LG_RFF_HAS_SUPPORT_VIEW          		= 0x004000,	/*!< (0x004000) Indicates presence of the supportViewRequests member. */
	RDM_LG_RFF_HAS_USERNAME              		= 0x008000,	/*!< (0x008000) Indicates presence of the userName member. */
	RDM_LG_RFF_HAS_USERNAME_TYPE         		= 0x010000,	/*!< (0x010000) Indicates presence of the userNameType member. */
	RDM_LG_RFF_SOLICITED                 		= 0x020000,	/*!< (0x020000) Indicates whether this refresh is being provided in response to a request. */
	RDM_LG_RFF_HAS_SUPPORT_ENH_SL				= 0x040000,	/*!< (0x040000) Indicates presence of the supportEnhancedSymbolList member. */
	RDM_LG_RFF_HAS_SUPPORT_PROV_DIC_DOWNLOAD	= 0x080000,	/*!< (0x080000) Indicates presence of the supportProviderDictionaryDownload member. */
	RDM_LG_RFF_HAS_SEQ_RETRY_INTERVAL			= 0x100000,	/*!< (0x100000) Indicates presence of the sequenceRetryInterval member. */
	RDM_LG_RFF_HAS_UPDATE_BUF_LIMIT				= 0x200000,	/*!< (0x200000) Indicates presence of the updateBufferLimit member. */
	RDM_LG_RFF_HAS_SEQ_NUM_RECOVERY				= 0x400000	/*!< (0x400000) Indicates presence of the sequenceNumberRecovery member. */
